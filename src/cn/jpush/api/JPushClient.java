...
public class JPushClient {
	private static final String appKey = "4e5e8d65d3e8c1a5d0a4a188";
	private static final String masterSecret = "02531abb55bd4592c9a144fd";
     ...
     * Shortcut
     */
    public PushResult sendNotificationAll(String title, String alert, 
     ...
     * Shortcut
     */
    public PushResult sendAndroidNotificationWithAlias1(String title, String alert, 
    ...
    public PushResult sendAndroidNotificationWithAlias(String title, String alert, 
        ...
        PushPayload payload = PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder().setAlert(alert).setTitle(title).addExtras(extras).build())
                        .build())
                .build();
        return _pushClient.sendPush(payload);
    }
