package com.jshx.zdwxyhxsq.entity;
...
@Entity
@Table(name="ZDWXYHXSQ")
public class Zdwxyhxsq extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	@Column(name="SQXHLY")
	public String getSqxhly()
	{
		return this.sqxhly;
	}

	public void setSqxhly(String sqxhly)
	{
		this.sqxhly = sqxhly;
	}
