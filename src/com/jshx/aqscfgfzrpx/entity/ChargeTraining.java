package com.jshx.aqscfgfzrpx.entity;
...
@Entity
@Table(name="CHARGE_TRAINING")
public class ChargeTraining extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public ChargeTraining(){
	}
	
	public ChargeTraining(String id, String areaName, String companyName, String trainingPersonName,String trainingCardnum, Date trainingTime,Date trainingTimeEnd){
		this.id = id;
