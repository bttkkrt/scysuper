package com.jshx.xygsgpx.entity;
...
@Entity
@Table(name="NEW_WOR_TRA")
public class NewWorTra extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public NewWorTra(String id, String areaName, String companyName, Date trainingTime,String trainingName,Date trainingTimeEnd){
this.id = id;
