package com.jshx.zlqxzgzls.web;
...
public class OrderDeadlineBookAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		final String filter = "id|relatedId|startTime|lawOfficer|";
		...
		pagination = orderDeadlineBookService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != orderDeadlineBook)&&(null != orderDeadlineBook.getId()))
			orderDeadlineBook = orderDeadlineBookService.getById(orderDeadlineBook.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			orderDeadlineBook.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != orderDeadlineBook)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到orderDeadlineBook中去
	...
	public String delete() throws Exception{
	    try{
			orderDeadlineBookService.deleteWithFlag(ids);
