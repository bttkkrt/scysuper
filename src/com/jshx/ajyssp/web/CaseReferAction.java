...
public class CaseReferAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = caseReferService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != caseRefer)&&(null != caseRefer.getId()))
			caseRefer = caseReferService.getById(caseRefer.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			caseRefer.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != caseRefer)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到caseRefer中去
	...
	public String delete() throws Exception{
	    try{
			caseReferService.deleteWithFlag(ids);
