...
public class CaseTransferAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = caseTransferService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != caseTransfer)&&(null != caseTransfer.getId()))
			caseTransfer = caseTransferService.getById(caseTransfer.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			caseTransfer.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != caseTransfer)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到caseTransfer中去
	...
	public String delete() throws Exception{
	    try{
			caseTransferService.deleteWithFlag(ids);
