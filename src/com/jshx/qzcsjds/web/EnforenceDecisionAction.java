...
public class EnforenceDecisionAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = enforenceDecisionService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != enforenceDecision)&&(null != enforenceDecision.getId()))
			enforenceDecision = enforenceDecisionService.getById(enforenceDecision.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			enforenceDecision.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != enforenceDecision)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到enforenceDecision中去
	...
	public String delete() throws Exception{
	    try{
			enforenceDecisionService.deleteWithFlag(ids);
