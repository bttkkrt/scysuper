package com.jshx.checkBasic.service;
...
public interface CheckBasicService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(CheckBasic model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(CheckBasic model);
