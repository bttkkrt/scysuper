package com.jshx.aqscwyhtj.service;
...
public interface AqscwyhtjService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(Aqscwyhtj model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(Aqscwyhtj model);
