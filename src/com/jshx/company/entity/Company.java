...
public class Company extends BaseModel
{
	 ...
	 * 是否参加安全责任险
	 */
	private String sfcjaqzrx;
	/**
	 * 是否设置安全总监
	 */
	private String sfszaqzj;
	 ...
	 * hanxc 20150827
	 */
	private String sfqzaqgly;
	

	//hanxc 20141212 为抚顺版本添加字段添加 end
	@Column
	public String getSfqzaqgly() {
		return sfqzaqgly;
	}

	public void setSfqzaqgly(String sfqzaqgly) {
		this.sfqzaqgly = sfqzaqgly;
	}

	@Column
	public String getSfcjaqzrx() {
		return sfcjaqzrx;
	}

	public void setSfcjaqzrx(String sfcjaqzrx) {
		this.sfcjaqzrx = sfcjaqzrx;
	}

	@Column
	public String getSfszaqzj() {
		return sfszaqzj;
	}

	public void setSfszaqzj(String sfszaqzj) {
		this.sfszaqzj = sfszaqzj;
	}
	...
	public String getIffmgmqylx() {
		return iffmgmqylx;
	}

	public void setIffmgmqylx(String iffmgmqylx) {
		this.iffmgmqylx = iffmgmqylx;
	}
