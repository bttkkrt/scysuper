package com.jshx.aqscgljlpx.entity;
...
@Entity
@Table(name="MANAGER_TRAINING")
public class ManagerTraining extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public ManagerTraining(){
	}
	
	public ManagerTraining(String id, String areaName, String companyName, String trainingPersonName,String trainingCardnum, Date trainingTime,Date trainingTimeEnd){
		this.id = id;
