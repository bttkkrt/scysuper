package com.jshx.aqscgljl.service;
...
public interface SecProManService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(SecProMan model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(SecProMan model);
