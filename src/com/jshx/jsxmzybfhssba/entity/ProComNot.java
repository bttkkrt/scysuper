package com.jshx.jsxmzybfhssba.entity;
...
@Entity
@Table(name="PRO_COM_NOT")
public class ProComNot extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public ProComNot(String id, String areaName, String companyName, String proNo, Date proDate,String createUserID){
this.id = id;
