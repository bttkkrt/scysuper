...
*作者：李海棠
*/
package com.jshx.occupationalControlPlan.entity;
...
@Entity
@Table(name="OCCUPATIONAL_CONTROL_PLAN")
public class OccupationalControlPlan extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	/**
	 * 新增字段 
	 * 报告完成日期  lj 2014-06-26
	 * @return
	 */
	private String bgwcrq;
	/**
	 * 新增字段
	 * 报告上报日期
	 * lj 2014-06-26
	 * @return
	 */
	private String bgsbrq;
	
	private String babh;
	
	private String barq;
	
	private String xcbarq;
	...
	@Column
	public String getBgwcrq() {
		return bgwcrq;
	}

	public void setBgwcrq(String bgwcrq) {
		this.bgwcrq = bgwcrq;
	}
	@Column
	public String getBgsbrq() {
		return bgsbrq;
	}

	public void setBgsbrq(String bgsbrq) {
		this.bgsbrq = bgsbrq;
	}
	...
	@Column
	public String getXcbarq() {
		return xcbarq;
	}

	public void setXcbarq(String xcbarq) {
		this.xcbarq = xcbarq;
	}
}
