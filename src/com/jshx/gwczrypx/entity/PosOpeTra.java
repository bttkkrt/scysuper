package com.jshx.gwczrypx.entity;
...
@Entity
@Table(name="POS_OPE_TRA")
public class PosOpeTra extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public PosOpeTra(String id, String areaName,String companyName, String operateName, String idCard, String certificateNo, String operateType,String createUserID){
this.id = id;
