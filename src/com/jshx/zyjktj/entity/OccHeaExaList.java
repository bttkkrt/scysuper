...
@Entity
@Table(name="OCC_HEA_EXA_LIST")
public class OccHeaExaList extends BaseModel
{
	/**
	 * 职业健康体检关联id
	 */
	private String occHeaExaId;
	/**
	 * 部门代码
	 */
	...
	public OccHeaExaList(){
	}
	
	public OccHeaExaList(String id,String occHeaExaId,String medicalInstitution,
			String medicalInstitutionName, 
			String occupationalDiseasName, String preOccupationHealthNumber,
			String postOccupationalHealth, String postOccupationHealthNumber,
			String foundPostsNumber, String actualPositionNumber) {
		this.id=id;
		this.occHeaExaId = occHeaExaId;
	...
	@Column(name="OCC_HEA_EXA_ID")
	public String getOccHeaExaId() {
		return occHeaExaId;
	}

	public void setOccHeaExaId(String occHeaExaId) {
		this.occHeaExaId = occHeaExaId;
	}
