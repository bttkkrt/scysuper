package com.jshx.whpyjyagzs.entity;
...
@Entity
@Table(name="WHPYJYAGZS")
public class Whpyjyagzs extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	@Column(name="YJJYYA")
	public String getYjjyya()
	{
		return this.yjjyya;
	}

	public void setYjjyya(String yjjyya)
	{
		this.yjjyya = yjjyya;
	}
