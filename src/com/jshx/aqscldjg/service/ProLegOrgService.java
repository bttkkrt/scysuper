package com.jshx.aqscldjg.service;
...
public interface ProLegOrgService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(ProLegOrg model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(ProLegOrg model);
