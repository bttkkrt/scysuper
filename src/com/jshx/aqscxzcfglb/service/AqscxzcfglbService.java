package com.jshx.aqscxzcfglb.service;
...
public interface AqscxzcfglbService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(Aqscxzcfglb model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(Aqscxzcfglb model);
