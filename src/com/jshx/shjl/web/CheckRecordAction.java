...
public class CheckRecordAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = checkRecordService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != checkRecord)&&(null != checkRecord.getId()))
			checkRecord = checkRecordService.getById(checkRecord.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			checkRecord.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != checkRecord)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到checkRecord中去
	...
	public String delete() throws Exception{
	    try{
			checkRecordService.deleteWithFlag(ids);
