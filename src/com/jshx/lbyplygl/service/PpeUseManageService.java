package com.jshx.lbyplygl.service;
...
public interface PpeUseManageService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(PpeUseManage model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(PpeUseManage model);
