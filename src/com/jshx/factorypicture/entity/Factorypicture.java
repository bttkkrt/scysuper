package com.jshx.factorypicture.entity;
...
@Entity
@Table(name="FACTORYPICTURE")
public class Factorypicture extends BaseModel
{
	/**
	 * 部门代码
	 */
	 ...
	 * 厂区实物名称
	 */
	private String physicalplantname;
	/**
	 * 附件上传通用关联的模块中记录的id
	 */
...
private String szc;
	...
	@Column(name="PHYSICALPLANTNAME")
	public String getPhysicalplantname()
	{
		return this.physicalplantname;
	}

	public void setPhysicalplantname(String physicalplantname)
	{
		this.physicalplantname = physicalplantname;
	}
	/**
	 * 是否直属企业
	 */
