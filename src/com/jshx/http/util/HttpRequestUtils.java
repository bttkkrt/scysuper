...
//        JSONObject j=httpPost(url,JSONObject.fromObject(dataMap));
//        System.out.println(j.toString());
        String url="http://172.25.127.9/services/HRModel/User?appid=1DBE552B23D440128A12BA5D6ECE72B2&$filter=Id%20eq%20FEBCB578-BC76-4A6B-9F5D-CDBB1C0B145B&$expand=Organizations";
        JSONObject j=httpGet(url);
        System.out.println(j.toString());
    }
