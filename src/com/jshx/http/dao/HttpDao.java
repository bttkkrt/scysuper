...
public interface HttpDao {
	...
	public List<DataBean> getCountyList(Map map);//获取所在县列表 lj 2013-07-23
	...
	public DataBean getDeptCodeByUserId(Map map);//根据用户id查询该用户的deptCode lj 2013-07-28
	...
	public List<JshxZazPxb> getZazpxListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getZazpxListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	
	public List<JshxTzzyPxb> getTzzypxListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getTzzypxListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	
	public List<JshxXrcPxb> getXrcpxListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getXrcpxListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	
	public List<JshxZzxtPxb> getZzxtpxListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getZzxtpxListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	
	public List<JshxXkzsb> getXzxkListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getXzxkListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	
	public List<Factorypicture> getCqtpListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getCqtpListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	
	public List<JshxZzbw> getZzbwListByMap(Map map);//获取自查隐患列表 2013-09-25 陆婷
	public int getZzbwListSizeByMap(Map map);//获取自查隐患列表总条数 2013-09-25 陆婷
	...
	public List<Map<String,String>> getInspectTaskListByMap(Map map);//获取安全检查任务列表 hanxc 2014-11-13
	public int getInspectTaskListCountByMap(Map map);//获取安全检查任务数 hanxc 2014-11-13
	public List<Map<String,String>> GetInspectItemListByMap(Map map);//获取安全检查项列表 hanxc 2014-11-13
