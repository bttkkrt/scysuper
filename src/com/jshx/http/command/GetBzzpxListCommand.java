 ...
 * @author 陆妍婷
 */
public class GetBzzpxListCommand implements Command
{
		...
		try{
			...
			if(aqscgljgList.size()>0){
				...
				for(Map<String,Object> m:aqscgljgList){
					...
					json.put("personName",null==m.get("TRAINING_NAME")?"":m.get("TRAINING_NAME"));
