...
public class GetMajorTroubleListCommand implements Command
{
...
//			}
//		}
		List<CommonTroubleBean> commons = httpService.getMajorTroubleList(map);//获取重大安全隐患列表信息

		int total = httpService.getMajorTroubleListCount(map);//获取重大安全隐患总条数
		int page=total/(l);
