package com.jshx.sbshcl.entity;
...
@Entity
@Table(name="JSHX_SBSHCL")
public class JshxSbshcl extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	@Column(name="JSHX_TITLE")
	public String getJshxTitle() {
		return jshxTitle;
	}

	public void setJshxTitle(String jshxTitle) {
		this.jshxTitle = jshxTitle;
	}
