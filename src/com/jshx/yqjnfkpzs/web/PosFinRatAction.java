package com.jshx.yqjnfkpzs.web;
...
public class PosFinRatAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = posFinRatService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != posFinRat)&&(null != posFinRat.getId()))
			posFinRat = posFinRatService.getById(posFinRat.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			posFinRat.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != posFinRat)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到posFinRat中去
	...
	public String delete() throws Exception{
	    try{
			posFinRatService.deleteWithFlag(ids);
