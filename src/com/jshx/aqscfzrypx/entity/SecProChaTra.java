package com.jshx.aqscfzrypx.entity;
...
@Entity
@Table(name="SEC_PRO_CHA_TRA")
public class SecProChaTra extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public SecProChaTra(String id, String areaName, String companyName, String trainingPersonName,String trainingCardnum, Date trainingTime,Date trainingTimeEnd){
		this.id = id;
