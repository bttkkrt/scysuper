package com.jshx.czrypxzs.entity;
...
@Entity
@Table(name="TRA_CER")
public class TraCer extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public TraCer(String id, String areaName, String companyName, String certificateName, String idCard, String certificateNo,String createUserID){
this.id = id;
