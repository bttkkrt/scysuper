package com.jshx.qyzyfzr.entity;
...
@Entity
@Table(name="ENT_CHA_PER")
public class EntChaPer extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public EntChaPer(String id, String areaId, String companyName, String chargeName, String chargeSpecializedNum, String chargePhone){
this.id = id;
