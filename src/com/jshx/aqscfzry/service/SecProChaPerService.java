package com.jshx.aqscfzry.service;
...
public interface SecProChaPerService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(SecProChaPer model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(SecProChaPer model);
