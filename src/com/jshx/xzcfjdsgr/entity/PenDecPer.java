package com.jshx.xzcfjdsgr.entity;
...
@Entity
@Table(name="PEN_DEC_PER")
public class PenDecPer extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public PenDecPer(String id, String relatedId, String punishedSex, String punishedAge, String punishedPosition, String adminPenalties){
this.id = id;
