package com.jshx.aqsczjpx.entity;
...
@Entity
@Table(name="MAJORDOMO_TRAINING")
public class MajordomoTraining extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public MajordomoTraining(){
	}
	
	public MajordomoTraining(String id, String areaName, String companyName, String trainingPersonName,String trainingCardnum, Date trainingTime,Date trainingTimeEnd){
		this.id = id;
