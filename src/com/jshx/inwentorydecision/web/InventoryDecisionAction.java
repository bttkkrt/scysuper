package com.jshx.inwentorydecision.web;
...
public class InventoryDecisionAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = inventoryDecisionService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != inventoryDecision)&&(null != inventoryDecision.getId()))
			inventoryDecision = inventoryDecisionService.getById(inventoryDecision.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			inventoryDecision.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != inventoryDecision)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到inventoryDecision中去
	...
	public String delete() throws Exception{
	    try{
			inventoryDecisionService.deleteWithFlag(ids);
