package com.jshx.whpxzxk.service;
...
public interface CheManLicService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(CheManLic model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(CheManLic model);
