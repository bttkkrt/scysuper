package com.jshx.checkTable.service.impl;
...
public class CheckTableServiceImpl extends BaseServiceImpl implements CheckTableService
{
	/**
	 * Dao类
	 */
	@Autowired() 
	@Qualifier("checkTableDao")
	...
	{
		return checkTableDao.findByPage(page, paraMap);
	}
	...
	{
		return checkTableDao.getById(id);
	}
	...
	public void delete(String[] ids)
	{
		...
		List objects=checkTableDao.findCheckTable(paraMap);
		
		checkTableDao.removeAll(objects);
	}
		...
		if(null != idArray)
		{
			for(String id : idArray)
			{
			    if(id!=null && !id.trim().equals(""))
				    checkTableDao.deleteWithFlag(id);
			}
		}
	}
}
