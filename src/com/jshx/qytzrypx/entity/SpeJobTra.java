package com.jshx.qytzrypx.entity;
...
@Entity
@Table(name="SPE_JOB_TRA")
public class SpeJobTra extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public SpeJobTra(String id, String areaName, String companyName, String trainingPersonName,String trainingCardnum, Date trainingTime,Date trainingTimeEnd){
		this.id = id;
