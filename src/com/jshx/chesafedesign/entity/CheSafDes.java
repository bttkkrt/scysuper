package com.jshx.chesafedesign.entity;
...
@Entity
@Table(name="CHE_SAF_DES")
public class CheSafDes extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public CheSafDes(String id, String areaName, String companyName, String designUnit, String projectNature, String expertReview, Date reviewDate, String reviewName, String receptName, String isComplete,String createUserID){
this.id = id;
