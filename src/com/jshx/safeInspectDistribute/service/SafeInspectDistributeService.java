package com.jshx.safeInspectDistribute.service;
...
public interface SafeInspectDistributeService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(SafeInspectDistribute model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(SafeInspectDistribute model);
