package com.jshx.distributeItem.service;
...
public interface DistributeItemService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(DistributeItem model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(DistributeItem model);
