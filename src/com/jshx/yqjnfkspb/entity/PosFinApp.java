package com.jshx.yqjnfkspb.entity;
...
@Entity
@Table(name="POS_FIN_APP")
public class PosFinApp extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public PosFinApp(String id, String relatedId, String undertaker, String checkPerson, String approver){
this.id = id;
