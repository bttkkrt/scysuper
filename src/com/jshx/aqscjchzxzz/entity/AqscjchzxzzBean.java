...
public class AqscjchzxzzBean {
	...
	public String getData7() {
		if(!data5.equals("0")){
			...
			String strFloat = myFormat.format(Integer.parseInt(data6)*100/Integer.parseInt(data5));
			return strFloat+"%";
		}else{
			return "100.00%";
		}
	...
	public String getData10() {
		if(!data8.equals("0")){
			DecimalFormat myFormat = new DecimalFormat("0.00"); 
			String strFloat = myFormat.format(Integer.parseInt(data9)*100/Integer.parseInt(data8));
			return strFloat+"%";
		}else{
			return "100.00%";
		}
