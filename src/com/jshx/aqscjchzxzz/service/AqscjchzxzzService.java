package com.jshx.aqscjchzxzz.service;
...
public interface AqscjchzxzzService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(Aqscjchzxzz model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(Aqscjchzxzz model);
