...
public class CloseApprovalAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		pagination = closeApprovalService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != closeApproval)&&(null != closeApproval.getId()))
			closeApproval = closeApprovalService.getById(closeApproval.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			closeApproval.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != closeApproval)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到closeApproval中去
	...
	public String delete() throws Exception{
	    try{
			closeApprovalService.deleteWithFlag(ids);
