...
@Entity
@Table(name="JSHX_ZSGL")
public class JshxZsgl extends BaseModel
{
	/**
	 * 部门代码
	 */
	 ...
	 * 证书类型
	 */
	private String jshxType;
	/**
	 * 新增字段备注 李军 2013-08-28
	 */
	private String remark;
	
	/**
	 * 新增 关联附件的id 李军 2013-08-15
	 * @return
	 */
	...
	@Column(name="JSHX_TYPE")
	public String getJshxType()
	{
		return this.jshxType;
	}

	public void setJshxType(String jshxType)
	{
		this.jshxType = jshxType;
	}
	@Column
