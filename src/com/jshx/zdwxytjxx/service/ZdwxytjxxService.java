package com.jshx.zdwxytjxx.service;
...
public interface ZdwxytjxxService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(Zdwxytjxx model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(Zdwxytjxx model);
