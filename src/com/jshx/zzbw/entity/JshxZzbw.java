...
@Entity
@Table(name="JSHX_ZZBW")
public class JshxZzbw extends BaseModel
{
	/**
	 * 部门代码
	 */
	 ...
	 * 装置、重点部位
	 */
	private String gjzzmc;
	/**
	 * 主要危险因素
	 */
	private String zywxys;
	/**
	 * 责任人
	 */
	private String zrr;
	...
	@Column(name="GJZZMC")
	public String getGjzzmc()
	{
		return this.gjzzmc;
	}

	public void setGjzzmc(String gjzzmc)
	{
		this.gjzzmc = gjzzmc;
	}

	@Column(name="ZYWXYS")
	public String getZywxys()
	{
		return this.zywxys;
	}

	public void setZywxys(String zywxys)
	{
		this.zywxys = zywxys;
	}
	...
	@Column(name="GWYGSL")
	public String getGwygsl()
	{
		return this.gwygsl;
	}

	public void setGwygsl(String gwygsl)
	{
		this.gwygsl = gwygsl;
	}
	@Column(name="PROID")
