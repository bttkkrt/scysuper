...
public class JshxPx {
	...
	public String getData26() {
		return Integer.parseInt(data16) + Integer.parseInt(data24)+Integer.parseInt(data25)+"";
	}
	...
	public String getData33() {
		return Integer.parseInt(data31)+Integer.parseInt(data32)+"";
	}
	public void setData33(String data33) {
		this.data33 = data33;
	}
	public String getData34() {
		return Integer.parseInt(data8)+Integer.parseInt(data16)+Integer.parseInt(data24)+Integer.parseInt(data25)+Integer.parseInt(data31)+Integer.parseInt(data32)+"";
	}
