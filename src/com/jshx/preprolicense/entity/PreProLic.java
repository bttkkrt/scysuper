package com.jshx.preprolicense.entity;
...
@Entity
@Table(name="PRE_PRO_LIC")
public class PreProLic extends BaseModel
{
	/**
	 * 部门代码
	 */
	...
	public PreProLic(String id, String areaId, String companyName, String licenseNumber, String productFlow, Date licenseValid, String issuingAuthority, Date issuingDate, Date receptDate, String receptName, String reviewName, String fileNo,String createUserID,String auditState){
this.id = id;
