...
public class ReviewSubmissionAction extends BaseAction
{
	...
	public void list() throws Exception{
		...
		final String filter = "id|relatedId|lawOfficer|";
		...
		pagination = reviewSubmissionService.findByPage(pagination, paraMap);
	...
	public String view() throws Exception{
		if((null != reviewSubmission)&&(null != reviewSubmission.getId()))
			reviewSubmission = reviewSubmissionService.getById(reviewSubmission.getId());
	...
	public String save() throws Exception{
		...
		if ("add".equalsIgnoreCase(this.flag)){
			reviewSubmission.setDeptId(this.getLoginUserDepartmentId());
	...
	private void setBlobField(FileInputStream in)
	{
		if (null != reviewSubmission)
		{
			try
			{
				//此处将File对象转换成blob对象，并设置到reviewSubmission中去
	...
	public String delete() throws Exception{
	    try{
			reviewSubmissionService.deleteWithFlag(ids);
