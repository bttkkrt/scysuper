...
public interface BehaviorLogParamDao extends BaseDao
{
	/**
	 * 分页查询
	 * @param page 分页信息
	 ...
	 * @param model 信息
	 */
	public void save(BehaviorLogParam model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(BehaviorLogParam model);
