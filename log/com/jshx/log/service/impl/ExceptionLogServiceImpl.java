...
public class ExceptionLogServiceImpl extends BaseServiceImpl implements ExceptionLogService
{
	...
	{
		return exceptionLogDao.findByPage(page, paraMap);
	}
	...
	{
		exceptionLogDao.update(exceptionLog);
	}
	...
	public void delete(String[] ids)
	{
		...
		List<?> objects=exceptionLogDao.findExceptionLog(paraMap);
		
		exceptionLogDao.removeAll(objects);
	}
		...
		if(null != idArray)
		{
			for(String id : idArray)
			{
			    if(id!=null && !id.trim().equals(""))
				    exceptionLogDao.deleteWithFlag(id);
			}
		}
	}
}
