...
/**  
 * @author   Chenjian
 * @version 创建时间：2011-1-26 上午09:35:47  
 * 以checkbox显示一维代码  
 */
public class CheckCodeValueTag extends TagSupport {

	private static final long serialVersionUID = 6044364422426352434L;
	...
	public int doEndTag() throws JspException{
		try{
			...
			for(CodeValue codeValue : valueList){
				sb.append("<input type='checkbox' id='").append(domId).append("' name='").append(domName).append("' ");
