package com.jshx.module.infomation.service;
...
public interface ContentAttachsService extends BaseService
{
	 ...
	 * @param model 信息
	 */
	public void save(ContentAttachs model);

	/**
	 * 修改信息
	 * @param model 信息
	 */
	public void update(ContentAttachs model);
