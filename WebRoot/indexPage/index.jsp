...
<head>
	...
	<link rel="shortcut icon" href="indexPage/img/favicon.ico">
	<link rel="stylesheet" type="text/css" href="indexPage/css/cloud-admin.css" >
	<link rel="stylesheet" type="text/css"  href="indexPage/css/themes/default.css" id="skin-switcher" >
	<link rel="stylesheet" type="text/css"  href="indexPage/css/responsive.css" >
	<!-- STYLESHEETS --><!--[if lt IE 9]><script src="js/flot/excanvas.min.js"></script><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><script src="http://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js"></script><![endif]-->
	<link href="indexPage/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<!-- ANIMATE -->
	<link rel="stylesheet" type="text/css" href="indexPage/css/animatecss/animate.min.css" />
	<!-- DATE RANGE PICKER -->
	<link rel="stylesheet" type="text/css" href="indexPage/js/bootstrap-daterangepicker/daterangepicker-bs3.css" />
	<!-- TODO -->
	<link rel="stylesheet" type="text/css" href="indexPage/js/jquery-todo/css/styles.css" />
	<!-- FULL CALENDAR -->
	<link rel="stylesheet" type="text/css" href="indexPage/js/fullcalendar/fullcalendar.min.css" />
	<!-- GRITTER -->
	<link rel="stylesheet" type="text/css" href="indexPage/js/gritter/css/jquery.gritter.css" />
	<!-- FONTS -->
...
<body>
		...
		<div class="container">
				<div class="navbar-brand">
					...
					<a href="${ctx}/index.action">
						<img src="indexPage/img/logo/logo.png" alt="Cloud Admin Logo" class="img-responsive" height="30" width="120">
					</a>
					<!-- /COMPANY LOGO -->
				...
				<ul class="nav navbar-nav pull-left hidden-xs" id="navbar-left">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu skins">
							...
							<li><a href="#" data-skin="default">美妙 (默认)</a></li>
				...
				<ul class="nav navbar-nav pull-right">
						...
						<ul class="dropdown-menu notification">
							...
							<li>
								<a href="#">
									...
									<span class="body">
										<span class="message">5 用户 在线. </span>
										<span class="time">
					...
					<li class="dropdown" id="header-message">
						...
						<ul class="dropdown-menu inbox">
							...
							<li>
								<a href="#">
									<img src="indexPage/img/avatars/avatar2.jpg" alt="" />
									<span class="body">
							...
							<li>
								<a href="#">
									<img src="indexPage/img/avatars/avatar1.jpg" alt="" />
									<span class="body">
							...
							<li>
								<a href="#">
									<img src="indexPage/img/avatars/avatar8.jpg" alt="" />
									<span class="body">
					...
					<li class="dropdown" id="header-tasks">
						...
						<ul class="dropdown-menu tasks">
							<li class="dropdown-title">
								<span><i class="fa fa-check"></i> 6 任务进程</span>
							</li>
							<li>
								<a href="#">
					...
					<li class="dropdown user" id="header-user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img alt="" src="indexPage/img/avatars/avatar3.jpg" />
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx }/logout.action"><i class="fa fa-power-off"></i> 登出</a></li>
						</ul>
					</li>
		  ...
		  <div id="teamslider">
			  <ul class="team-list">
				<li class="current">
				  ...
				  <span class="image">
					  <img src="indexPage/img/avatars/avatar3.jpg" alt="" />
				  </span>
				  <span class="title">
					You
				  </span>
				...
				<li>
				  <a href="javascript:void(0);">
				  <span class="image">
					  <img src="indexPage/img/avatars/avatar4.jpg" alt="" />
				  </span>
				  <span class="title">
					Ellie Doe
				  </span>
				...
				<li>
				  <a href="javascript:void(0);">
				  <span class="image">
					  <img src="indexPage/img/avatars/avatar5.jpg" alt="" />
				  </span>
				  <span class="title">
					Lisa Doe
				  </span>
				...
				<li>
				  <a href="javascript:void(0);">
				  <span class="image">
					  <img src="indexPage/img/avatars/avatar6.jpg" alt="" />
				  </span>
				  <span class="title">
					Kelly Doe
				  </span>
				...
				<li>
				  <a href="javascript:void(0);">
				  <span class="image">
					  <img src="indexPage/img/avatars/avatar7.jpg" alt="" />
				  </span>
				  <span class="title">
					Jessy Doe
				  </span>
					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
								...
								<c:if test="${not empty  module.moduleAddr}">
			 					...
			 					<c:if test="${module.hasChild>0}">
			 						<li class="has-sub">
										...
										<i class="fa fa-bookmark-o fa-fw"></i> <span class="menu-text">${module.moduleName}</span>
			  					...
			  					<c:if test="${module.hasChild==0}">
									<li class='item'>
										<li><a class="" href="${ctx}/${module.moduleAddr}" target="_blank"><i class="fa fa-desktop fa-fw"></i> <span class="menu-text">${module.moduleName}</span></a></li><li><a class="" href="inbox.html"><i class="fa fa-envelope-o fa-fw"></i> <span class="menu-text">${module.moduleName}</span></a></li>
									</li>
								</c:if>	
			 				</c:forEach>
							...
							<li class="has-sub">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/elements.html"><span class="sub-menu-text">Elements</span></a></li><li><a class="" href="notifications.html"><span class="sub-menu-text">Hubspot Notifications</span></a></li>
									<li><a class="" href="indexPage/buttons_icons.html"><span class="sub-menu-text">Buttons & Icons</span></a></li>
									<li><a class="" href="indexPage/sliders_progress.html"><span class="sub-menu-text">Sliders & Progress</span></a></li>
									<li><a class="" href="indexPage/typography.html"><span class="sub-menu-text">Typography</span></a></li>
									<li><a class="" href="indexPage/tabs_accordions.html"><span class="sub-menu-text">Tabs & Accordions</span></a></li>
									<li><a class="" href="indexPage/treeview.html"><span class="sub-menu-text">Treeview</span></a></li>
									<li><a class="" href="indexPage/nestable_lists.html"><span class="sub-menu-text">Nestable Lists</span></a></li>
							...
							<li><a class="" href="indexPage/frontend_theme/index.html" target="_blank"><i class="fa fa-desktop fa-fw"></i> <span class="menu-text">Frontend Theme</span></a></li><li><a class="" href="inbox.html"><i class="fa fa-envelope-o fa-fw"></i> <span class="menu-text">Inbox</span></a></li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/simple_table.html"><span class="sub-menu-text">Simple Tables</span></a></li>
									<li><a class="" href="indexPage/dynamic_tables.html"><span class="sub-menu-text">Dynamic Tables</span></a></li>
									<li><a class="" href="indexPage/jqgrid_plugin.html"><span class="sub-menu-text">jqGrid Plugin</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/forms.html"><span class="sub-menu-text">Forms</span></a></li>
									<li><a class="" href="indexPage/wizards_validations.html"><span class="sub-menu-text">Wizards & Validations</span></a></li>
									<li><a class="" href="indexPage/rich_text_editors.html"><span class="sub-menu-text">Rich Text Editors</span></a></li>
									
									<li><a class="" href="indexPage/dropzone_file_upload.html"><span class="sub-menu-text">Dropzone File Upload</span></a></li>
								</ul>
							</li>
							<li><a class="" href="indexPage/widgets_box.html"><i class="fa fa-th-large fa-fw"></i> <span class="menu-text">Widgets & Box</span></a></li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/flot_charts.html"><span class="sub-menu-text">Flot Charts</span></a></li>
									<li><a class="" href="indexPage/xcharts.html"><span class="sub-menu-text">xCharts</span></a></li>
									
									<li><a class="" href="indexPage/others.html"><span class="sub-menu-text">Others</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/mini_sidebar.html"><span class="sub-menu-text">Mini Sidebar</span></a></li>
									<li><a class="" href="indexPage/fixed_header.html"><span class="sub-menu-text">Fixed Header</span></a></li>
									
									<li><a class="" href="indexPage/fixed_header_sidebar.html"><span class="sub-menu-text">Fixed Header & Sidebar</span></a></li>
								</ul>
							</li>
							<li><a class="" href="indexPage/calendar.html"><i class="fa fa-calendar fa-fw"></i> 
							...
							<li class="has-sub">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/google_maps.html"><span class="sub-menu-text">Google Maps</span></a></li>
									<li><a class="" href="indexPage/vector_maps.html"><span class="sub-menu-text">Vector Maps</span></a></li>
								</ul>
							</li>
							<li><a class="" href="indexPage/gallery.html"><i class="fa fa-picture-o fa-fw"></i> <span class="menu-text">Gallery</span></a></li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/login.html"><span class="sub-menu-text">Login & Register Option 1</span></a></li><li><a class="" href="login_bg.html"><span class="sub-menu-text">Login & Register Option 2</span></a></li>
									<li><a class="" href="indexPage/user_profile.html"><span class="sub-menu-text">User profile</span></a></li>
									
									<li><a class="" href="indexPage/chats.html"><span class="sub-menu-text">Chats</span></a></li>
									<li><a class="" href="indexPage/todo_timeline.html"><span class="sub-menu-text">Todo & Timeline</span></a></li>
									<li><a class="" href="indexPage/address_book.html"><span class="sub-menu-text">Address Book</span></a></li>
									
									<li><a class="" href="indexPage/pricing.html"><span class="sub-menu-text">Pricing</span></a></li>
									<li><a class="" href="indexPage/invoice.html"><span class="sub-menu-text">Invoice</span></a></li>
									<li><a class="" href="indexPage/orders.html"><span class="sub-menu-text">Orders</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								...
								<ul class="sub">
									<li><a class="" href="indexPage/search_results.html"><span class="sub-menu-text">Search Results</span></a></li>
									<li><a class="" href="indexPage/email_templates.html"><span class="sub-menu-text">Email Templates</span></a></li>
									
									<li><a class="" href="indexPage/error_404.html"><span class="sub-menu-text">Error 404 Option 1</span></a></li><li><a class="" href="error_404_2.html"><span class="sub-menu-text">Error 404 Option 2</span></a></li><li><a class="" href="error_404_3.html"><span class="sub-menu-text">Error 404 Option 3</span></a></li>
									<li><a class="" href="indexPage/error_500.html"><span class="sub-menu-text">Error 500 Option 1</span></a></li><li><a class="" href="error_500_2.html"><span class="sub-menu-text">Error 500 Option 2</span></a></li>
									<li><a class="" href="indexPage/faq.html"><span class="sub-menu-text">FAQ</span></a></li>
									<li><a class="" href="indexPage/blank_page.html"><span class="sub-menu-text">Blank Page</span></a></li>
								</ul>
							</li>
						</ul>
						<!-- /SIDEBAR MENU -->
											...
											<ul class="media-list chat-list">
												<li class="media">
												  <a class="pull-left" href="#">
													<img class="media-object" alt="Generic placeholder image" src="indexPage/img/chat/headshot1.jpg">
												  </a>
												...
												<li class="media">
												  <a class="pull-right" href="#">
													<img class="media-object"  alt="Generic placeholder image" src="indexPage/img/chat/headshot2.jpg">
												  </a>
												...
												<li class="media">
												  <a class="pull-left" href="#">
													<img class="media-object"  alt="Generic placeholder image" src="indexPage/img/chat/headshot3.jpg">
												  </a>
												  <div class="media-body chat-pop">
												...
												<li class="media">
												  <a class="pull-left" href="#">
													<img class="media-object"  alt="Generic placeholder image" src="indexPage/img/chat/headshot5.jpg">
												  </a>
												  <div class="media-body chat-pop">
												...
												<li class="media">
												  <a class="pull-left" href="#">
													<img class="media-object"  alt="Generic placeholder image" src="indexPage/img/chat/headshot4.jpg">
												  </a>
												  <div class="media-body chat-pop">
	...
	<!-- JQUERY -->
	<script src="indexPage/js/jquery/jquery-2.0.3.min.js"></script>
	<!-- JQUERY UI-->
	<script src="indexPage/js/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min.js"></script>
	<!-- BOOTSTRAP -->
	<script src="indexPage/bootstrap-dist/js/bootstrap.min.js"></script>
	
		
	<!-- DATE RANGE PICKER -->
	<script src="indexPage/js/bootstrap-daterangepicker/moment.min.js"></script>
	
	<script src="indexPage/js/bootstrap-daterangepicker/daterangepicker.min.js"></script>
	<!-- SLIMSCROLL -->
	<script type="text/javascript" src="indexPage/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.min.js"></script>
	<!-- SLIMSCROLL -->
	<script type="text/javascript" src="indexPage/js/jQuery-slimScroll-1.3.0/slimScrollHorizontal.min.js"></script>
	<!-- BLOCK UI -->
	<script type="text/javascript" src="indexPage/js/jQuery-BlockUI/jquery.blockUI.min.js"></script>
	<!-- SPARKLINES -->
	<script type="text/javascript" src="indexPage/js/sparklines/jquery.sparkline.min.js"></script>
	<!-- EASY PIE CHART -->
	<script src="indexPage/js/jquery-easing/jquery.easing.min.js"></script>
	<script type="text/javascript" src="indexPage/js/easypiechart/jquery.easypiechart.min.js"></script>
	<!-- FLOT CHARTS -->
	<script src="indexPage/js/flot/jquery.flot.min.js"></script>
	<script src="indexPage/js/flot/jquery.flot.time.min.js"></script>
    <script src="indexPage/js/flot/jquery.flot.selection.min.js"></script>
	<script src="indexPage/js/flot/jquery.flot.resize.min.js"></script>
    <script src="indexPage/js/flot/jquery.flot.pie.min.js"></script>
    <script src="indexPage/js/flot/jquery.flot.stack.min.js"></script>
    <script src="indexPage/js/flot/jquery.flot.crosshair.min.js"></script>
	<!-- TODO -->
	<script type="text/javascript" src="indexPage/js/jquery-todo/js/paddystodolist.js"></script>
	<!-- TIMEAGO -->
	<script type="text/javascript" src="indexPage/js/timeago/jquery.timeago.min.js"></script>
	<!-- FULL CALENDAR -->
	<script type="text/javascript" src="indexPage/js/fullcalendar/fullcalendar.min.js"></script>
	<!-- COOKIE -->
	<script type="text/javascript" src="indexPage/js/jQuery-Cookie/jquery.cookie.min.js"></script>
	<!-- GRITTER -->
	<script type="text/javascript" src="indexPage/js/gritter/js/jquery.gritter.min.js"></script>
	<!-- CUSTOM SCRIPT -->
	<script src="indexPage/js/script.js"></script>
	<script>
