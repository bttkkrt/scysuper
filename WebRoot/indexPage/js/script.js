var App = function () {
	...
	var handleRaty = function () {
		$.fn.raty.defaults.path = 'indexPage/js/jquery-raty/img';
		...
		$('#starHalf-demo').raty({
			path    : 'indexPage/js/jquery-raty/img',
			half    : true,
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "indexPage/css/themes/" + color + ".css");
		...
		if ($.cookie('gritter_show')) {
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: 'indexPage/img/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
	...
	return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="indexPage/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
