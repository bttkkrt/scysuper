    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、姓名或资格证号"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、姓名或资格证号");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var chargerSpecializedNum=item.chargerSpecializedNum;
		                    		if(chargerSpecializedNum.length>10){
		                    			chargerSpecializedNum=chargerSpecializedNum.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+item.chargerName+"</td><td>"+chargerSpecializedNum+"</td><td>"
		                    		+item.chargerPhone+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProCha","添加安全生产分管负责人","${ctx}/zwt/secProChaInitEdit.action?flag=add&dt="+dt.getTime(),700,480);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProCha","修改安全生产分管负责人","${ctx}/zwt/secProChaInitEdit.action?flag=mod&secProCha.id="+row_Id+"&dt="+dt.getTime(),700,480);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProCha","查看安全生产分管负责人","${ctx}/zwt/secProChaView.action?secProCha.id="+row_Id+"&dt="+dt.getTime(),700,480);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	...
                	<li>
                		<a href="${ctx }/zwt/proManOrgList.action">管理机构</a>
                    </li>
                    <li>
                		<a href="${ctx }/zwt/entChaPerList.action">主要负责人</a>
                    </li>
                    <li>
                		<a class="active" href="${ctx }/zwt/secProChaList.action">分管负责人</a>
                    </li>
                     <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称、姓名或资格证号"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
