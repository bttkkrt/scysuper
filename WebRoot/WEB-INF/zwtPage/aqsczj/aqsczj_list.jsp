...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var majordomoSpecializedNum=item.majordomoSpecializedNum;
		                    		if(majordomoSpecializedNum.length>10){
		                    			majordomoSpecializedNum=majordomoSpecializedNum.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+item.majordomoName+"</td><td>"+majordomoSpecializedNum+"</td><td>"
		                    		+item.majordomoPhone+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProMaj","添加安全生产总监","${ctx}/zwt/secProMajInitEdit.action?flag=add&dt="+dt.getTime(),700,480);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProMaj","修改安全生产总监","${ctx}/zwt/secProMajInitEdit.action?flag=mod&secProMaj.id="+row_Id+"&dt="+dt.getTime(),700,480);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProMaj","查看安全生产总监","${ctx}/zwt/secProMajView.action?secProMaj.id="+row_Id+"&dt="+dt.getTime(),700,480);
            ...
            <div class="s_h_nav">
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/secProMajList.action">生产总监</a>
                    </li>
                     <li>
