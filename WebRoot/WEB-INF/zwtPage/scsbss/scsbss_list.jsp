    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、设备名称或车间名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、设备名称或车间名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.deviceCode+"</td><td>"+item.deviceName+"</td><td>"
		                    		+item.deviceWorkshopName+"</td>"
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_proDev","添加生产设备设施","${ctx}/zwt/proDevInitEdit.action?flag=add&dt="+dt.getTime(),700,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proDev","修改生产设备设施","${ctx}/zwt/proDevInitEdit.action?flag=mod&proDev.id="+row_Id+"&dt="+dt.getTime(),700,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proDev","查看生产设备设施","${ctx}/zwt/proDevView.action?proDev.id="+row_Id+"&dt="+dt.getTime(),700,550);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/proDevList.action">生产设备设施</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、设备名称或车间名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
