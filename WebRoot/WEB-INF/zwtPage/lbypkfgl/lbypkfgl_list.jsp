    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、用品名称或盘点人"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、用品名称或盘点人");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.ppeWareNum+"</td><td>"+item.ppeWareType+"</td><td>"
		                     		+item.ppeWarePeople+"</td>"
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_ppeWareManag","添加劳保用品库房管理","${ctx}/zwt/ppeWareManagInitEdit.action?flag=add&dt="+dt.getTime(),700,300);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_ppeWareManag","修改劳保用品库房管理","${ctx}/zwt/ppeWareManagInitEdit.action?flag=mod&ppeWareManag.id="+row_Id+"&dt="+dt.getTime(),700,300);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_ppeWareManag","查看劳保用品库房管理","${ctx}/zwt/ppeWareManagView.action?ppeWareManag.id="+row_Id+"&dt="+dt.getTime(),700,300);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/ppeWareManagList.action">劳保用品库房管理施</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/ppeUseManageList.action">劳保用品领用管理</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、用品名称或盘点人"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
