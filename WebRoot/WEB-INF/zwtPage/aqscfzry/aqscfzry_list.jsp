...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var chargeSpecializedNum=item.chargeSpecializedNum;
		                    		if(chargeSpecializedNum.length>10){
		                    			chargeSpecializedNum=chargeSpecializedNum.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+item.chargeName+"</td><td>"+chargeSpecializedNum+"</td><td>"
		                    		+item.chargePhone+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProChaPer","添加安全生产管理人员","${ctx}/zwt/secProChaPerInitEdit.action?flag=add&dt="+dt.getTime(),700,480);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProChaPer","修改安全生产管理人员","${ctx}/zwt/secProChaPerInitEdit.action?flag=mod&secProChaPer.id="+row_Id+"&dt="+dt.getTime(),700,480);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProChaPer","查看安全生产管理人员","${ctx}/zwt/secProChaPerView.action?secProChaPer.id="+row_Id+"&dt="+dt.getTime(),700,480);
            ...
            <div class="s_h_nav">
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/secProChaPerList.action">负责人员</a>
                    </li>
                     <li>
