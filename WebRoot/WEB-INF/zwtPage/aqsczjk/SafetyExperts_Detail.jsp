	...
	<form name="myform" method="post">
		...
		<div class="inner6px">
			...
			<table width="100%">
				...
				<tr>
					<th width="15%">工作记录</th>
					<td width="85%" colspan="3"><textarea readOnly name="safetyExperts.workRecord" style="width:96%;height:120px">${safetyExperts.workRecord}</textarea></td>
				</tr>
				<tr>
					<th width="15%">教育情况</th>
					<td width="85%" colspan="3"><textarea readOnly name="safetyExperts.educationSec" style="width:96%;height:120px">${safetyExperts.educationSec}</textarea></td>
				</tr>
			</table>
		</div></div></div>
	</form>
