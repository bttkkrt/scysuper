...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		var feeExtractRemark=item.feeExtractRemark;
		                    		if(feeExtractRemark.length>20){
		                    			feeExtractRemark=feeExtractRemark.substring(0,20)+"...";
		                    		}
		                    		//获取操作按钮
		                    		...
		                    		+item.feeExtractFee+"</td><td>"+item.feeExtractTime.substring(0,10)+"</td><td>"
		                    		+feeExtractRemark+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProFeeExt","添加安全生产费用提取情况","${ctx}/zwt/secProFeeExtInitEdit.action?flag=add&dt="+dt.getTime(),700,250);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProFeeExt","修改安全生产费用提取情况","${ctx}/zwt/secProFeeExtInitEdit.action?flag=mod&secProFeeExt.id="+row_Id+"&dt="+dt.getTime(),700,250);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProFeeExt","查看安全生产费用提取情况","${ctx}/zwt/secProFeeExtView.action?secProFeeExt.id="+row_Id+"&dt="+dt.getTime(),700,250);
...
<!-- head style -->
    	<div class="sipac_head">
        	<a href="#" class="s_h_logo"><i></i><span>③安全生产投入</span></a>
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/secProFeeExtList.action">安全生产费用提取情况</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/secProFeeAccList.action">安全生产费用使用台账</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/secProInsList.action">安全生产保险投保情况</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称或用途"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>提取费用 </span></th>
                        	<th><span>提取时间</span></th>
                        	<th><span>用途</span></th>
                        	<th ><span>操作项</span></th>
                        </tr>
  						</thead>
