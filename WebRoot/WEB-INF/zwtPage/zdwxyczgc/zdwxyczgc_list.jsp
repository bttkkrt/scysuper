    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、危险源名称或操作规程名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、危险源名称或操作规程名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.companyName+"</td><td>"+item.ruleName+"</td><td>"
		                    		+item.dangerName+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_comOpeRul","添加企业重点危险源的操作规程","${ctx}/zwt/comOpeRulInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comOpeRul","修改企业重点危险源的操作规程","${ctx}/zwt/comOpeRulInitEdit.action?flag=mod&comOpeRul.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comOpeRul","查看企业重点危险源的操作规程","${ctx}/zwt/comOpeRulView.action?comOpeRul.id="+row_Id+"&dt="+dt.getTime(),700,500);
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a href="${ctx }/zwt/comDanIdeList.action">重点危险源的识别评估分级</a>
                  </li>
                  ...
                  <li>
                   ...
                   <li>
                		<a class="active" href="${ctx }/zwt/comOpeRulList.action">重点危险源的操作规程</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、危险源名称或操作规程名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
