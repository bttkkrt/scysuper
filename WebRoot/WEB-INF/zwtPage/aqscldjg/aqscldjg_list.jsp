    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、机构名称或主要负责人"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、机构名称或主要负责人");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var orgenizationCharge=item.orgenizationCharge;
		                    		if(orgenizationCharge.length>10){
		                    			orgenizationCharge=orgenizationCharge.substring(0,10)+"...";
		                    		}
		                    		
		                    		var orgenizationMenberCount=item.orgenizationMenberCount;
		                    		if(orgenizationMenberCount.length>10){
		                    			orgenizationMenberCount=orgenizationMenberCount.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+orgenizationName+"</td><td>"+orgenizationMenberCount+"</td><td>"
		                    		+orgenizationCharge+"</td>"
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/proLegOrgList.action">领导机构</a>
                    </li>
                	<li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称、机构名称或主要负责人"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
