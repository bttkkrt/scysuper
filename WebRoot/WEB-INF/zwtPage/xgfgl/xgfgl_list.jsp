    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或相关方名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或相关方名称");
		        }
		    });
		});
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_partyManage","添加相关方管理","${ctx}/zwt/partyManageInitEdit.action?flag=add&dt="+dt.getTime(),700,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_partyManage","修改相关方管理","${ctx}/zwt/partyManageInitEdit.action?flag=mod&partyManage.id="+row_Id+"&dt="+dt.getTime(),700,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_partyManage","查看相关方管理","${ctx}/zwt/partyManageView.action?partyManage.id="+row_Id+"&dt="+dt.getTime(),700,550);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/partyManageList.action">相关方管理</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称或相关方名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
