    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、危险源名称或制度名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、危险源名称或制度名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.companyName+"</td><td>"+item.systemName+"</td><td>"
		                    		+item.dangerName+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_comManSys","添加企业重点危险源的管理制度","${ctx}/zwt/comManSysInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comManSys","修改企业重点危险源的管理制度","${ctx}/zwt/comManSysInitEdit.action?flag=mod&comManSys.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comManSys","查看企业重点危险源的管理制度","${ctx}/zwt/comManSysView.action?comManSys.id="+row_Id+"&dt="+dt.getTime(),700,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、危险源名称或制度名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
