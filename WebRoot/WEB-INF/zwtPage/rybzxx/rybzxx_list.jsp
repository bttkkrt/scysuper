    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、年度、荣誉称号或表彰部门"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、年度、荣誉称号或表彰部门");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var honor=item.honor;
		                    		var recognitionDept=item.recognitionDept;
		                    		if(honor.length>10){
		                    			honor=honor.substring(0,10)+"...";
		                    		}
		                    		if(recognitionDept.length>10){
		                    			recognitionDept=recognitionDept.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+item.bzyear.substring(0,4)+"</td><td>"+honor+"</td><td>"
		                    		+recognitionDept+"</td><td>"+item.auditState+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_honRec","添加荣誉表彰信息","${ctx}/zwt/honRecInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_honRec","修改荣誉表彰信息","${ctx}/zwt/honRecInitEdit.action?flag=mod&honRec.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_honRec","查看荣誉表彰信息","${ctx}/zwt/honRecView.action?honRec.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
         function check(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_honRec","审核","${ctx}/zwt/honRecCheck.action?flag=check&honRec.id="+row_Id+"&dt="+dt.getTime(),700,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
               <ul>
                    ...
                    <li>
                		<a class="active" href="${ctx }/zwt/honRecList.action">荣誉表彰</a>
                    </li>
                    <li>
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>年度  </span></th>
                        	<th><span>荣誉称号</span></th>
                        	<th><span>表彰部门 </span></th>
