...
<title>挂牌督办管理</title>
	...
	<script>
        ...
        function check(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_supervice","审核挂牌督办","${ctx}/jsp/gpdb/superviceCheck.action?flag=check&supervice.id="+row_Id+"&dt="+dt.getTime(),900,500);
...
{field:'op',title:'操作',width:100,formatter:function(value,rec){
	...
	var button2="<a class='btn_02_mini' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a class='btn_03_mini' onclick=check('"+rec.id+"')>审核<b></b></a>";
...
<body>
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<tr>
				<th width="15%">隐患名称</th>
				<td width="35%"><input name="supervice.dangerName" style="width:50%" dataType="*1-127" id="dangerName" value="${supervice.dangerName}" type="text" maxlength="127"></td>
				<th width="15%">隐患类别</th>
