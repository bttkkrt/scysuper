...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var dangerName=item.dangerName;
		                    		if(dangerName.length>10){
		                    			dangerName=dangerName.substring(0,10)+"...";
		                    		}
		                    		var tr="";
		                    		if(idx%2==0){
		                    		...
		                    		+item.companyName+"</td><td>"+dangerName+"</td><td>"
		                    		+item.dangerSort+"</td><td>"+item.dangerLevel+"</td><td>"
		                    		+item.rectificationLevel+"</td><td>"+item.rectificationState+"</td>"
        ...
        function getButton(rec){
			...
			var button5="<a style='color:blue' href='#' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a style='color:blue' href='#' onclick=report('"+rec.id+"')>整改上报<b></b></a>";
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	...
                	<li>
                		<a class="active" href="${ctx }/zwt/superviceList.action">挂牌督办管理</a>
                	</li>
                </ul>
            </div>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" type="text" id="searchLike" value="搜索企业名称或隐患名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
