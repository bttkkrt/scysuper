...
<body validform="true" style="overflow: auto;">
   <div class="box_01 boxBmargin12 submitdata" style="overflow-y: auto;overflow-x: hidden;padding: 0;top: 0px;left: 0px;right: 0px;bottom: 0;position: absolute; ">
	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="superviceCheckSave.action">
		<s:token />
		<input type="hidden" name="flag" value="${flag}">
		<input type="hidden" name="supervice.id" value="${supervice.id}">
		<input type="hidden" name="checkRecord.infoId" value="${supervice.id}">
			<table width="100%" border="0">
				...
				<c:if test="${fn:length(rectInfos) >0}">
				...
				<tr>
					<th width="15%">审核结果</th>
					<td width="96%" colspan="3">
					<s:select name="checkRecord.checkResult" list="#{'审批通过':'审批通过','审批未通过':'审批未通过'}" theme="simple"/>
					</td>
				</tr>
				<tr>
					<th width="15%">备注</th>
