		...
		<input type="hidden" name="entBaseInfo.id" value="${entBaseInfo.id}">
			<table width="100%" border="0">
				...
				<tr>
					<th width="15%">所属网格</th>
					<td width="35%">
						<cus:SelectOneTag property="entBaseInfo.grid" defaultText='请选择' codeSql="select t.row_id,t.GRID_NAME from COM_GRI_MAN t where t.delflag = 0" value="${entBaseInfo.grid}" datatype="*1-127" errormsg='所属网格必须是1到127位字符！' nullmsg='所属网格不能为空！' sucmsg='所属网格填写正确！'  maxlength="127" onchange="deptChange();"/><font style='color:red'>*</font>
					</td>
					<th width="15%">网格管理人员</th>
					<td width="35%"><span id="personTd"><cus:SelectOneTag property="entBaseInfo.gridManageId" defaultText='请选择' codeSql="select u.row_id AS ID,u.DISPLAY_NAME from USERS u where  u.DEL_FLAG=0 and  u.DEPT_CODE='${entBaseInfo.gridManageteamCode}'" value="${entBaseInfo.gridManageId}" /></span></td>
				</tr>
				<tr>
					<th width="15%">经营范围</th>
