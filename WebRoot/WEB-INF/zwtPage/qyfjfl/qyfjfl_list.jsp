...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function view(row_Id){
        	var dt=new Date();
        	createSimpleWindow("win_enterpriseGrade","查看分级分类评分","${ctx}/zwt/enterpriseGradeView.action?enterpriseGrade.id="+row_Id+"&dt="+dt.getTime(),1000,550);
            ...
            <div class="s_h_nav">
               <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/enterpriseGradeList.action">分级分类评分</a>
                    </li>
                </ul>
            </div>
