    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或项目负责人"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或项目负责人");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.personInCharge+"</td><td>"+item.jobTime.substring(0,10)+"</td>"
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_productionManage","添加生产现场管理和生产过程控制","${ctx}/zwt/productionManageInitEdit.action?flag=add&dt="+dt.getTime(),800,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_productionManage","修改生产现场管理和生产过程控制","${ctx}/zwt/productionManageInitEdit.action?flag=mod&productionManage.id="+row_Id+"&dt="+dt.getTime(),800,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_productionManage","查看生产现场管理和生产过程控制","${ctx}/zwt/productionManageView.action?productionManage.id="+row_Id+"&dt="+dt.getTime(),800,550);
...
<!-- head style -->
    	<div class="sipac_head">
        	<a href="#" class="s_h_logo"><i></i><span>⑥企业作业安全</span></a>
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a href="${ctx }/zwt/workshopList.action">生产车间</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/proDevList.action">生产设备设施</a>
                  </li>
                  <li>
                		<a class="active" href="${ctx }/zwt/productionManageList.action">生产现场管理和生产过程控制</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/publicBoardList.action">公告栏</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/informCardList.action">告知卡</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/signsList.action">安全标志</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/partyManageList.action">相关方管理</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称或项目负责人"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>项目负责人 </span></th>
                          <th><span>作业时间 </span></th>
