...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+index+++"</td>";
		                    		tr+="<td><a onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >" + getSpanByName(item.zjContent) + "</a></td>";
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_caseZj","添加案件证据","${ctx}/zwt/uploadZjlbInitEdit.action?flag=add&caseZj.caseId=${caseZj.caseId}&dt="+dt.getTime(),900,550);
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_caseZj","修改案件证据","${ctx}/zwt/uploadZjlbInitEdit.action?flag=mod&caseZj.id="+row_Id+"&dt="+dt.getTime(),900,550);
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_caseZj","查看案件证据","${ctx}/zwt/uploadZjlbView.action?caseZj.id="+row_Id+"&dt="+dt.getTime(),900,550);
        }
