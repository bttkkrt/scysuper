...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_newWorTra","添加新员工上岗培训","${ctx}/zwt/newWorTraInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_newWorTra","修改新员工上岗培训","${ctx}/zwt/newWorTraInitEdit.action?flag=mod&newWorTra.id="+row_Id+"&dt="+dt.getTime(),800,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/newWorTraList.action">新员工上岗</a>
                  </li>
                  <li>
