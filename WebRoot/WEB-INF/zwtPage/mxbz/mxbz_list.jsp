    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或清单名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或清单名称");
		        }
		    });
		});
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_signs","添加安全标识","${ctx}/zwt/signsInitEdit.action?flag=add&dt="+dt.getTime(),1000,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_signs","修改安全标识","${ctx}/zwt/signsInitEdit.action?flag=mod&signs.id="+row_Id+"&dt="+dt.getTime(),1000,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_signs","查看安全标识","${ctx}/zwt/signsView.action?signs.id="+row_Id+"&dt="+dt.getTime(),1000,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/signsList.action">安全标志</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称或清单名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
