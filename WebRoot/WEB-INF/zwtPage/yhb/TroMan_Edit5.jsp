	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="troManSaveAJ.action">
		...
		<input name="troMan.rectificationState" value="${troMan.rectificationState}" type="hidden" maxlength="127">
			...
			<table width="100%" border="0">
				<tr>
					<th width="15%">隐患名称</th>
					<td width="35%"><input name="troMan.troubleName" value="${troMan.troubleName}" type="text" maxlength="127" datatype="*1-127" errormsg='隐患名称必须是1到127位字符！' nullmsg='隐患名称不能为空！' sucmsg='隐患名称填写正确！' style="width:60%"><font style='color:red'>*</font></td>
					<th width="15%">隐患来源</th>
					<td width="35%">
				...
				<s:else>
					<tr>
						<th width="15%">所在区域</th>
						<td width="35%">
							<cus:SelectOneTag property="troMan.areaId" defaultText='请选择' codeName="企业属地" value="${troMan.areaId}" onchange="clearCompany();saveSelText('areaName',jQuery('#areaId  option:selected').text())" datatype="*1-127" errormsg='所在区域必须是1到127位字符！' nullmsg='所在区域不能为空！' sucmsg='所在区域填写正确！' style="width:60%"/><font style='color:red'>*</font>
				...
				<tr>
					<th width="15%">上报时间</th>
					<td width="35%"><input name="troMan.reportTime" style="width:60%" value="<fmt:formatDate  pattern="yyyy-MM-dd" type='both' value='${troMan.reportTime}' />" type="text" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="*1-127" errormsg='上报时间必须是1到127位字符！' nullmsg='上报时间不能为空！' sucmsg='上报时间填写正确！'><font style='color:red'>*</font></td>
					<th width="15%">隐患地点</th>
				...
				<tr>
					<th width="15%">整改期限</th>
					<td width="35%">
						<input  name="troMan.rectificationTerm"  style="width:60%" type="text" class="Wdate" value="<fmt:formatDate type="both"  pattern="yyyy-MM-dd" value='${troMan.rectificationTerm}' />" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="*1-127" errormsg='整改期限必须是1到127位字符！' nullmsg='整改期限不能为空！' sucmsg='整改期限填写正确！'><font style='color:red'>*</font>
					</td>
					
					<th width="15%">检查项</th>
					<td width="35%">
						<cus:SelectOneTag property="troMan.checkItem" defaultText='请选择' style="width:60%" codeSql="select t.row_id,PATROL_NAME from PAT_MAN t where t.delflag = 0" value="${troMan.checkItem}" datatype="*"/><font style='color:red'>*</font>
					</td>
				</tr>
				<tr>
					<th width="15%">隐患级别</th>
