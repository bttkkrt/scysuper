	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="troManSaveAJ.action">
		...
		<input name="troMan.rectificationState" value="${troMan.rectificationState}" type="hidden" maxlength="127">
			...
			<table width="100%" border="0">
				<tr>
					<th width="15%">隐患名称</th>
					<td width="35%"><input name="troMan.troubleName" style="width:60%" value="${troMan.troubleName}" type="text" maxlength="127" datatype="*1-127" errormsg='隐患名称必须是1到127位字符！' nullmsg='隐患名称不能为空！' sucmsg='隐患名称填写正确！'><font style='color:red'>*</font></td>
					<th width="15%">隐患来源</th>
					<td width="35%">
