...
<body validform="true" style="overflow: auto;">
   <div class="box_01 boxBmargin12 submitdata" style="overflow-y: auto;overflow-x: hidden;padding: 0;top: 0px;left: 0px;right: 0px;bottom: 0;position: absolute; ">
	...
	<form class="checkform" name="myform1" method="post" enctype="multipart/form-data" action="troManCaseSave.action">
		<s:token />
		...
		<input type="hidden" name="caseInfo.underTime" value="${caseInfo.underTime}">
			...
			<table width="100%" border="0">
				<tr>
					...
					<th width="15%">案件时间</th>
					<td width="35%"><input name="caseInfo.caseTime" value="<fmt:formatDate type='date' value='${caseInfo.caseTime}'/>" type="text" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="*1-127"  nullmsg='案件时间不能为空！' sucmsg='案件时间填写正确！'  maxlength="127" style="width:60%"><font style='color:red'>*</font></td>
				</tr>
				<tr>
					<th width="15%">案发区域</th>
				...
				<tr id="sgdiv1" style="display:none">
					<th width="15%">轻伤人数</th>
					<td width="35%"><input name="caseInfo.miborNum" value="${caseInfo.miborNum}" type="text" datatype="*1-127" errormsg='轻伤人数必须是1到127位字符！' nullmsg='轻伤人数不能为空！' sucmsg='轻伤人数填写正确！'  maxlength="127" style="width:60%" class="clsdiv1"><font style='color:red'>*</font></td>
					<th width="15%">重伤人数</th>
					<td width="35%"><input name="caseInfo.injuriesNum" value="${caseInfo.injuriesNum}" type="text" datatype="*1-127" errormsg='重伤人数必须是1到127位字符！' nullmsg='重伤人数不能为空！' sucmsg='重伤人数填写正确！'  maxlength="127" style="width:60%" class="clsdiv1"><font style='color:red'>*</font></td>
				</tr>
				<tr id="sgdiv2" style="display:none">
					<th width="15%">死亡人数</th>
					<td width="35%"><input name="caseInfo.dieNum" value="${caseInfo.dieNum}" type="text" datatype="*1-127" errormsg='死亡人数必须是1到127位字符！' nullmsg='死亡人数不能为空！' sucmsg='死亡人数填写正确！'  maxlength="127" style="width:60%" class="clsdiv1"><font style='color:red'>*</font></td>
					<th width="15%">事故级别</th>
				...
				<tr id="sgdiv3" style="display:none">
					<th width="15%">事故类别</th>
