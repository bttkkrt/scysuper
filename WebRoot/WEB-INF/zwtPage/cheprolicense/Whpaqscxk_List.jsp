...
$(function()
{
        ...
        kkpager.init({
            ...
            //链接前部
            hrefFormer: '${ctx}/wzxx/whpaqscxkList',
            //链接尾部
            hrefLatter: '.action',
            getLink: function (n) {
...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">危化品安全生产许可证查询</a></p></div>
    <div class="news_list">
    <ul>
    	<c:forEach var="whpaqscxk" items="${whpaqscxkList}">
    	  <li><a href="${ctx}/wzxx/whpaqscxkContent.action?cheProLic.id=${whpaqscxk.id}">${whpaqscxk.companyName}</a><fmt:formatDate type="date" value="${whpaqscxk.createTime}" pattern="yyyy-MM-dd"/></li>
