			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+item.enterpriseName+"</td><td>"+item.enterprisePossessionName+"</td><td>"
		                    		+item.registrationNumber+"</td><td>"+item.enterpriseCode+"</td><td>"
		                    		+item.enterpriseLegalName+"</td><td>"+item.enterpriseNature+"</td><td>"
		                    		+item.gridName+"</td><td class='s_t_control'><a style='color:blue' href='#' onclick=view('"+item.id+"','"+item.enterpriseName+"')>详情</a></tr>";
		                    		trs+=tr;
								});
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
               <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/entBaseInfoListZwt.action">企业基本信息</a>
                    </li>
                	<li>
