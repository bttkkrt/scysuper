...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.startTime.substring(0,10) + "~" + item.endTime.substring(0,10)+"</td><td>"+state+"</td><td>"
		                    		+item.zpzf+"</td><td>"+item.ajzf+"</td>"
        ...
        function getButton(rec){
        	if('${roleName}'=='1'){//网格管理员
				if(rec.state=='1'){
					return "<a class='btn_01_mini' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a class='btn_01_mini' onclick=edit('"+rec.id+"')>审核<b></b></a>";
				}else{
        ...
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_companyScore","审核标准化评分","${ctx}/zwt/companyScoreInitEdit.action?flag=mod&companyScore.id="+row_Id+"&dt="+dt.getTime(),900,550);
            ...
            <div class="s_h_nav">
               <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/companyScoreList.action">标准化评分</a>
                    </li>
                     <li>
