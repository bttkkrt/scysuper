...
<head>
<title>安全生产分管负责人培训管理</title>
    <%@include file="/common/jsLib.jsp"%><link href="${ctx}/webResources/zwt/css/sipac.css" rel="stylesheet">
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_chargeTraining","添加安全生产分管负责人培训","${ctx}/jsp/aqscfgfzrpx/chargeTrainingInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_chargeTraining","修改安全生产分管负责人培训","${ctx}/jsp/aqscfgfzrpx/chargeTrainingInitEdit.action?flag=mod&chargeTraining.id="+row_Id+"&dt="+dt.getTime(),800,500);
        ...
        function search_chargeTraining(){
        	var queryParams = {
				"chargeTraining.areaId": $("#areaId").val(),
...
"chargeTraining.trainingCardnum": $("#trainingCardnum").val(),
"chargeTraining.trainingPersonName": $("#trainingPersonName").val(),
"chargeTraining.companyName": $("#companyName").val()
			};        	
        ...
        var toolbar = [];
        	...
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				title:'安全生产分管负责人培训列表',
				url:'chargeTrainingQuery.action',
				queryParams:{
				"chargeTraining.areaId": $("#areaId").val(),
 "queryTrainingTimeStart" :$("#queryTrainingTimeStart").val(),
 "queryTrainingTimeEnd" :$("#queryTrainingTimeEnd").val(),
    ...
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<table width="100%">
				...
				<th width="15%">所在区域</th>
				<td width="35%"><cus:SelectOneTag property="chargeTraining.areaId" style="width:50%" defaultText='请选择' codeName="企业属地" value="${chargeTraining.areaId}"  maxlength="127"/></td>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="chargeTraining.companyName" style="width:50%" id="companyName" value="${chargeTraining.companyName}" type="text" maxlength="127"></td>
			</tr></s:if>
			<tr>
				<th width="15%">安全生产分管负责人姓名</th>
				<td width="35%"><input name="chargeTraining.trainingPersonName" style="width:50%" id="trainingPersonName" value="${chargeTraining.trainingPersonName}" type="text" maxlength="127"></td>
				<th width="15%">证书号码</th>
				<td width="35%"><input id="trainingCardnum" style="width:50%" name="chargeTraining.trainingCardnum" value="${chargeTraining.trainingCardnum}" type="text"  maxlength="127"></td>
			</tr>
			<tr>	
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_chargeTraining()" >查询<b></b></a>&nbsp;
