...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_chargeTraining","添加安全生产分管负责人培训","${ctx}/zwt/chargeTrainingInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_chargeTraining","修改安全生产分管负责人培训","${ctx}/zwt/chargeTrainingInitEdit.action?flag=mod&chargeTraining.id="+row_Id+"&dt="+dt.getTime(),800,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/chargeTrainingList.action">分管负责人</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/managerTrainingList.action">管理经理</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/majordomoTrainingList.action">安全生产总监</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称、姓名或证书号码"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
