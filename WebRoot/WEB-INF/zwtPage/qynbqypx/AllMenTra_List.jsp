...
<head>
<title>企业内部全员培训管理</title>
    <%@include file="/common/jsLib.jsp"%><link href="${ctx}/webResources/zwt/css/sipac.css" rel="stylesheet">
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_allMenTra","添加企业内部全员培训","${ctx}/jsp/qynbqypx/allMenTraInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_allMenTra","修改企业内部全员培训","${ctx}/jsp/qynbqypx/allMenTraInitEdit.action?flag=mod&allMenTra.id="+row_Id+"&dt="+dt.getTime(),800,500);
        ...
        function search_allMenTra(){
        	var queryParams = {
				"allMenTra.areaId": $("#areaId").val(),
"allMenTra.companyName": $("#companyName").val(),
...
"allMenTra.trainingName": $("#trainingName").val()
			};        	
    ...
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<table width="100%">
				...
				<th width="15%">所在区域</th>
				<td width="35%"><cus:SelectOneTag property="allMenTra.areaId" style="width:50%" defaultText='请选择' codeName="企业属地" value="${allMenTra.areaId}" /></td>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="allMenTra.companyName" style="width:50%" id="companyName" value="${allMenTra.companyName}" type="text" maxlength="127"></td>
			</tr></s:if>
			<tr>
				<th width="15%">培训班名称</th>
				<td width="35%"><input name="allMenTra.trainingName" style="width:50%" id="trainingName" value="${allMenTra.trainingName}" type="text" maxlength="127"></td>
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_allMenTra()" >查询<b></b></a>&nbsp;
