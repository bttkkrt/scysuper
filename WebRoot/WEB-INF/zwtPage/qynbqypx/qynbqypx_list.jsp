    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或培训班名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或培训班名称");
		        }
		    });
		});
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_allMenTra","添加企业内部全员培训","${ctx}/zwt/allMenTraInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_allMenTra","修改企业内部全员培训","${ctx}/zwt/allMenTraInitEdit.action?flag=mod&allMenTra.id="+row_Id+"&dt="+dt.getTime(),800,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/allMenTraList.action">企业内部全员</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称或培训班名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
