    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或承保保险公司"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或承保保险公司");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.insuranceCompnay+"</td><td>"+item.insuranceTime.substring(0,10)+"</td><td>"
		                    		+item.insuranceWorkerCount+"</td>"
        ...
        function getButton(rec){
           ...
           function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProIns","添加安全生产保险投保情况","${ctx}/zwt/secProInsInitEdit.action?flag=add&dt="+dt.getTime(),1100,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProIns","修改安全生产保险投保情况","${ctx}/zwt/secProInsInitEdit.action?flag=mod&secProIns.id="+row_Id+"&dt="+dt.getTime(),1100,500);
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a href="${ctx }/zwt/secProFeeExtList.action">安全生产费用提取情况</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/secProFeeAccList.action">安全生产费用使用台账</a>
                  </li>
                  <li>
                		<a class="active" href="${ctx }/zwt/secProInsList.action">安全生产保险投保情况</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称或承保保险公司"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
