...
<head>
<title>安全生产总监培训管理</title>
    <%@include file="/common/jsLib.jsp"%><link href="${ctx}/webResources/zwt/css/sipac.css" rel="stylesheet">
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_majordomoTraining","添加安全生产总监培训","${ctx}/jsp/aqsczjpx/majordomoTrainingInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_majordomoTraining","修改安全生产总监培训","${ctx}/jsp/aqsczjpx/majordomoTrainingInitEdit.action?flag=mod&majordomoTraining.id="+row_Id+"&dt="+dt.getTime(),800,500);
        ...
        function del(){
			...
			if(rows.length<1){
			    ...
			    $.messager.confirm("删除","确定要删除吗?",function(result){
			        if(result){
		                $.ajax({
		                	url : "majordomoTrainingDel.action",
		                	type: 'post',
		                    dataType: 'json',
		                    async : false,
		                    data:{ 
        ...
        function search_majordomoTraining(){
        	var queryParams = {
				"majordomoTraining.areaId": $("#areaId").val(),
...
"majordomoTraining.trainingCardnum": $("#trainingCardnum").val(),
"majordomoTraining.trainingPersonName": $("#trainingPersonName").val(),
"majordomoTraining.companyName": $("#companyName").val()
			};        	
        ...
        var toolbar = [];
        	...
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				title:'安全生产总监培训列表',
				url:'majordomoTrainingQuery.action',
				queryParams:{
					"majordomoTraining.areaId": $("#areaId").val(),
 "queryTrainingTimeStart" :$("#queryTrainingTimeStart").val(),
 "queryTrainingTimeEnd" :$("#queryTrainingTimeEnd").val(),
    ...
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<table width="100%">
				...
				<th width="15%">所在区域</th>
				<td width="35%"><cus:SelectOneTag property="majordomoTraining.areaId" style="width:50%" defaultText='请选择' codeName="企业属地" value="${majordomoTraining.areaId}"  maxlength="127"/></td>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="majordomoTraining.companyName" style="width:50%" id="companyName" value="${majordomoTraining.companyName}" type="text" maxlength="127"></td>
			</tr></s:if>
			<tr>
				<th width="15%">安全生产总监姓名</th>
				<td width="35%"><input name="majordomoTraining.trainingPersonName" style="width:50%" id="trainingPersonName" value="${majordomoTraining.trainingPersonName}" type="text" maxlength="127"></td>
				<th width="15%">证书号码</th>
				<td width="35%"><input id="trainingCardnum" name="majordomoTraining.trainingCardnum" style="width:50%" value="${majordomoTraining.trainingCardnum}" type="text"  maxlength="127"></td>
			</tr>
			<tr>	
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_majordomoTraining()" >查询<b></b></a>&nbsp;
