    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、姓名或证书号码"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、姓名或证书号码");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.trainingPersonName+"</td><td>"+item.trainingCardnum+"</td><td>"
		                    		+item.trainingTime.substring(0,11)+"</td><td>"+item.trainingTimeEnd.substring(0,11)+"</td>"
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_majordomoTraining","添加安全生产总监培训","${ctx}/zwt/majordomoTrainingInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_majordomoTraining","修改安全生产总监培训","${ctx}/zwt/majordomoTrainingInitEdit.action?flag=mod&majordomoTraining.id="+row_Id+"&dt="+dt.getTime(),800,500);
...
<!-- head style -->
    	<div class="sipac_head">
        	<a href="#" class="s_h_logo"><i></i><span>⑤教育培训</span></a>
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a href="${ctx }/zwt/maiChaTraList.action">主要负责人</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/chargeTrainingList.action">分管负责人</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/managerTrainingList.action">管理经理</a>
                  </li>
                  <li>
                		<a class="active" href="${ctx }/zwt/majordomoTrainingList.action">安全生产总监</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/secProChaTraList.action">负责人员</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/speJobTraList.action">特种人员</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/teaLeaTraList.action">班组长</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/newWorTraList.action">新员工上岗</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/allMenTraList.action">企业内部全员</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、姓名或证书号码"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>安全生产总监姓名 </span></th>
                        	<th><span>证书号码 </span></th>
                        	<th><span>培训开始时间 </span></th>
                        	<th><span>培训结束时间 </span></th>
