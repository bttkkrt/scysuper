...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var commitmentContent=item.commitmentContent;
		                    		if(commitmentContent.length>10){
		                    			commitmentContent=commitmentContent.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+item.commitmentYear.substring(0,4)+"</td><td>"+commitmentContent+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_proCom","添加企业安全生产承诺","${ctx}/zwt/proComInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proCom","修改企业安全生产承诺","${ctx}/zwt/proComInitEdit.action?flag=mod&proCom.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proCom","查看企业安全生产承诺","${ctx}/zwt/proComView.action?proCom.id="+row_Id+"&dt="+dt.getTime(),700,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
               <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/proComList.action">安全生产承诺</a>
                    </li>
                     <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" type="text" id="ids" value="搜索企业名称或组织机构代码"><input class="s_s_btn" type="submit" 

onclick="searchByNameOrCode();"> 
