...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_informCard","添加告知卡","${ctx}/zwt/informCardInitEdit.action?flag=add&dt="+dt.getTime(),1000,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_informCard","修改告知卡","${ctx}/zwt/informCardInitEdit.action?flag=mod&informCard.id="+row_Id+"&dt="+dt.getTime(),1000,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_informCard","查看告知卡","${ctx}/zwt/informCardView.action?informCard.id="+row_Id+"&dt="+dt.getTime(),1000,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/informCardList.action">告知卡</a>
                  </li>
                  <li>
