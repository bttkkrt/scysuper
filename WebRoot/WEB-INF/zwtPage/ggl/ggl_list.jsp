...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_publicBoard","添加公告栏","${ctx}/zwt/publicBoardInitEdit.action?flag=add&dt="+dt.getTime(),1000,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_publicBoard","修改公告栏","${ctx}/zwt/publicBoardInitEdit.action?flag=mod&publicBoard.id="+row_Id+"&dt="+dt.getTime(),1000,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_publicBoard","查看公告栏","${ctx}/zwt/publicBoardView.action?publicBoard.id="+row_Id+"&dt="+dt.getTime(),1000,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/publicBoardList.action">公告栏</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
