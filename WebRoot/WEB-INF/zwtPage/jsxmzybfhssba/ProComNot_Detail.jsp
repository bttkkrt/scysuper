			...
			<tr>
				...
				<tr>
					<td style="text-align: right;font-family:仿宋_GB2312;font-size: 14.0pt">
						（${proComNot.proNo}）安职预备字〔${proComNot.preparatoryWord}〕第 ${proComNot.arranging} 号
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<cus:hxlabel codeName="企业属地" itemValue="${proComNot.areaId}" />${proComNot.companyName}:
				</tr>
				<tr>
					<td height="20px">
					</td>
				...
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
					   &nbsp;&nbsp;&nbsp; 你单位    &nbsp; <fmt:formatDate type="date" value="${proComNot.proDate}" pattern="yyyy-MM-dd"/>  &nbsp;提请备案的&nbsp;${proComNot.projectName}&nbsp; 职业病危害控制效果评价报告、自行组织评审与验收的意见和情况报告以及其他相关文件、资料收悉。经核实，提交的文件、资料齐全，符合有关规定，现予以备案。
					</td>
				</tr>
				<tr>
					<td height="50px">
				...
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
					经 办 人：&nbsp;${proComNot.conPeople}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
					联系电话：&nbsp;${proComNot.conPhone}
					</td>
				</tr>
				<tr>
					<td height="50px">
				...
				<tr>
				<td style="text-align: right;font-family:仿宋_GB2312;font-size: 16.0pt">
				<fmt:formatDate type="date" value="${proComNot.createTime}" pattern="yyyy-MM-dd"/>
				</td>
				</tr>
				<tr>
					<td>
