...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var managerSpecializedNum=item.managerSpecializedNum;
		                    		if(managerSpecializedNum.length>10){
		                    			managerSpecializedNum=managerSpecializedNum.substring(0,10)+"...";
		                    		}
		                    		...
		                    		+item.managerName+"</td><td>"+managerSpecializedNum+"</td><td>"
		                    		+item.managerPhone+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProMan","添加安全生产管理经理","${ctx}/zwt/secProManInitEdit.action?flag=add&dt="+dt.getTime(),700,480);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProMan","修改安全生产管理经理","${ctx}/zwt/secProManInitEdit.action?flag=mod&secProMan.id="+row_Id+"&dt="+dt.getTime(),700,480);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProMan","查看安全生产管理经理","${ctx}/zwt/secProManView.action?secProMan.id="+row_Id+"&dt="+dt.getTime(),700,480);
            ...
            <div class="s_h_nav">
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/secProManList.action">管理经理</a>
                    </li>
                     <li>
