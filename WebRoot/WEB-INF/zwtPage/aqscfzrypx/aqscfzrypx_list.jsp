...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProChaTra","添加安全生产负责人员培训","${ctx}/zwt/secProChaTraInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProChaTra","修改安全生产负责人员培训","${ctx}/zwt/secProChaTraInitEdit.action?flag=mod&secProChaTra.id="+row_Id+"&dt="+dt.getTime(),800,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/secProChaTraList.action">负责人员</a>
                  </li>
                  <li>
