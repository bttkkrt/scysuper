...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_maiChaTra","添加企业主要负责人培训","${ctx}/jsp/qyzyfzrpx/maiChaTraInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_maiChaTra","修改企业主要负责人培训","${ctx}/jsp/qyzyfzrpx/maiChaTraInitEdit.action?flag=mod&maiChaTra.id="+row_Id+"&dt="+dt.getTime(),800,500);
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/maiChaTraList.action">主要负责人</a>
                  </li>
                  <li>
