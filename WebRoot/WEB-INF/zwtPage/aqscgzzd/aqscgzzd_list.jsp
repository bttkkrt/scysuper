    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或制度名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或制度名称");
		        }
		    });
		});
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_secProSys","添加安全生产规章制度","${ctx}/zwt/secProSysInitEdit.action?flag=add&dt="+dt.getTime(),750,400);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProSys","修改安全生产规章制度","${ctx}/zwt/secProSysInitEdit.action?flag=mod&secProSys.id="+row_Id+"&dt="+dt.getTime(),750,400);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_secProSys","查看安全生产规章制度","${ctx}/zwt/secProSysView.action?secProSys.id="+row_Id+"&dt="+dt.getTime(),750,400);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/secProSysList.action">安全生产规章制度</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称或制度名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
