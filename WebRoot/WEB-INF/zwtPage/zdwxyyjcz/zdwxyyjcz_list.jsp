    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、危险源名称或应急处置名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、危险源名称或应急处置名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.companyName+"</td><td>"+item.emergencyName+"</td><td>"
		                    		+item.dangerName+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_comDanEme","添加企业重点危险源的应急处置","${ctx}/zwt/comDanEmeInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comDanEme","修改企业重点危险源的应急处置","${ctx}/zwt/comDanEmeInitEdit.action?flag=mod&comDanEme.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comDanEme","查看企业重点危险源的应急处置","${ctx}/zwt/comDanEmeView.action?comDanEme.id="+row_Id+"&dt="+dt.getTime(),700,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/comManSysList.action">重点危险源的管理制度</a>
                  </li>
                   <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、危险源名称或应急处置名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
