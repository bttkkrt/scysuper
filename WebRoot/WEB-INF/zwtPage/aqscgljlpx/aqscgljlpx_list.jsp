...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_managerTraining","添加安全生产管理经理培训","${ctx}/zwt/managerTrainingInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_managerTraining","修改安全生产管理经理培训","${ctx}/zwt/managerTrainingInitEdit.action?flag=mod&managerTraining.id="+row_Id+"&dt="+dt.getTime(),800,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/managerTrainingList.action">管理经理</a>
                  </li>
                  <li>
