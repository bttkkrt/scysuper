...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_entChaPer","添加企业主要负责人","${ctx}/zwt/entChaPerInitEdit.action?flag=add&dt="+dt.getTime(),700,480);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_entChaPer","修改企业主要负责人","${ctx}/zwt/entChaPerInitEdit.action?flag=mod&entChaPer.id="+row_Id+"&dt="+dt.getTime(),700,480);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_entChaPer","查看企业主要负责人","${ctx}/zwt/entChaPerView.action?entChaPer.id="+row_Id+"&dt="+dt.getTime(),700,480);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                    ...
                    <li>
                		<a class="active" href="${ctx }/zwt/entChaPerList.action">主要负责人</a>
                    </li>
                    <li>
