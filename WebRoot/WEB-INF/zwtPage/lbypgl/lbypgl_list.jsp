    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、用品编号或用品名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、用品编号或用品名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.companyName+"</td><td>"+item.ppeNo+"</td><td>"
		                    		+item.ppeName+"</td><td>"+item.ppeNum+"</td><td>"
		                     		+item.ppeType+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_ppeManag","添加劳保用品管理","${ctx}/zwt/ppeManagInitEdit.action?flag=add&dt="+dt.getTime(),700,300);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_ppeManag","修改劳保用品管理","${ctx}/zwt/ppeManagInitEdit.action?flag=mod&ppeManag.id="+row_Id+"&dt="+dt.getTime(),700,300);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_ppeManag","查看劳保用品管理","${ctx}/zwt/ppeManagView.action?ppeManag.id="+row_Id+"&dt="+dt.getTime(),700,300);
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/ppeManagList.action">劳保用品管理</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、用品编号或用品名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>用品编号 </span></th>
                				  <th><span>用品名称 </span></th>
                          <th><span>用品数量 </span></th>  
                          <th><span>用品分类 </span></th>                                         	
                        	<th ><span>操作项</span></th>
                        </tr>
  						</thead>
                    	<tbody id="tbody">
