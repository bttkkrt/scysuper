    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、姓名或特种作业证号"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、姓名或特种作业证号");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.specialName+"</td><td>"+item.specialJobType+"</td><td>"
		                    		+item.specialJobCradnum+"</td><td>"+item.specialVerificationDate.substring(0,10)+"</td>"
        ...
        function getButton(rec){
          ...
          function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_speJobPer","添加特种作业人员","${ctx}/zwt/speJobPerInitEdit.action?flag=add&dt="+dt.getTime(),700,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_speJobPer","修改特种作业人员","${ctx}/zwt/speJobPerInitEdit.action?flag=mod&speJobPer.id="+row_Id+"&dt="+dt.getTime(),700,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_speJobPer","查看特种作业人员","${ctx}/zwt/speJobPerView.action?speJobPer.id="+row_Id+"&dt="+dt.getTime(),700,550);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                		<a class="active" href="${ctx }/zwt/speJobPerList.action">特种作业人员</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称、姓名或特种作业证号"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>姓名 </span></th>
                        	<th><span>特种作业类型</span></th>
                        	<th><span>特种作业证号 </span></th>
                        	<th><span>复审日期 </span></th>
                        	<th ><span>操作项</span></th>
                        </tr>
  						</thead>
                    	<tbody id="tbody">
