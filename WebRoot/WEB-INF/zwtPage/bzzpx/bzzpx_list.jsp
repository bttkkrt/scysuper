    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、姓名或车间名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、姓名或车间名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.trainingName+"</td><td>"+item.trainingWorkshopName+"</td><td>"
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_teaLeaTra","添加班组长培训","${ctx}/zwt/teaLeaTraInitEdit.action?flag=add&dt="+dt.getTime(),800,450);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_teaLeaTra","修改班组长培训","${ctx}/zwt/teaLeaTraInitEdit.action?flag=mod&teaLeaTra.id="+row_Id+"&dt="+dt.getTime(),800,450);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/teaLeaTraList.action">班组长</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、姓名或车间名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
