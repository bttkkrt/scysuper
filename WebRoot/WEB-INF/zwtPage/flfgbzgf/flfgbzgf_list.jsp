...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		var legalName=item.legalName;
		                    		if(legalName.length>20){
		                    		 	legalName	=legalName.substring(0,20);
		                    		}
		                    		...
		                    		+legalName+"</td><td>"+item.legalStandardTime+"</td>"
       ...
       function addNew(){
        	var dt=new Date();
          reateSimpleWindow("win_legSta","添加法律法规标准规范","${ctx}/zwt/legStaInitEdit.action?flag=add&dt="+dt.getTime(),700,350);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
          createSimpleWindow("win_legSta","修改法律法规标准规范","${ctx}/zwt/legStaInitEdit.action?flag=mod&legSta.id="+row_Id+"&dt="+dt.getTime(),700,350);
        	
        }
        function view(row_Id){
        	var dt=new Date();
          createSimpleWindow("win_legSta","查看法律法规标准规范","${ctx}/zwt/legStaView.action?legSta.id="+row_Id+"&dt="+dt.getTime(),700,350);
...
<!-- head style -->
    	<div class="sipac_head">
        	<a href="#" class="s_h_logo"><i></i><span>④法律法规与安全管理制度</span></a>
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/legStaList.action">法律法规标准规范</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/secProSysList.action">安全生产规章制度</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/opeProList.action">操作规程</a>
                  </li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称或清单名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
