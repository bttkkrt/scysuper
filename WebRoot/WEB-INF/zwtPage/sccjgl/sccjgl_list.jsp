    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称或车间名称"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称或车间名称");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.workshopCode+"</td><td>"+item.workshopName+"</td><td>"
		                    		+item.workshopOperation+"</td>"
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_workshop","添加生产车间管理","${ctx}/zwt/workshopInitEdit.action?flag=add&dt="+dt.getTime(),700,300);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_workshop","修改生产车间管理","${ctx}/zwt/workshopInitEdit.action?flag=mod&workshop.id="+row_Id+"&dt="+dt.getTime(),700,300);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_workshop","查看生产车间管理","${ctx}/zwt/workshopView.action?workshop.id="+row_Id+"&dt="+dt.getTime(),700,300);
...
<!-- head style -->
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/workshopList.action">生产车间</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/proDevList.action">生产设备设施</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/productionManageList.action">生产现场管理和生产过程控制</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称或车间名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>车间编号 </span></th>
                          <th><span>车间名称 </span></th>
                          <th><span>操作方式 </span></th>
