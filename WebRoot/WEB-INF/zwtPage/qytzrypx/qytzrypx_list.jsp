...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_speJobTra","添加企业特种人员培训","${ctx}/zwt/speJobTraInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_speJobTra","修改企业特种人员培训","${ctx}/zwt/speJobTraInitEdit.action?flag=mod&speJobTra.id="+row_Id+"&dt="+dt.getTime(),800,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/speJobTraList.action">特种人员</a>
                  </li>
                  <li>
