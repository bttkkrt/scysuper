    ...
    var ajaxData={ };
    	 $(function(){
			...
			$('.sipac_searchbar .s_s_text').click(function(){
		        var email = $(this).val();
		        if(email == "搜索企业名称、危险源名称或安全负责人"){
		            $(this).val("");
		        }
		    }).blur(function(){
		        var email = $(this).val();
		        if(email == ""){
		            $(this).val("搜索企业名称、危险源名称或安全负责人");
		        }
		    });
		});
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.companyName+"</td><td>"+item.dangerName+"</td><td>"
		                    		+item.dangerLevel+"</td><td>"+item.safePerson+"</td><td>"
		                    		+item.dangerType+"</td><td>"+item.auditState+"</td>"
        ...
        function getButton(rec){
         ...
         function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_comDanIde","添加企业重点危险源的识别评估分级","${ctx}/zwt/comDanIdeInitEdit.action?flag=add&dt="+dt.getTime(),1000,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comDanIde","修改企业重点危险源的识别评估分级","${ctx}/zwt/comDanIdeInitEdit.action?flag=mod&comDanIde.id="+row_Id+"&dt="+dt.getTime(),1000,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comDanIde","查看企业重点危险源的识别评估分级","${ctx}/zwt/comDanIdeView.action?comDanIde.id="+row_Id+"&dt="+dt.getTime(),1000,500);
...
<!-- head style -->
    	<div class="sipac_head">
        	<a href="#" class="s_h_logo"><i></i><span>⑨企业重点危险源监控</span></a>
            <div class="s_h_nav">
                <ul>
                	<li>
                		<a class="active" href="${ctx }/zwt/comDanIdeList.action">重点危险源的识别评估分级</a>
                  </li>
                  
                  <li>
                		<a href="${ctx }/zwt/comManSysList.action">重点危险源的管理制度</a>
                  </li>
                   <li>
                		<a href="${ctx }/zwt/comOpeRulList.action">重点危险源的操作规程</a>
                  </li>
                  <li>
                		<a href="${ctx }/zwt/comDanEmeList.action">重点危险源的应急处置</a>
                  </li>
                </ul>
            </div>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:200px;' type="text" id="searchLike" value="搜索企业名称、危险源名称或安全负责人"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>重点危险源名称 </span></th>
                				  <th><span>重点危险源级别 </span></th>
                          <th><span>安全负责人 </span></th>
                          <th><span>重点危险源类别 </span></th>
