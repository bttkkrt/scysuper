...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+item.feeAccountAmount+"</td><td>"+item.feeAccountMonth+"</td>"
        ...
        function getButton(rec){
        	return "<a style='color:blue' href='#' onclick=view('"+rec.companyId+"','"+rec.feeAccountMonth+"') >查看<b></b></a>";
        	
        }
        
           function view(companyId,feeAccountMonth){
        	var dt=new Date();
            createSimpleWindow("win_secProFeeAcc","查看安全生产费用使用台账","${ctx}/zwt/secProFeeAccView.action?secProFeeAcc.companyId="+companyId+"&secProFeeAcc.feeAccountMonth="+feeAccountMonth+"&dt="+dt.getTime(),900,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                  ...
                  <li>
                		<a class="active" href="${ctx }/zwt/secProFeeAccList.action">安全生产费用使用台账</a>
                  </li>
                  <li>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" style='width:250px;' type="text" id="searchLike" value="搜索企业名称"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>支出金额 </span></th>
                        	<th><span>使用月份</span></th>
