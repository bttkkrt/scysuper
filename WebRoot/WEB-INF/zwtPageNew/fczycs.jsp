...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td><a onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >"+getSpanByName(item.workplaceName)+"</a></td>";
		                    		tr+="<td>"+getSpanByName(item.agencyResponsible)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.industryType)+"</td></tr>";
		                    		trs+=tr;
								});
        ...
        function view(row_Id){
        	var dt=new Date();
        	createSimpleWindow("win_dusWorMan","查看粉尘作业场所管理","${ctx}/zwt/dusWorManView.action?dusWorMan.id="+row_Id+"&dt="+dt.getTime(),1000,500);
