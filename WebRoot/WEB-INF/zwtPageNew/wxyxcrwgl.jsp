    ...
    var ajaxData={ };
    	 $(function(){
    	 	...
    	 	if($("#searchType").val()==1){
    	 		ajaxData={ 
		                    	...
		                    	"danTasMan.assPlanNo":"${danTasMan.assPlanNo}"
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.taskName)+"</a></td><td>"+getSpanByName(item.checkTime.substring(0,10))+"</td><td>"+getSpanByName(item.checkTimeEnd.substring(0,10))+"</td><td>"+getSpanByName(item.checkPeopleName)+"</td><td>"+getSpanByName(item.result)+"</td>"
        ...
        function getButton(rec){
			 ...
			 if(rec.result=='待巡查' || rec.result=='已巡查'){
				 temp += "<a class='s_t_Btn stb_3' href='javascript:;' onclick=taskYhbList('"+rec.id+"')>隐患信息<b></b></a>&nbsp;";
			 }
			return temp;
        }
        ...
        function taskYhbList(row_Id){
        	var dt=new Date();
        	createSimpleWindow("win_danTasMan","查看隐患情况","${ctx}/zwt/aqscyhView.action?troMan.taskId="+row_Id+"&dt="+dt.getTime(),1100,500);
        }
