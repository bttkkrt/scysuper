...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_cheRepFil","添加危化品安全条件评价报告备案","${ctx}/zwt/cheRepFilInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_cheRepFil","修改危化品安全条件评价报告备案","${ctx}/zwt/cheRepFilInitEdit.action?flag=mod&cheRepFil.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_cheRepFil","查看危化品安全条件评价报告备案","${ctx}/zwt/cheRepFilView.action?cheRepFil.id="+row_Id+"&dt="+dt.getTime(),700,500);
