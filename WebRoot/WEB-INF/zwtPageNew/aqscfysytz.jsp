...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var feeAccountMonth=getName(item);
		                    		//获取操作按钮
		                    		...
		                    		tr+="<td>"
		                    		+feeAccountMonth+"</td><td>"+getSpanByName(item.feeAccountAmount)+"</td>"
        ...
        function getButton(rec){
			return "<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.companyId+"','"+rec.feeAccountMonth+"') >查看<b></b></a>";
        }
        
         function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.companyId+"','"+rec.feeAccountMonth+"') >"+getSpanByName(rec.feeAccountMonth)+"<b></b></a>";
        }
        
        function getJx(rec){
        	var yt=rec.feeAccountRemark;
        	var jx="";
        	if(yt.length>15){
        		jx=yt.substring(0,20)+"...";
        	}else{
        	jx=yt;
        	}
			return "<span title='"+yt+"'  >"+jx+"</span>";
        }
