			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+getSpanByName(item.surroundingEnvironmentType)+"</td><td>"+getSpanByName(item.personnelType)+"</td><td>"+getSpanByName(item.surroundingEnvironmentName)+"</td><td>"+getSpanByName(item.contactPerson)+"</td>"
