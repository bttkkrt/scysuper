    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+name+"</td><td>"
		                    		+getSpanByName(item.lx)+"</td><td>"+getSpanByName(item.no)+"</td><td>"
		                    		+getSpanByName(item.phone)+"</td>"
		                    		+"</tr>";
		                    		trs+=tr;
        ...
        function getName(rec){
        	if(rec.lx=='企业主要负责人'){
				...
				return "<a href='javascript:;' style='color:#27a9e3' onclick=viewTzzyry('"+rec.id+"') >"+getSpanByName(rec.name)+"<b></b></a>";
			}else {return "";}
        }
            	...
            	<div class="sipac_tableBox">
                	...
                	<table style="width:100%;">
                       ...
                       <tr>
                        	...
                        	--><th><span>序号</span></th>
                        	<th><span>姓名  </span></th>
                        	<th><span>人员类型  </span></th>
                        	<th><span>资格证号 </span></th>
