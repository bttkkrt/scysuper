...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function view(row_Id){
        	var dt=new Date();
        	createSimpleWindow("win_enterpriseGrade","查看安全生产信用评分","${ctx}/zwt/enterpriseGradeView.action?enterpriseGrade.id="+row_Id+"&dt="+dt.getTime(),1000,550);
