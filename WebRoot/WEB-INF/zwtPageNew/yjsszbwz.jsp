    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+facilityName+"</td><td>"+getSpanByName(item.facilityLevel)+"</td>"
		                    		+"</tr>";
		                    		trs+=tr;
								});
        ...
        function getButton(rec){
         ...
         function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"')>"+getSpanByName(rec.facilityName)+"<b></b></a>";
        }
        
        
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emeFac","查看应急设施装备物资","${ctx}/zwt/emeFacView.action?emeFac.id="+row_Id+"&dt="+dt.getTime(),700,300);
