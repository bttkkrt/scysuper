...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		var operationPostname=getName(item);
		                    		...
		                    		tr+="<td>"
		                    		+operationPostname+"</td><td>"+getSpanByName(item.operationWorkshopName)+"</td>"
        ...
        function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.operationPostname)+"<b></b></a>";
        }
