...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_cheSafPro","添加危险化学品建设项目安全设施试生产备案","${ctx}/zwt/cheSafProInitEdit.action?flag=add&dt="+dt.getTime(),900,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_cheSafPro","修改危险化学品建设项目安全设施试生产备案","${ctx}/zwt/cheSafProInitEdit.action?flag=mod&cheSafPro.id="+row_Id+"&dt="+dt.getTime(),900,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_cheSafPro","查看危险化学品建设项目安全设施试生产备案","${ctx}/zwt/cheSafProView.action?cheSafPro.id="+row_Id+"&dt="+dt.getTime(),900,500);
