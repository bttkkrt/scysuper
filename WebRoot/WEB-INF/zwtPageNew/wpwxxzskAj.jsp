...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.itemName)+"</a></td><td>"+getSpanByName(item.dangerousContent)+"</td><td>"+getSpanByName(item.responseMeasures)+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_risKnoBas","添加物品危险性知识库","${ctx}/zwt/risKnoBasInitEditAJ.action?flag=add&dt="+dt.getTime(),700,480);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_risKnoBas","修改物品危险性知识库","${ctx}/zwt/risKnoBasInitEditAJ.action?flag=mod&risKnoBas.id="+row_Id+"&dt="+dt.getTime(),700,480);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_risKnoBas","查看物品危险性知识库","${ctx}/zwt/risKnoBasViewAJ.action?risKnoBas.id="+row_Id+"&dt="+dt.getTime(),700,480);
