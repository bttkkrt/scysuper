    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+publicType+"</td><td>"
		                            +getSpanByName(item.publicAddress) + "</td>"
        ...
        function getButton(rec){
          ...
          function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.publicType)+"<b></b></a>";
        }
