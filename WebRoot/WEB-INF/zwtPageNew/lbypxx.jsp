			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td><a onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >"+getSpanByName(item.ppeName)+"</a></td><td>"
		                    		+getSpanByName(item.ppeNo)+"</td><td>"+getSpanByName(item.ppeNum)+"</td><td>"+getSpanByName(item.ppeType)+"</td></tr>";
		                    		trs+=tr;
								});
