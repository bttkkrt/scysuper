...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_proSafAss","添加建设项目安全条件论证与安全预评价","${ctx}/zwt/proSafAssInitEdit.action?flag=add&dt="+dt.getTime(),900,450);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proSafAss","修改建设项目安全条件论证与安全预评价","${ctx}/zwt/proSafAssInitEdit.action?flag=mod&proSafAss.id="+row_Id+"&dt="+dt.getTime(),900,450);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proSafAss","查看建设项目安全条件论证与安全预评价","${ctx}/zwt/proSafAssView.action?proSafAss.id="+row_Id+"&dt="+dt.getTime(),900,450);
