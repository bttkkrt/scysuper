...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+systemName+"</td><td>"
		                    		+getSpanByName(item.systemType)+"</td><td>"
		                    		+getSpanByName(item.createTime.substring(0,10))+"</td>"
        ...
        function getButton(rec){
	        if('${roleName}'=='0'){
						return "<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a class='s_t_Btn stb_1' href='javascript:;' onclick=edit('"+rec.id+"')>修改<b></b></a>";
					}else{
        ...
        function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.systemName)+"<b></b></a>";
        }
