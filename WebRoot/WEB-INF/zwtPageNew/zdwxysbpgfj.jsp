    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.dangerName)+"</a></td><td>"+getSpanByName(item.dangerLevel)+"</td><td>"+getSpanByName(item.safePerson)+"</td><td>"+getSpanByName(item.dangerType)+"</td><td>"+getSpanByName(item.auditState)+"</td>";
		                    		if("true"=="${canCheck}")
		                    		{
       ...
       function view(row_Id){
         ...
         function check(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_comDanIde","审核企业重点危险源的识别评估分级","${ctx}/zwt/comDanIdeCheck.action?flag=check&comDanIde.id="+row_Id+"&dt="+dt.getTime(),700,450);
