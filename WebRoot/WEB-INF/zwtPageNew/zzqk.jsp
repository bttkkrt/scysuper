			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td><a onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >"+getSpanByName(item.intelligenceCardnum)+"</a></td><td>"
		                    		+getSpanByName(item.intelligenceCardname)+"</td><td>"+getSpanByName(item.intelligenceType)+"</td><td>"
		                    		+getSpanByName(item.auditState)+"</td>";
		                    		if("true"=="${canCheck}")
		                    		{
