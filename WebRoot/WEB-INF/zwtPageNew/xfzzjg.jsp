...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_firIns","添加消防组织机构","${ctx}/zwt/firInsInitEdit.action?flag=add&dt="+dt.getTime(),800,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_firIns","修改消防组织机构","${ctx}/zwt/firInsInitEdit.action?flag=mod&firIns.id="+row_Id+"&dt="+dt.getTime(),800,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_firIns","查看消防组织机构","${ctx}/zwt/firInsView.action?firIns.id="+row_Id+"&dt="+dt.getTime(),800,550);
