    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+drillName+"</td><td>"+getSpanByName(item.drillType)+"</td>"
		                    		+"</tr>";
		                    		trs+=tr;
								});
        ...
        function getButton(rec){
          ...
          function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.drillName)+"<b></b></a>";
        }
        
        
         function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emeDri","查看应急演练","${ctx}/zwt/emeDriView.action?emeDri.id="+row_Id+"&dt="+dt.getTime(),700,500);
            	...
            	<div class="sipac_tableBox">
                	...
                	<table style="width:100%;">
                        ...
                        <tr>
                        	...
                        	--><th><span>序号</span></th>
                        	<th><span>演练名称 </span></th>
                        	<th><span>演练类型 </span></th>
                        </tr>
  						</thead>
                    	</table>
     			</div>
