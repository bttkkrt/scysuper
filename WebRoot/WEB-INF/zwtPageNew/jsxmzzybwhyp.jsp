...
<head>
    <title>建设项目职业病危害预评价报告备案通知书</title>
...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_proEvaNot","添加建设项目职业病危害预评价报告备案通知书","${ctx}/zwt/proEvaNotInitEdit.action?flag=add&dt="+dt.getTime(),800,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proEvaNot","修改建设项目职业病危害预评价报告备案通知书","${ctx}/zwt/proEvaNotInitEdit.action?flag=mod&proEvaNot.id="+row_Id+"&dt="+dt.getTime(),800,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_proEvaNot","查看建设项目职业病危害预评价报告备案通知书","${ctx}/zwt/proEvaNotView.action?proEvaNot.id="+row_Id+"&dt="+dt.getTime(),800,550);
