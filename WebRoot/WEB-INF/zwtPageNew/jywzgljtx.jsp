...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.facilityName)+"</a></td><td>"+getSpanByName(item.facilityLevel)+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_emeFac","添加应急设施装备物资","${ctx}/zwt/emeFacInitEdit.action?flag=add&dt="+dt.getTime()+"&type="+type,900,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emeFac","修改应急设施装备物资","${ctx}/zwt/emeFacInitEdit.action?flag=mod&emeFac.id="+row_Id+"&dt="+dt.getTime()+"&type="+type,900,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emeFac","查看应急设施装备物资","${ctx}/zwt/emeFacView.action?emeFac.id="+row_Id+"&dt="+dt.getTime()+"&type="+type,900,500);
            	...
            	<div class="sipac_tableBox">
                	...
                	<table style="width:100%;">
                        ...
                        <tr>
                        	...
                        	<th><span>序号</span></th>
                        	<th><span>物资名称 </span></th>
                        	<th><span>物资级别 </span></th>
                        	<th ><span>操作项</span></th>
                        </tr>
  						</thead>
                    	</table>
