    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+planName+"</td><td>"+getSpanByName(item.planType)+"</td><td>"+getSpanByName(item.planLevel)+"</td><td>"+getSpanByName(item.planFilingNumber)+"</td>"
		                    		+"</tr>";
		                    		trs+=tr;
								});
        ...
        function getButton(rec){
         ...
         function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.planName)+"<b></b></a>";
        }
        
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emeAge","查看应急预案","${ctx}/zwt/emePlaView.action?emePla.id="+row_Id+"&dt="+dt.getTime(),700,300);
