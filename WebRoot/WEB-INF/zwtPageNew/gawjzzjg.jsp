...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.agencyNum)+"</a></td><td>"+getSpanByName(item.mobile)+"</td><td>"+getSpanByName(item.agencyName)+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_policeInstitutions","添加公安武警组织机构","${ctx}/zwt/policeInstitutionsInitEdit.action?flag=add&dt="+dt.getTime(),800,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_policeInstitutions","修改公安武警组织机构","${ctx}/zwt/policeInstitutionsInitEdit.action?flag=mod&policeInstitutions.id="+row_Id+"&dt="+dt.getTime(),800,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_policeInstitutions","查看公安武警组织机构","${ctx}/zwt/policeInstitutionsView.action?policeInstitutions.id="+row_Id+"&dt="+dt.getTime(),800,550);
