    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+legalName+"</td><td>"+getSpanByName(item.legalStandardTime.substring(0,10))+"</td>"
        ...
        function getButton(rec){
         ...
         function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.legalName)+"<b></b></a>";
        }
       function addNew(){
        	var dt=new Date();
