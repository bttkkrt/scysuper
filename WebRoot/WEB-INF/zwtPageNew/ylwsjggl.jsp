...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_medIns","添加医疗卫生机构","${ctx}/zwt/medInsInitEdit.action?flag=add&dt="+dt.getTime(),800,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_medIns","修改医疗卫生机构","${ctx}/zwt/medInsInitEdit.action?flag=mod&medIns.id="+row_Id+"&dt="+dt.getTime(),800,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_medIns","查看医疗卫生机构","${ctx}/zwt/medInsView.action?medIns.id="+row_Id+"&dt="+dt.getTime(),800,550);
