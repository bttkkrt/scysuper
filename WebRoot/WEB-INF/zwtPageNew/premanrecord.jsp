...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+ "<td>"+getSpanByName(item.isComplete)+"</td>";
		                    		if('${operateRight}'=='add')
		                    		{
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_preManRec","添加第二第三类非药品类易制毒化学品经营备案","${ctx}/zwt/preManRecInitEdit.action?flag=add&dt="+dt.getTime(),900,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_preManRec","修改第二第三类非药品类易制毒化学品经营备案","${ctx}/zwt/preManRecInitEdit.action?flag=mod&preManRec.id="+row_Id+"&dt="+dt.getTime(),900,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_preManRec","查看第二第三类非药品类易制毒化学品经营备案","${ctx}/zwt/preManRecView.action?preManRec.id="+row_Id+"&dt="+dt.getTime(),900,500);
