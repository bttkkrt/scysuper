...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
    	 $(function(){
    	 $("#div1").load("${ctx}/zwt/zbhj.action?entBaseInfo.id=${entBaseInfo.id}&searchLike="+encodeURIComponent('${entBaseInfo.enterpriseName}'));
    	 	//初始化样式 
    	 	if($("#searchType").val()==1){
    	 		ajaxData={ 
		                    	pageNo :$("#currPage").val(),
...
<!-- body style -->
        <div class="sipac_body" >
            <div class="sipac_container" id="tableDiv" style="margin: 0 0 0 0px;">
            	...
            	<div class="sipac_tableBox" id="div1">
