...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+getSpanByName(item.holidayTimeStart)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.holidayTimeEnd)+"</td>";
        ...
        function getButton(rec){
	      var button1="<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a class='s_t_Btn stb_1' href='javascript:;' onclick=check('"+rec.id+"')>审核<b></b></a>";
	      var button2="<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.id+"') >查看<b></b></a>";
	      var button3="<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a class='s_t_Btn stb_1' href='javascript:;' onclick=edit('"+rec.id+"')>修改<b></b></a>";
		if(rec.auditState=='待审核'){
			return button1;
