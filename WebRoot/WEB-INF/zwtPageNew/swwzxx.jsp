			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+getSpanByName(item.dangerouSourceName)+"</td><td>"+getSpanByName(item.dangerousChemicalName)+"</td><td>"+getSpanByName(item.riskGauge)+"</td><td>"+getSpanByName(item.device)+"</td><td>"+getSpanByName(item.existenceQuantity)+"</td>"
