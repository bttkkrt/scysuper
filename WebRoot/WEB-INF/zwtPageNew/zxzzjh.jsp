...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td><a onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >"+getSpanByName(item.planName)+"</a></td><td>"
		                    		+getSpanByName(item.workGoal)+"</td><td>"+getSpanByName(item.workTimeStart.substring(0,11))+"</td><td>"
		                    		+getSpanByName(item.workTimeEnd.substring(0,11))+"</td>"
        ...
        function getButton(rec){
			...
			var button2="<a class='s_t_Btn stb_1' href='javascript:;' onclick=viewCheck('"+rec.id+"')>检查记录<b></b></a>";
			if(rec.status=='0'){
