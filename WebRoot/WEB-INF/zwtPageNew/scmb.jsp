...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td><a  onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >"+getSpanByName(item.productGoalYear.substring(0,4))+"</a></td><td>"+getSpanByName(item.productGoalYearGoal)+"</td>"
		                    		+"</tr>";
		                    		trs+=tr;
								});
        ...
        function getButton(rec){
        	var button1="<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.id+"') >查看<b></b></a>";
			var button2="<a class='s_t_Btn stb_3' href='javascript:;' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a class='s_t_Btn stb_1' href='javascript:;' onclick=edit('"+rec.id+"')>修改<b></b></a>";
			if('${roleName}'!='0'){
				return button1;
			}else{
				return button2;
