			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.checkUsername)+"</td><td>"
		                    		+getSpanByName(item.taskType)+"</td><td>"+getSpanByName(item.taskState)+"</td></tr>";
		                    		trs+=tr;
								});
            ...
            <div class="sipac_container" id="tableDiv" style="margin: 0 0 0 0px;">
            	...
            	<div class="sipac_tableBox">
	                <c:if test="${roleName=='09'||roleName=='11'}">
	                    <div class="sipac_tableBar" style="display:none">
                	...
                	<table style="width:100%;">
                    	...
                    	<thead>
                        	...
                        	<th><span>任务开始时间 </span></th>
                        	<th><span>任务结束时间</span></th>
                        	<th><span>检查人员名称 </span></th>
