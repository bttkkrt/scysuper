...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+ "<td>"+getSpanByName(item.reviewDate.substring(0,10))+"</td>"
		                    		+ "<td>"+getSpanByName(item.review)+"</td>";
		                    		if('${roleName}'=='1')
		                    		{
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_cheSafCon","添加危险化学品建设项目安全条件审查","${ctx}/zwt/cheSafConInitEdit.action?flag=add&dt="+dt.getTime(),900,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_cheSafCon","修改危险化学品建设项目安全条件审查","${ctx}/zwt/cheSafConInitEdit.action?flag=mod&cheSafCon.id="+row_Id+"&dt="+dt.getTime(),900,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_cheSafCon","查看危险化学品建设项目安全条件审查","${ctx}/zwt/cheSafConView.action?cheSafCon.id="+row_Id+"&dt="+dt.getTime(),900,500);
