...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+ "<td>"+getSpanByName(item.authority)+"</td>";
		                    		if('${roleName}'=='1')
		                    		{
       ...
       function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_preProRec","添加第二第三类非药品类易制毒化学品生产备案","${ctx}/zwt/preProRecInitEdit.action?flag=add&dt="+dt.getTime(),800,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_preProRec","修改第二第三类非药品类易制毒化学品生产备案","${ctx}/zwt/preProRecInitEdit.action?flag=mod&preProRec.id="+row_Id+"&dt="+dt.getTime(),800,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_preProRec","查看第二第三类非药品类易制毒化学品生产备案","${ctx}/zwt/preProRecView.action?preProRec.id="+row_Id+"&dt="+dt.getTime(),800,500);
