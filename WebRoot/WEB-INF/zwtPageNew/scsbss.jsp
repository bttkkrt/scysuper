    ...
    var ajaxData={ };
		...
		function getList(num,size){ 
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"
		                    		+deviceName+"</td><td>"+getSpanByName(item.deviceCode)+"</td><td>"+getSpanByName(item.deviceWorkshopName)+"</td>"
		                    		+"</tr>";
		                    		trs+=tr;
								});
         ...
         function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.deviceName)+"<b></b></a>";
        }
