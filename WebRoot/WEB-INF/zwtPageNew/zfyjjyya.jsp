...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.planName)+"</a></td><td>"+getSpanByName(item.planType)+"</td><td>"+getSpanByName(item.planLevel)+"</td><td>"+getSpanByName(item.planFilingNumber)+"</td>"
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_emePla","添加应急预案","${ctx}/zwt/emePlaInitEdit.action?flag=add&dt="+dt.getTime()+"&type="+type,700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emePla","修改应急预案","${ctx}/zwt/emePlaInitEdit.action?flag=mod&emePla.id="+row_Id+"&dt="+dt.getTime()+"&type="+type,700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_emePla","查看应急预案","${ctx}/zwt/emePlaView.action?emePla.id="+row_Id+"&dt="+dt.getTime()+"&type="+type,700,500);
            	...
            	<div class="sipac_tableBox">
                	...
                	<table style="width:100%;">
                        ...
                        <tr>
                        	...
                        	<th><span>序号</span></th>
                        	<th><span>预案名称 </span></th>
                        	<th><span>预案类别 </span></th>
                        	<th><span>预案级别 </span></th>
                        	<th><span>预案备案编号 </span></th>
                        	<th ><span>操作项</span></th>
                        </tr>
  						</thead>
                    	</table>
