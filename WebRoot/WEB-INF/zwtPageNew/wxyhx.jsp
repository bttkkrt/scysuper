...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+getSpanByName(item.uploadTime)+"</td>";
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_opePro","添加危险源核销","${ctx}/zwt/opeProInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_opePro","修改危险源核销","${ctx}/zwt/opeProInitEdit.action?flag=mod&opePro.id="+row_Id+"&dt="+dt.getTime(),700,500);
