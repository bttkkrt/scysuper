			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td><a onclick=view('"+item.id+"') href='javascript:;' style='color:#27a9e3' >"+getSpanByName(item.bzyear.substring(0,4))+"</a></td><td>"
		                    		+getSpanByName(item.honor)+"</td><td>"
		                    		+getSpanByName(item.recognitionDept)+"</td><td>"+getSpanByName(item.auditState)+"</td>";
		                    		if("true"=="${canCheck}")
		                    		{
