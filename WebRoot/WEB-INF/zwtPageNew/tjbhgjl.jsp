...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+getSpanByName(item.jshxName)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.medicalExaminationDate)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.physicalExaminatioResults)+"</td>";
      ...
      function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_opePro","添加体检不合格记录","${ctx}/zwt/opeProInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_opePro","修改体检不合格记录","${ctx}/zwt/opeProInitEdit.action?flag=mod&opePro.id="+row_Id+"&dt="+dt.getTime(),700,500);
