			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		+getSpanByName(item.checkTime.substring(0,10))+"</td><td>"+getSpanByName(item.checkDept)+"</td><td>"
		                    		+getSpanByName(item.rectificationDate.substring(0,10))+"</td>"
