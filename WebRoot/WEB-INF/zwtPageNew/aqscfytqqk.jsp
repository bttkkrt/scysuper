...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		var feeExtractTime=getName(item);
		                    		//获取操作按钮
		                    		...
		                    		tr+="<td>"
		                    		+feeExtractTime+"</td><td>"+getSpanByName(item.feeExtractFee)+"</td><td>"+getSpanByName(item.feeExtractRemark)+"</td>"
        ...
        function getName(rec){
			return "<a href='javascript:;' style='color:#27a9e3'  onclick=view('"+rec.id+"') >"+getSpanByName(rec.feeExtractTime.substring(0,10))+"<b></b></a>";
        }
