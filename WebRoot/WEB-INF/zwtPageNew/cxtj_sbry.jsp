...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
		...
		function getList(num,size){ 
			...
			$("#currPage").val(num);
			$.ajax({
		                	url : "reportmanTroManTongjiZwt.action",
		                	type: 'post',
		                    dataType: 'json',
		                    async : false,
		                    data:ajaxData,
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		...
		                    		tr+="<td>"+getSpanByName(item.szzid)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.dwdz)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.sbcs)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.zgwc)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.zgwwc)+"</td>";
		                    		tr+="<td>"+getSpanByName(item.zgl)+"</td></tr>";
		                    		trs+=tr;
								});
            	...
            	<div class="sipac_tableBox">
                	...
                	<table style="width:100%;">
                        ...
                        <tr>
                        	...
                        	<th><span>部门</span></th>
                        	<th><span>上报人</span></th>
                        	<th><span>隐患总数</span></th>
                        	<th><span>整改完成数</span></th>
                        	<th><span>未整改数</span></th>
                        	<th><span>整改率</span></th>
                        </tr>
  						</thead>
                    	</table>
