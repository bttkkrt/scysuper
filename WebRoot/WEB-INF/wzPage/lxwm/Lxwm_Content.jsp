        ...
        <div class="nav">
             <ul>
                ...
                <li><a href="${ctx}/wzxx/flfgList.action">法律常规</a></li>             
                 <li><a class="navnow" href="${ctx}/wzxx/lxwmList.action">联系我们</a></li>           
          </ul>
        </div>	
    </div>
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/lxwmList.action">联系我们</a>&gt;<a href="#">联系我们详情</a></p></div>
   	</div>
