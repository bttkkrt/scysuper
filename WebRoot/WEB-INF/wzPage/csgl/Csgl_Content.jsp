...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/csglWzList.action">城市管理</a>&gt;<a href="#">城市管理详情</a></p></div>
    </div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
             	<c:if test="${fn:length(cityMan.firTitle)>0 }">
				<span class="smtitle">${cityMan.firTitle}</span><br/>
				</c:if>
				${cityMan.infoTitle}
				</h1>
				<div class="meta">
					本文被阅读次数：${cityMan.clickTime}次&nbsp;&nbsp;
					发表时间：<fmt:formatDate type="date" value="${cityMan.publicDate}" pattern="yyyy-MM-dd"/>
				</div>
