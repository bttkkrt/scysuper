...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/flfgList.action">法律常规</a>&gt;<a href="#">法律常规详情</a></p></div>
    </div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
             	<c:if test="${fn:length(law.firTitle)>0 }">
				<span class="smtitle">${law.firTitle}</span><br/>
				</c:if>
				${law.infoTitle}
				</h1>
				<div class="meta">
					索引号：${law.numbers}&nbsp;&nbsp;
					发布机构：${law.publicAgency}&nbsp;&nbsp;
					生成日期：<fmt:formatDate type="date" value="${law.generateDate}" pattern="yyyy-MM-dd"/>&nbsp;&nbsp;
					发布日期：<fmt:formatDate type="date" value="${law.publicDate}" pattern="yyyy-MM-dd"/>&nbsp;&nbsp;
					发表时间：<fmt:formatDate type="both" value="${law.publicTime}" pattern="yyyy-MM-dd"/>&nbsp;&nbsp;
					<br/>
					内容概述：${law.remark}
				</div>
