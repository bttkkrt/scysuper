...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/jgdlWzList.action">机关党建</a>&gt;<a href="#">机关党建详情</a></p></div>
   	</div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
             	<c:if test="${fn:length(jgdl.firTitle)>0 }">
				<span class="smtitle">${jgdl.firTitle}</span><br/>
				</c:if>
				${jgdl.infoTitle}
				</h1>
				<div class="meta">
					本文被阅读次数：${jgdl.clickTime}次&nbsp;&nbsp;
					发表时间：<fmt:formatDate type="date" value="${jgdl.publicDate}" pattern="yyyy-MM-dd"/>
				</div>
