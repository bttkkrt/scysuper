...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">通知公告</a></p></div>
    <div class="news_list">
    <ul>
    	<c:forEach var="tzgg" items="${tzggList}">
        	<li><a href="${ctx}/wzxx/newsContent.action?tzgg.id=${tzgg.id}">${tzgg.infoTitle}</a><fmt:formatDate type="date" value="${tzgg.publicDate}" pattern="yyyy-MM-dd HH:mm:ss"/></li>
        </c:forEach>
    </ul>
    <!--pages-->
    <div id="div_pager">
