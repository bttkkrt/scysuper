...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">表格下载</a></p></div>
    <div class="news_list">
    <ul>
    	<c:forEach var="bgxz" items="${bgxzList}">
        	<li><a href="${ctx}/wzxx/bgxzContent.action?bgxz.id=${bgxz.id}">${bgxz.infoTitle}</a><fmt:formatDate type="date" value="${bgxz.publicDate}" pattern="yyyy-MM-dd HH:mm:ss"/></li>
        </c:forEach>
    </ul>
    <!--pages-->
    <div id="div_pager">
