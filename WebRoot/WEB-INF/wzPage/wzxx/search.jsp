    ...
    <div id="navBg">
        <div class="nav">
             <ul>
                ...
                <li><a class="navnow" href="${ctx}/wzxx/gzdtList.action?pageNum=1">工作动态</a></li>
                ...
                <li><a href="${ctx}/wzxx/awhgzList.action?wzInfoManage.infoType=2">政务互动</a></li>
...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">查询服务</a></p></div>
    <div class="news_list">
     <ul>
                    <li><a href="http://zfw.sipac.gov.cn/Page/ContentDetail.aspx?WorkInfoType_id=5&ID=1555" target="_blank">安全培训证书查询</a></li>
                    <li><a href="http://www.suzhousafety.gov.cn/xxcx_2.asp" target="_blank">安全生产专家查询</a></li>
                    <li><a href="${ctx}/wzxx/whpaqscxkList.action">危化品安全生产许可证查询</a></li>
                    <li><a href="${ctx}/wzxx/whpjyxkzList.action">危化品经营许可证查询</a></li>
                    <li><a href="http://zfw.sipac.gov.cn/Page/ContentDetail.aspx?WorkInfoType_id=5&ID=1579" target="_blank">烟花爆竹经营许可证查询</a></li>
       </ul>
    <!--pages-->
    <div id="div_pager">
    </div>
