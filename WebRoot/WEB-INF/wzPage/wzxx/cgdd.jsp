...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">城市管理综合执法大队</a></p></div>
   </div>
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
				...
				<div class="content" id="newscontent">
					...
					该大队主要职能为：受园区综合行政执法局委托，负责功能区及社工委区域内（包括各社区）的市容市政、规划建设、园林绿化等综合执法工作，负责园区金鸡湖、独墅湖以及娄江等除阳澄湖水域以外水域的水政水务及其相关综合执法工作。大队可根据工作需要设置区域中队、水上执法中队以及社区城管中队，其中社区城管中队主要负责城管进社区相关工作。
					</p>
					<br/>
			</div>
        </div>
