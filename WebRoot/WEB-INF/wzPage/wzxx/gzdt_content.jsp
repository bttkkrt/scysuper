...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/gzdtList.action">工作动态</a>&gt;<a href="#">动态详情</a></p></div>
    </div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
             	<c:if test="${fn:length(gzdt.firTitle)>0 }">
				<span class="smtitle">${gzdt.firTitle}</span><br/>
				</c:if>
				${gzdt.infoTitle}
				</h1>
				<div class="meta">
					本文被阅读次数：${gzdt.readNum}次&nbsp;&nbsp;
					发表时间：<fmt:formatDate type="date" value="${gzdt.publicDate}" pattern="yyyy-MM-dd"/>
				</div>
