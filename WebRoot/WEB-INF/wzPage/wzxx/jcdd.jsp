...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">基层综合执法大队</a></p></div>
   </div>
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
				...
				<div class="content" id="newscontent">
					...
					该大队主要职能为：负责四个街道的市容市政、规划建设、园林绿化、安全生产、国土资源、城镇燃气及相关市政管网等的日常监管及综合执法工作，协同环境监察大队开展街道环境监管及执法工作；负责承担阳澄湖水域园区片的综合执法等工作（各街道仍需按照属地管理职能承担安全生产等的日常监管工作）。
					</p>
					<br/>
			</div>
        </div>
