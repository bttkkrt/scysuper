...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">工作动态</a></p></div>
    <div class="news_list">
    <ul>
    	<c:forEach var="gzdt" items="${gzdtList}">
        	<li><a href="${ctx}/wzxx/gzdtContent.action?gzdt.id=${gzdt.id}">${gzdt.infoTitle}</a><fmt:formatDate type="date" value="${gzdt.publicDate}" pattern="yyyy-MM-dd HH:mm:ss"/></li>
        </c:forEach>
    </ul>
    <!--pages-->
    <div id="div_pager">
