...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/aqwhList.action">安全生产</a>&gt;<a href="#">安全生产详情</a></p></div>
    </div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
             	<c:if test="${fn:length(safCul.firTitle)>0 }">
				<span class="smtitle">${safCul.firTitle}</span><br/>
				</c:if>
				${safCul.infoTitle}
				</h1>
				<div class="meta">
					本文被阅读次数：${safCul.clickTime}次&nbsp;&nbsp;
					发表时间：<fmt:formatDate type="date" value="${safCul.publicDate}" pattern="yyyy-MM-dd"/>
				</div>
