...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/awhgzList.action?wzInfoManage.infoType=6">组织机构</a>&gt;<a href="#">详情</a></p></div>
   </div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
             	<c:if test="${fn:length(wzInfoManage.firTitle)>0 }">
				<span class="smtitle">${wzInfoManage.firTitle}</span><br/>
				</c:if>
				${wzInfoManage.infotitle}
				</h1>
				<div class="meta">
					本文被阅读次数：${wzInfoManage.clickTime}次&nbsp;&nbsp;
					发表时间：<fmt:formatDate type="date" value="${wzInfoManage.createTime}" pattern="yyyy-MM-dd"/>
				</div>
				<div class="content" id="newscontent">
					${wzInfoManage.infoContent}
					<br/>
					<br/>
