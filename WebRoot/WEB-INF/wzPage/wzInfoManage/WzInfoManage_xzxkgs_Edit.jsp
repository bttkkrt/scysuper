	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="wzInfoManageSave.action">
		...
		<input type="hidden" name="wzInfoManage.linkId" value="${wzInfoManage.linkId}">
			...
			<table width="100%" border="0">
				<tr>
					<th width="15%">申报企业</th>
					<td width="35%" ><input name="wzInfoManage.companyName" style="width:60%" value="${wzInfoManage.companyName}" type="text" datatype="*1-127" errormsg='此项为必填' maxlength="127"><font style='color:red'>*</font></td>
					<th width="15%">类别</th>
					<td width="35%" >
						<s:select name="wzInfoManage.category" cssStyle="width:60%" list="#{'服务许可':'服务许可','经营许可':'经营许可','生产许可':'生产许可'}" theme="simple"/>
					</td>
				</tr>
				<tr>
					<th width="10%">附件</th>
