...
$(function()
{
        ...
        kkpager.init({
            ...
            //链接前部
            hrefFormer: '${ctx}/wzxx/awhgzList.action?wzInfoManage.infoType=6',
            //链接尾部
            hrefLatter: '.action',
            getLink: function (n) {
    ...
    <div id="navBg">
        <div class="nav">
             <ul>
                ...
                <li><a class="navnow" href="${ctx}/wzxx/awhgzList.action?wzInfoManage.infoType=6">组织机构</a></li>
...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">组织机构</a></p></div>
    <div class="news_list">
    <ul>
