...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="${ctx}/wzxx/awhgzList.action?wzInfoManage.infoType=8">行证许可公示</a>&gt;<a href="#">详情</a></p></div>
    </div>
<div class="wrap govopen">
        ...
        <div class="main-col mb10">
             <div class="newsdetail" style="min-height:800px;">
             	<h1 class="title">
				${wzInfoManage.companyName}
				</h1>
				<div class="meta">
					本文被阅读次数：${wzInfoManage.clickTime}次&nbsp;&nbsp;
					类别：${wzInfoManage.category}
