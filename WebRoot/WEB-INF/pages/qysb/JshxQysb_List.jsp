...
<title>企业设备管理</title>
	...
	<script>
        var flag = "${flag}";
        function addNew(){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/qysb/jshxQysbInitEdit.action?flag=add",900,600);
        	//window.open("${ctx}/jsp/qysb/jshxQysbInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/qysb/jshxQysbInitEdit.action?flag=mod&jshxQysb.id="+row_Id,900,600);
            //window.open("${ctx}/jsp/qysb/jshxQysbInitEdit.action?flag=mod&jshxQysb.id="+row_Id);
        }
        function view(row_Id){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/qysb/jshxQysbView.action?jshxQysb.id="+row_Id,900,600);
            //window.open("${ctx}/jsp/qysb/jshxQysbView.action?jshxQysb.id="+row_Id);
        }
        ...
        function search_jshxQysb(){
        	var queryParams = {
        	"jshxQysb.szzid": $("#szzid").val(),
"jshxQysb.qymc": $("#qymc").val(),
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			  	<tr>
					<th width="15%">企业名称</th>
					<td width="35%"><input name="jshxQysb.qymc" id="qymc" value="${jshxQysb.qymc}" type="text"></td>
				...
				<s:if test="flag==3">
					...
					<select id="szzid" name="jshxQysb.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="jshxQysb.szzid" defaultText='请选择' codeName="相城地址" value="${jshxQysb.szzid}" /></td>
					 -->
					</tr>
				</s:if>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_jshxQysb()" iconCls="icon-search">查询</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="clear_form(document.myform);" iconCls="icon-undo">清空</a>&nbsp;				
				<s:if test="flag == 1">
				<a href="###" class="easyui-linkbutton" onclick="addNew();" iconCls="icon-add">添加</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="del();" iconCls="icon-remove">删除</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="download('qysb')" iconCls="icon-add">模板下载</a>
				</s:if>
				</td>
			</tr>
		</table>
