...
<title>安监隐患统计</title>
    ...
    $(document).ready(function(){
    	$("#tj_div2").load("${ctx}/jsp/yhb/ajyhDataDept.action?tongjiType=dept");
	...
	<script>
        ...
        function changeDiv(obj){
        	 ...
        	 if(obj=='2'){
     	       ...
     	       $("#tj_div3").hide();
     	        $("#comList").hide();
     	      $("#tj_div2").load("${ctx}/jsp/yhb/ajyhDataDept.action?tongjiType=dept&starttime="+starttime+"&endtime="+endtime+"&troMan.areaId="+areaId+"&troMan.companyName="+companyName);
     	      ...
     	      $.ajax({
     	       ...
     	       $("#tj_div1").hide();
     	       $("#comList").hide();
     	      $("#tj_div3").load("${ctx}/jsp/yhb/ajyhDataDept.action?tongjiType=grid&starttime="+starttime+"&endtime="+endtime+"&troMan.areaId="+areaId+"&troMan.companyName="+companyName);
        ...
        function clear_form(ff){
          ...
          function pag(){
        	...
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				title:'上报人员统计',
				url:'reportmanTroManTongji.action',
				queryParams:{
				...
				columns:[[
				{field:'szzid',title:'部门',width:100},
				{field:'dwdz',title:'上报人',width:100},
				{field:'sbcs',title:'隐患总数',width:100},
		   ...
		   <tr>
			...
			<%-- <tr>
				<td colspan="4" style="text-align:center;">
					<s:radio theme="simple" list="#{'2':'所属部门','3':'所属网格','1':'隐患类别','4':'上报人员'}" name="type" value="2" onclick="changeDiv(this.value)"/>
				</td>
			</tr> --%>
			<tr>
