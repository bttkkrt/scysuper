	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="troManBaseSaveAJ.action">
		...
		<input name="troMan.ifCorrected" value="${troMan.ifCorrected}" type="hidden" maxlength="127">	
			<table width="100%" border="0">
				<tr>
					<th width="15%">隐患名称</th>
					<td width="35%"><input name="troMan.troubleName" datatype="*1-127" style="width:60%" errormsg='隐患名称必须是1到127位字符！' nullmsg='隐患名称不能为空！' sucmsg='隐患名称填写正确！'  value="${troMan.troubleName}" type="text" maxlength="127"><font style='color:red'>*</font></td>
					<th width="15%">隐患来源</th>
					<td width="35%">
				...
				<tr>
					...
					<th width="15%">检查项</th>
					<td width="35%">
						<cus:SelectOneTag  dataType="*" style="width:60%" property="troMan.checkItem" defaultText='请选择' codeSql="select t.row_id,PATROL_NAME from PAT_MAN t where t.delflag = 0 " value="${troMan.checkItem}" /><font style='color:red'>*</font>
					</td>
				</tr>
				<tr>
					<th width="15%">隐患级别</th>
					<td width="35%"><cus:SelectOneTag style="width:60%"  property="troMan.troubleLevel" defaultText='请选择' codeName="隐患级别" value="${troMan.troubleLevel}" datatype="*1-127" errormsg='隐患级别必须选择！' nullmsg='隐患级别必须选择！' sucmsg='隐患级别选择正确！'/><font style='color:red'>*</font></td>
					<th width="15%">隐患类别</th>
					<td width="35%"><cus:SelectOneTag style="width:60%"  property="troMan.troubleSort" defaultText='请选择' codeName="隐患类别" value="${troMan.troubleSort}" datatype="*1-127" errormsg='隐患类别必须选择！' nullmsg='隐患类别必须选择！' sucmsg='隐患类别选择正确！'/><font style='color:red'>*</font></td>
				</tr>
				<tr>
