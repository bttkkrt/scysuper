	...
	<form name="myform" method="post">
		...
		<div class="inner6px">
			...
			<table width="100%">
				<tr>
					<th width="15%">所在区域</th>
					<td width="35%" >${supCheRes.areaName}</td>
					<th width="15%">企业名称</th>
					<td width="35%" >${supCheRes.companyName}</td>
				</tr>
				<tr>
					<th width="15%">检查时间</th>
					<td width="35%" ><fmt:formatDate type="both" value="${supCheRes.checkTime}" /></td>
					<th width="15%">检查人员姓名</th>
					<td width="35%" >${supCheRes.checkUsername}</td>
				</tr>
				<tr>
					<th width="15%">检查文书号</th>
					<td width="35%" >${supCheRes.checkInstrumentNum}</td>
					<th width="15%">检查内容</th>
					<td width="35%" >${supCheRes.checkContent}</td>
				</tr>
