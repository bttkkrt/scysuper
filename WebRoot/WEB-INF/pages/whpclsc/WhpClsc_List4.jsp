				...
				columns:[[
					 	{field:'szzname',title:'所属地区',width:fixWidth(0.1)},
						  {field:'qymc',title:'企业名称',width:fixWidth(0.15)},
						   ...
						   {field:'sjdw',title:'设计单位',width:fixWidth(0.1)},
	...
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				...
				<th width="15%"> 设计单位</th>
				<td width="35%"> 	 
				 <input name="whpClsc.sjdw" id="sjdw"  size= 50 type="text"   maxlength="255">
				...
				<tr>
				 ...
				 <th width="15%"> 审查专家 </th>
				<td width="35%">
					<input name="whpClsc.sczj" id="sczj"  size= 50 type="text"   maxlength="255">
				 </td>
		 		<th width="15%" >项目类型</th>
					<td  colspan="3">
