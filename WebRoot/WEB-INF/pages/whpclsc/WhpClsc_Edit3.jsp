	...
	<form name="myform1" method="post" enctype="multipart/form-data">
		...
		<div class="submitdata">
			<table width="100%" border="0">
				...
				<tr>	
					<th width="30%" colspan="2">审查专家</th>
					<td width="70%">
					<input name="whpClsc.sczj" value="${whpClsc.sczj}" size= 50 type="text"   maxlength="255">
					</td>
				</tr>
				
				
				<tr>
					<th width="30%" colspan="2">审查日期</th>
					<td width="70%">
				    <input name="whpClsc.scrq" id="scrq"  
				   value="<fmt:formatDate type="date" value="${whpClsc.scrq}" pattern="yyyy-MM-dd"/>"
					type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</td>
				</tr>
		 			
		 		<tr>	
					<th width="30%" colspan="2">审查结果</th>
					<td width="70%">
					<input name="whpClsc.scjg" value="${whpClsc.scjg}" size= 50 type="text"   maxlength="255">
					</td>
				</tr>
		 		...
		 		<tr>
					...
					<s:select id="xmxz" listKey="key" listValue="value" 
					 ...
					 name="whpClsc.xmxz" value="{whpClsc.xmxz}"/>
		 				...
		 				<tr>
					<th width="30%" colspan="2">审批日期</th>
					<td width="70%">
					<input name="whpClsc.sprq" id="sprq"    
					  value="<fmt:formatDate type="date" value="${whpClsc.sprq}" pattern="yyyy-MM-dd"/>"
					type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</td>
				</tr>
		 				
		 		<tr>	
					<th width="30%" colspan="2">审批编号</th>
					<td width="70%">
					<input name="whpClsc.spbh" value="${whpClsc.spbh}" size= 50 type="text"   maxlength="255">
					</td>
				</tr>
				<tr>
