				...
				columns:[[
					 	{field:'szzname',title:'所属地区',width:fixWidth(0.1)},
						  ...
						  {field:'cljsrq',title:'材料接收日期',width:fixWidth(0.1),formatter:function(value,rec){
							...
							{field:'clsbsjrq',title:'材料上报日期',width:fixWidth(0.1),formatter:function(value,rec){
								if(rec.clsbsjrq==null) {return;}
								var date = new Date(rec.clsbsjrq.time);
								var month = parseInt(date.getMonth()+1);
								return date.getFullYear()+'年'+month+'月'+date.getDate()+'日  ';
							}},
							...
							{field:'sczhsyz',title:'生产证或使用证',width:fixWidth(0.1)},
