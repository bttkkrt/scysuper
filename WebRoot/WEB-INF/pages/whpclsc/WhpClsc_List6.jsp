      ...
      /*  alert($("#pjjg").val()+">>"
        ...
        +$("#xmlx").val()+">>");*/
			...
			"createTimeStart" :$("#createTimeStart").val(),
			 ...
			 "whpClsc.pjdw":$("#pjdw").val(),
			 "whpClsc.xmnr":$("#xmnr").val(),
			  "whpClsc.yszj":$("#yszj").val(),
			  "whpClsc.spbh":$("#spbh").val(),
			 "whpClsc.xmxz":$("#xmxz").val(),
			 "createTimeStartYs" :$("#createTimeStartYs").val(),
			 "createTimeEndYs" :$("#createTimeEndYs").val(),
				...
				columns:[[
					 	{field:'szzname',title:'所属地区',width:fixWidth(0.1)},
						  {field:'qymc',title:'企业名称',width:fixWidth(0.2)},
						   ...
						   {field:'pjdw',title:'评价单位',width:fixWidth(0.1)},
						    {field:'yszj',title:'验收专家',width:fixWidth(0.1)},
						   {field:'ysrq',title:'验收日期',width:fixWidth(0.1),formatter:function(value,rec){
								if(rec.ysrq==null) {return;}
								var date = new Date(rec.ysrq.time);
							...
							{field:'sprq',title:'审批日期',width:fixWidth(0.1),formatter:function(value,rec){
							 ...
							 {field:'xmlx',title:'项目类型',width:fixWidth(0.15)},
	...
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				...
				<th width="15%">评价单位</th>
				<td width="35%"> 	
				<input name="whpClsc.pjdw" id="pjdw" size= 50 type="text"   maxlength="255">
				 </td>
				...
				<tr>
				 ...
				 <th width="15%">  验收专家 </th>
				<td width="35%">
					<input name="whpClsc.yszj" id="yszj"  size= 50 type="text"   maxlength="255">
				 </td>
			...
			<th width="15%" >项目类型</th>
		 		...
		 		<tr>
					...
					<tr>
				<th width="15%">验收日期 </th>
				<td width="35%"><input name="createTimeStartYs" id="createTimeStartYs" value="${createTimeStartYs}" type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'createTimeEndYs\')}'})" >
					-<input name="createTimeEndYs" id="createTimeEndYs" value="${createTimeEndYs}" type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'createTimeStartYs\')}'})" ></td>
