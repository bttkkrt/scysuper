			...
			<table width="100%" border="0">
				...
				<tr>
			 	...
			 	<tr>	
					...
					<td width="70%">
					<input name="whpClsc.fzjg" value="${whpClsc.fzjg}" size= 50 type="text"   maxlength="255">
					</td>
				</tr>
				...
				<tr>
					...
					<td width="70%">
					<input name="whpClsc.yxq" id="yxq"    
					  value="<fmt:formatDate type="date" value="${whpClsc.yxq}" pattern="yyyy-MM-dd"/>"
					type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})">
					</td>
				</tr>
				<tr>
					...
					<td width="70%">
				<cus:hxcheckbox property="whpClsc.yzdhxp" defaultText='请选择' codeName="易制毒化学品" 
				value="${whpClsc.yzdhxp}"   /> 
					</td>
				</tr>
				...
				<tr>
					<th width="30%" colspan="2">本次备案情况</th>
					<td   width="70%">
					<textarea id="bclzqk"  
