			...
			<table width="100%">
				<tr>
					...
					<td width="70%"  colspan="3">
						<cus:hxlabel codeName="安全评价机构" itemValue="${whpClsc.pjjg}" />
					</td>
				</tr>
				
				
				<tr>	
					<th width="15%" colspan="2">经营方式</th>
					<td  colspan="3">
					 ${whpClsc.jyfs} 
					</td>
				</tr>
				...
				<tr>	
					<th width="15%" colspan="2">经营类型</th>
					<td  colspan="3">
					 <cus:hxmulselectlabel codeName="经营类型" itemValue="${whpClsc.jylx}" />
					</td>
				</tr>
				<tr>
					...
					<td width="70%"  colspan="3">
					  <fmt:formatDate type="date" value="${whpClsc.slclrq}" pattern="yyyy-MM-dd"/> 
					</td>
				</tr>
				<tr>
					<th width="30%" colspan="2">许可证有效期</th>
					<td width="70%"  colspan="3">
					 <fmt:formatDate type="date" value="${whpClsc.xkzyxq}" pattern="yyyy-MM-dd"/> 
					</td>
				</tr>
				<tr>
					...
					<td width="70%"  colspan="3">
					   ...
					   <s:if test="whpClsc.fzdw == 0">
							市安监局发证
						</s:if>
						<s:elseif test="whpClsc.fzdw == 1" >
							市安监局委托发证
						</s:elseif>
						<s:elseif test="whpClsc.fzdw == 2" >
							区安监局发证
						</s:elseif>
				...
				<tr>	
					<th width="15%" colspan="2">本次领证情况</th>
					<td  colspan="3">
					 <cus:hxmulselectlabel codeName="本次领证情况" itemValue="${whpClsc.bclzqk}" />
					</td>
				</tr>	
				...
				<tr>
					<th width="15%"  colspan="2">乡镇预审意见</th>
					<td  colspan="3">
					 ${whpClsc.xzysyj} 
				...
				<tr>
					<th width="15%"  colspan="2">现场核查部门</th>
					<td  colspan="3">
					${whpClsc.xchcbm}
				...
				<tr>
					<th width="15%"  colspan="2">是否储存涉及</th>
