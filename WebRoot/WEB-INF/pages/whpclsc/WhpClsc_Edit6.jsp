	...
	<form name="myform1" method="post" enctype="multipart/form-data">
		...
		<div class="submitdata">
			<table width="100%" border="0">
				...
				<tr>
					<th width="30%" colspan="2"> 评价单位</th>
					<td width="70%">
					<input name="whpClsc.pjdw" value="${whpClsc.pjdw}" size= 50 type="text"   maxlength="255">
					</td>
				</tr>
				...
				<tr>	
					<th width="30%" colspan="2">验收专家</th>
					<td width="70%">
					<input name="whpClsc.yszj" value="${whpClsc.yszj}" size= 50 type="text"   maxlength="255">
					</td>
				</tr>
				
				
				<tr>
					<th width="30%" colspan="2">验收日期</th>
					<td width="70%">
				    <input name="whpClsc.ysrq" id="ysrq"  
				   value="<fmt:formatDate type="date" value="${whpClsc.ysrq}" pattern="yyyy-MM-dd"/>"
