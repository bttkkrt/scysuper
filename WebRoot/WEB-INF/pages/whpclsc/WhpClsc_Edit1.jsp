	...
	<form name="myform1" method="post" enctype="multipart/form-data">
		...
		<div class="submitdata">
			<table width="100%" border="0">
				...
				<tr>
					<th width="30%" colspan="2"> 生产证或使用证</th>
					<td width="70%">
					<s:select id="sczhsyz" listKey="key" listValue="value"  theme="simple" list="#{'危险化学品生产':'危险化学品生产','危险化学品使用':'危险化学品使用'}" name="whpClsc.sczhsyz" value="{whpClsc.sczhsyz}"/>
					</td>
				</tr>
		 	...
		 	<tr>
				...
				<tr>
					...
					<td   width="70%">
					<s:select id="bclzqk" listKey="key" listValue="value"  theme="simple" list="#{'':'请选择','延期换证':'延期换证','变更法人':'变更法人','变更企业类型':'变更企业类型','变更营业执照':'变更营业执照','变更生产品种':'变更生产品种','新发证':'新发证'}" name="whpClsc.bclzqk" value="{whpClsc.bclzqk}"/>
					</td>
