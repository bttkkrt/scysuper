	...
	<input type="hidden" id="isfinish" name="whpClsc.isfinish" value="${whpClsc.isfinish}">
		<div class="submitdata">
			<table width="100%">
				...
				<tr>
					<th width="15%" colspan="2">审查日期</th>
					<td  colspan="3">
				   <fmt:formatDate type="date" value="${whpClsc.scrq}" pattern="yyyy-MM-dd"/> 
					</td>
				</tr>
		 			
		 		<tr>	
					<th width="15%" colspan="2">审查结果</th>
					<td  colspan="3">
					 ${whpClsc.scjg} 
					</td>
				</tr>
		 		...
		 		<tr>
					<th width="15%" colspan="2">项目性质 </th>
					<td  colspan="3">
					
						
					<s:if test="whpClsc.xmxz == 0">
							新建
						</s:if>
						<s:elseif test="whpClsc.xmxz == 1" >
							改建
						</s:elseif>
						<s:elseif test="whpClsc.xmxz == 2" >
							扩建
						</s:elseif>
		 				...
		 				<tr>
					<th width="15%" colspan="2">审批日期</th>
					<td  colspan="3">
				 
					<fmt:formatDate type="date" value="${whpClsc.sprq}" pattern="yyyy-MM-dd"/>
					</td>
				</tr>
		 				
		 		<tr>	
					<th width="15%" colspan="2">审批编号</th>
					<td  colspan="3">
						${whpClsc.spbh}
					</td>
				</tr>
				<tr>
					<th width="15%" colspan="2">项目类型</th>
					<td  colspan="3" >
					
				<cus:hxmulselectlabel codeName="项目类型" itemValue="${whpClsc.xmlx}" />
					</td>
				</tr>
