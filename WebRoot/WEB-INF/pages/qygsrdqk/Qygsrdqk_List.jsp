...
<head>
<title>企业工伤认定情况管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_qygsrdqk","添加企业工伤认定情况","${ctx}/jsp/qygsrdqk/qygsrdqkInitEdit.action?flag=add&dt="+dt.getTime(),800,400);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_qygsrdqk","修改企业工伤认定情况","${ctx}/jsp/qygsrdqk/qygsrdqkInitEdit.action?flag=mod&qygsrdqk.id="+row_Id+"&dt="+dt.getTime(),800,400);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_qygsrdqk","查看企业工伤认定情况","${ctx}/jsp/qygsrdqk/qygsrdqkView.action?qygsrdqk.id="+row_Id+"&dt="+dt.getTime(),800,400);
        ...
        function exportData()
        {
         var queryMonthTimeStart = $("#queryMonthTimeStart").val();
        	...
        	document.myform.action = "${ctx}/jsp/qygsrdqk/qygsrdqkExport.action";
			...
			<table width="100%">
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_qygsrdqk()" >查询<b></b></a>&nbsp;
