...
<title>剧毒化学品名录管理</title>
	...
	<script>
        ...
        function addNew(){
        	window.open("${ctx}/jsp/jdhxp/jdhxpInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/jdhxp/jdhxpInitEdit.action?flag=mod&jdhxp.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/jdhxp/jdhxpView.action?jdhxp.id="+row_Id);
        }
        function close_win(){
