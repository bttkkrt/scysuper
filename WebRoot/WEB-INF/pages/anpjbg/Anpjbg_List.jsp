...
<html>
<head>
<title>安全评价报告管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/anpjbg/anpjbgInitEdit.action?flag=add",900,600);
        	//window.open("${ctx}/jsp/anpjbg/anpjbgInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/anpjbg/anpjbgInitEdit.action?flag=mod&anpjbg.id="+row_Id,900,600);
        	//window.open("${ctx}/jsp/anpjbg/anpjbgInitEdit.action?flag=mod&anpjbg.id="+row_Id);
        }
        function view(row_Id){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/anpjbg/anpjbgView.action?anpjbg.id="+row_Id,900,600);
        	//window.open("${ctx}/jsp/anpjbg/anpjbgView.action?anpjbg.id="+row_Id);
        }
        function close_win(){
        ...
        function search_anpjbg(){
        	var queryParams = {
					"anpjbg.deptId":$("#deptId").val(),
					"anpjbg.qymc":$("#qymc").val(),
					"anpjbg.pjbgmc":$("#pjbgmc").val(),
...
{field:'pjbgmc',title:'评价报告名称',width:fixWidth(0.2)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			<tr>
				<th width="15%">单位名称</th>
				<td width="35%"><input name="anpjbg.qymc" size= 35 id="qymc" value="${anpjbg.qymc}" type="text"></td>
				<th width="15%">报告名称</th>
				<td width="35%"><input name="anpjbg.pjbgmc" size= 35 id="pjbgmc" value="${anpjbg.pjbgmc}" type="text"></td>
			</tr>
			<tr>
				...
				<s:if test="visable==1">
					...
					<select id="deptId" name="anpjbg.deptId" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="anpjbg.deptId" defaultText='请选择' codeName="相城地址" value="${anpjbg.deptId}" /></td>
					 -->
				</s:if>
			</tr>
			<tr>
				<td colspan="4" style="text-align:center">
				<a href="###" class="easyui-linkbutton" onclick="search_anpjbg()" iconCls="icon-search">查询</a>&nbsp;
