	...
	<form name="myform" method="post">
		<div class="submitdata">
			...
			<s:if test="role==0">
				<tr>
				<th width="15%">所在街道</th>
					<td width="35%">${anpjbg.szz}</td>
					<th width="15%">企业名称</th>
					<td width="35%">${anpjbg.qymc}</td>
				</tr>
						</s:if>
				<tr>
					<th width="15%">评价报告名称</th>
					<td width="35%">${anpjbg.pjbgmc}</td>
					<th width="15%">上传时间</th>
					<td width="35%"><fmt:formatDate type="both" value="${anpjbg.createTime}" /></td>
				</tr>
					<tr>
					<th width="15%">已上传文件</th>
				<td width="85%" colspan="3">
					 <div style="color:green;overflow:auto; height:550px;">
										  <table id="aqpjbg">
