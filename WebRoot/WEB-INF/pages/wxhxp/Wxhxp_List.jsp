...
<title>危险化学品名录管理</title>
	...
	<script>
        ...
        function addNew(){
        	window.open("${ctx}/jsp/wxhxp/wxhxpInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/wxhxp/wxhxpInitEdit.action?flag=mod&wxhxp.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/wxhxp/wxhxpView.action?wxhxp.id="+row_Id);
        }
        
        function importData(){
        	window.open("${ctx}/jsp/wxhxp/wxhxpImportData.action");
        }
        function close_win(){
