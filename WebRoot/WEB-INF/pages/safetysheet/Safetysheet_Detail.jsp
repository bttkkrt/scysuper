...
<%@include file="/WEB-INF/template/content_title.jsp"%>
	<form name="myform" method="post">
		<div class="submitdata">
			...
			<tr>
					<th width="15%">所属街道</th>
					<td width="85%">${safetysheet.deptName}</td>
			</tr>
			<tr>
					<th width="15%">企业名称</th>
					<td width="85%">${safetysheet.comName}</td>
				</tr>
			</s:if>
				<tr>
					<th width="15%">制度名称</th>
					<td width="85%"><cus:hxlabel codeName="安全生产规章制度" itemValue="${safetysheet.systemname}" /></td>
				</tr>
				<tr>
				...
				<td width="85%">
					...
					<tr>
					<td colspan="2" height="10px" style="text-align:center">
