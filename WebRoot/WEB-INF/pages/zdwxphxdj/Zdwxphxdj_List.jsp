...
<title>危险化学品重大危险源核销登记管理</title>
	...
	<script>
        ...
        function addNew(){
    		...
    		var xc = (aw - 800) / 2;
    		var yc = (ah - 700) / 2;
            openparentWindow("newWindow","添加危险化学品重大危险源核销登记",xc,yc,"800","600","${ctx}/jsp/zdwxphxdj/zdwxphxdjInitEdit.action?flag=add&dt="+dt.getTime(),true,true,true,false,true,"win");
        }
        function edit(row_Id){
    		...
    		var xc = (aw - 800) / 2;
    		var yc = (ah - 700) / 2;
            openparentWindow("newWindow","修改危险化学品重大危险源核销登记",xc,yc,"800","600","${ctx}/jsp/zdwxphxdj/zdwxphxdjInitEdit.action?flag=mod&zdwxphxdj.id="+row_Id+"&dt="+dt.getTime(),true,true,true,false,true,"win");
        ...
        function view(row_Id){
    		...
    		var xc = (aw - 800) / 2;
    		var yc = (ah - 700) / 2;
            openparentWindow("newWindow","查看危险化学品重大危险源核销登记",xc,yc,"800","600","${ctx}/jsp/zdwxphxdj/zdwxphxdjView.action?zdwxphxdj.id="+row_Id+"&dt="+dt.getTime(),true,true,true,false,true,"win");
        ...
        function search_zdwxphxdj(){
        	var queryParams = {
        	"zdwxphxdj.szzid": $("#szzid").val(),
				"zdwxphxdj.hxbh": $("#hxbh").val(),
"zdwxphxdj.qymc": $("#qymc").val(),
"zdwxphxdj.zdwxymc": $("#zdwxymc").val(),
"zdwxphxdj.zdwxybabh": $("#zdwxybabh").val(),
 ...
 "queryDjrqEnd" :$("#queryDjrqEnd").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				title:'危险化学品重大危险源核销登记列表',
				iconCls:'icon-save',
				nowrap: false,
				striped: true,
				collapsible:true,
				url:'zdwxphxdjQuery.action',
				queryParams:{
				"zdwxphxdj.szzid": $("#szzid").val(),
					"zdwxphxdj.hxbh": $("#hxbh").val(),
"zdwxphxdj.qymc": $("#qymc").val(),
...
{field:'qymc',title:'填报单位名称',width:fixWidth(0.3)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			<tr>
				<th width="15%">填报单位名称</th>
				<td width="35%"><input name="zdwxphxdj.qymc" id="qymc" value="${zdwxphxdj.qymc}" type="text"></td>
			...
			<s:if test="flag==3">
					...
					<select id="szzid" name="zdwxphxdj.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="zdwxphxdj.szzid" defaultText='请选择' codeName="相城地址" value="${zdwxphxdj.szzid}" /></td>
					 -->
					</tr>
				</s:if>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_zdwxphxdj()" iconCls="icon-search">查询</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="clear_form(document.myform);" iconCls="icon-undo">清空</a>&nbsp;				
				<s:if test="flag == 1">
				<a href="###" class="easyui-linkbutton" onclick="addNew();" iconCls="icon-add">添加</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="del();" iconCls="icon-remove">删除</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="download('hxdj')" iconCls="icon-add">模板下载</a>
				</s:if>
				</td>
			</tr>
		</table>
