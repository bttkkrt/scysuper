		...
		<div class="submitdata">
			<table width="100%">
				<tr>
					...
					<td width="30%">${zdwxyhxsq.szzname}</td>
					<th width="20%">填报单位名称</th>
					<td width="30%">${zdwxyhxsq.qymc}</td>
				</tr>
				<tr>
					<th width="20%">上传时间</th>
					<td width="30%"><fmt:formatDate type="both" value="${zdwxyhxsq.createTime}" /></td>
				</tr>
				<tr>
					<th width="20%">核销申请</th>
					<td width="80%" colspan="3">
					<div style="color:green;overflow:auto; height:200px;">
										  <table id="zdwxyhxsqb" width="80%">
