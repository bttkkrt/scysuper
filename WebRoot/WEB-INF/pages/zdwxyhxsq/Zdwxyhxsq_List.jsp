...
<title>危险化学品重大危险源核销管理</title>
	...
	<script>
        var flag = "${flag}";
        function addNew(){
        	window.open("${ctx}/jsp/zdwxyhxsq/zdwxyhxsqInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/zdwxyhxsq/zdwxyhxsqInitEdit.action?flag=mod&zdwxyhxsq.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/zdwxyhxsq/zdwxyhxsqView.action?zdwxyhxsq.id="+row_Id);
        }
        ...
        function search_zdwxyhxsq(){
        	var queryParams = {
		"zdwxyhxsq.szzid": $("#szzid").val(),
				"zdwxyhxsq.zdwxymc": $("#zdwxymc").val(),
"zdwxyhxsq.zdwxybabh": $("#zdwxybabh").val(),
 "queryDjrqStart" :$("#queryDjrqStart").val(),
 "queryDjrqEnd" :$("#queryDjrqEnd").val(),
"zdwxyhxsq.qymc": $("#qymc").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				title:'危险化学品重大危险源核销信息列表',
				iconCls:'icon-save',
				nowrap: false,
				striped: true,
				collapsible:true,
				url:'zdwxyhxsqQuery.action',
				queryParams:{
				"zdwxyhxsq.szzid": $("#szzid").val(),
					"zdwxyhxsq.zdwxymc": $("#zdwxymc").val(),
"zdwxyhxsq.zdwxybabh": $("#zdwxybabh").val(),
	...
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				...
				<td width="35%"><input name="zdwxyhxsq.qymc" id="qymc" value="${zdwxyhxsq.qymc}" type="text"></td>
			...
			<s:if test="flag==3">
				<tr>
					...
					<select id="szzid" name="zdwxyhxsq.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="zdwxyhxsq.szzid" defaultText='请选择' codeName="相城地址" value="${zdwxyhxsq.szzid}" /></td>
					 -->
				</tr>
			</s:if>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_zdwxyhxsq()" iconCls="icon-search">查询</a>&nbsp;
