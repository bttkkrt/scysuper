...
<body>
		<div class="page_dialog">
			<form name="myform" method="post" enctype="multipart/form-data">
				<div class="inner12px">
					<div class="bigtitle">
						${receiveInformation.recinfoTitle}
					</div>
					<div class="info">
						<span>来文单位：${receiveInformation.userName}</span>
						<span>收文时间：<fmt:formatDate type="date" value="${receiveInformation.recinfoTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
						<span>来文编号：${receiveInformation.recinfoNum}</span>
						<span>来文类型：<cus:hxlabel codeName="来文类型" itemValue="${receiveInformation.recinfoType}" /></span>
					</div>
