...
<head>
	...
	<script>
		 ...
		 $(document).ready(function(){
			    ...
			    var infoType = window.opener.document.getElementById('recinfoType').value;
                var u=userNames.substring(0,userNames.length-1); 
                var ids=userIds.split(",");
                var names=u.split(",");
			    var t=new Date().getTime();
			    $.post('${ctx}/jsp/swgl/getDepartUser.action',{'t':t,'receiveInformation.recinfoType':infoType,'userIds':userIds},function(nodes){
