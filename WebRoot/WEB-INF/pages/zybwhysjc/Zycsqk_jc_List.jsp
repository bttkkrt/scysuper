...
<title>职业病危害因素检测</title>
	...
	<script>
        ...
        function editZybwhysjc(row_Id,cjmc){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/zybwhysjc/zybwhysjcList.action?Zybwhysjc.cjid="+row_Id,900,600);
        	//parent.parent.frames["frm"].addTab("zybwhysjcList",cjmc+"-职业病危害因素检测","${ctx}/jsp/zybwhysjc/zybwhysjcList.action?Zybwhysjc.cjid="+row_Id);
        }
        function del(){
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				...
				columns:[[
						...
						{field:'zywhysmc',title:'职业病危害因素名称',width:fixWidth(0.2)},
				          {field:'op',title:'编辑',width:fixWidth(0.2),formatter:function(value,rec){
	                            
	                            if(flag == '1')
				          		{
				          			return "<span style='color:red;cursor:hand' onclick=\"editZybwhysjc('"+rec.id+"','" + rec.cjmc + "')\">编辑职业病危害因素检测</span>";
				          		}
	                            else
	                            {
	                            	return "<span style='color:red;cursor:hand' onclick=\"editZybwhysjc('"+rec.id+"','" + rec.cjmc + "')\">查看职业病危害因素检测</span>";
	                            }  
                          }}
				        ]],
				pagination:true,
