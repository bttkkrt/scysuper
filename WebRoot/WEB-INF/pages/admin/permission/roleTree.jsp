...
<script>
		    $(function(){
	             $('#roleTree').tree({   
	                 checkbox: true,
					 cascadeCheck:false, 
	                 url: '${ctx}/jsp/admin/role/findRoleTreeForFunc.action?userRole.roleType=ALL&funcId='+'<%=funcId%>', 
	                 onBeforeExpand:function(node,param){
	                     $('#roleTree').tree('options').url = "${ctx}/jsp/admin/role/findRoleTreeForFunc.action?userRole.roleType=ALL&selNode=" + node.id+"&funcId="+'<%=funcId%>';
                 	 },
