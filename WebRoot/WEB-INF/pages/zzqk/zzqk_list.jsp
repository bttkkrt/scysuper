...
.photos-demo img{width:200px;}
    ...
    var ajaxData={ };
			...
			$.ajax({
		                    ...
		                    success: function(data){
		                    	...
		                    	$.each(data.result,function(idx,item){ 
		                    		var intelligenceCardnum=item.intelligenceCardnum;
		                    		var intelligenceCardname=item.intelligenceCardname;
		                    		if(intelligenceCardnum.length>10){
		                    			intelligenceCardnum=intelligenceCardnum.substring(0,10)+"...";
		                    		}
		                    		if(intelligenceCardname.length>10){
		                    			intelligenceCardname=intelligenceCardname.substring(0,10)+"...";
		                    		}
		                    		//获取操作按钮
		                    		...
		                    		tr+="<td>"+item.areaName+"</td><td>"
		                    		+item.companyName+"</td><td>"+intelligenceCardnum+"</td><td>"
		                    		+intelligenceCardname+"</td><td>"+item.intelligenceType+"</td><td>"
		                    		+item.auditState+"</td>"
        ...
        function getButton(rec){
        	var button1="<a style='color:blue' href='#' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a style='color:blue' href='#' onclick=check('"+rec.id+"')>审核<b></b></a>";
			var button2="<a style='color:blue' href='#' onclick=view('"+rec.id+"') >查看<b></b></a>";
			var button3="<a style='color:blue' href='#' onclick=view('"+rec.id+"') >查看<b></b></a>&nbsp;<a style='color:blue' href='#' onclick=edit('"+rec.id+"')>修改<b></b></a>";
			if(rec.auditState=='待审核'&&"true"=="${canCheck}"){
				return button1;
			}else if(rec.auditState=='审核通过'||'${roleName}'!='0'){
				return button2;
			}else if(rec.auditState=='审核未通过'&&"true"=="${canCheck}"){
				return button2;
			}else if(rec.auditState=='审核未通过')
			{
				return button3;
			}
			else{
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_intSit","添加行政许可及资质情况","${ctx}/zwt/intSitInitEdit.action?flag=add&dt="+dt.getTime(),700,500);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_intSit","修改行政许可及资质情况","${ctx}/zwt/intSitInitEdit.action?flag=mod&intSit.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_intSit","查看行政许可及资质情况","${ctx}/zwt/intSitView.action?intSit.id="+row_Id+"&dt="+dt.getTime(),700,500);
        	
        }
         function check(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_intSit","审核行政许可及资质情况","${ctx}/zwt/intSitCheck.action?flag=check&intSit.id="+row_Id+"&dt="+dt.getTime(),700,500);
    	...
    	<div class="sipac_head">
            ...
            <div class="s_h_nav">
                <ul>
                	...
                	<li>
                		<a class="active" href="${ctx }/zwt/intSitList.action">资质情况</a>
                    </li>
                    <li>
                		<a href="${ctx }/zwt/honRecList.action">荣誉表彰信息</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="sipac_rtbox">
            	...
            	<div class="sipac_searchbar">
                	<input class="s_s_text" type="text" id="searchLike" value="搜索企业名称、证书名称或编号"><input class="s_s_btn" type="submit" onclick="searchByNameOrCode();"><!-- 
        	...
        	<div class="sipac_menu">
                <ul>
                	...
                	<li style="text-align:center;">
                    	<a style="font-size:30px;" href="form.html">②</a>
                        <div class="dropdown_nav">
                         <a class="s_m_tit" href="form.html">组织机构职责</a>
                        </div>
                    </li>
                	<li style="text-align:center;">
                    	<a style="font-size:30px;" href="simple_page.html">③</a>
                        <div class="dropdown_nav">
                         <a class="s_m_tit" href="simple_page.html">安全生产投入</a>
                        </div>
                    </li>
                </ul>
            	...
            	<div class="sipac_tableBox">
                	...
                	<table>
                        ...
                        <tr>
                        	...
                        	<th><span>证书名称</span></th>
                        	<th><span>资质类型</span></th>
