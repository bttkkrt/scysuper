...
<html>
<head>
<title>重大危险源信息管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
         var flag = "${flag}";
        var createUserID = "${createUserID}";
        function addNew(){
        	window.open("${ctx}/jsp/zdwxytjxx/zdwxytjxxInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/zdwxytjxx/zdwxytjxxInitEdit.action?flag=mod&zdwxytjxx.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/zdwxytjxx/zdwxytjxxView.action?zdwxytjxx.id="+row_Id);
        }
        function close_win(){
        ...
        function exportdata()
        {
        	document.myform.action = "${ctx}/jsp/zdwxytjxx/zdwxytjxxExport.action";
        ...
        function search_zdwxytjxx(){
        	var queryParams = {
				"zdwxytjxx.szzid": $("#szzid").val(),
"zdwxytjxx.qymc": $("#qymc").val(),
...
"zdwxytjxx.qymc": $("#qymc").val(),
 ...
 "queryTbrqEnd" :$("#queryTbrqEnd").val()
				...
				columns:[[
				          {field:'szzname',title:'所在镇',width:fixWidth(0.09)},
{field:'qymc',title:'企业名称',width:fixWidth(0.2)},
{field:'yjgs',title:'一级危险源个数',width:fixWidth(0.09)},
{field:'ejgs',title:'二级危险源个数',width:fixWidth(0.09)},
{field:'sjgs',title:'三级危险源个数',width:fixWidth(0.09)},
{field:'sijigs',title:'四级危险源个数',width:fixWidth(0.09)},
{field:'tbr',title:'填表人',width:fixWidth(0.1)},
{field:'tbrq',title:'填表日期',width:fixWidth(0.1),formatter:function(value,rec){
if(rec.tbrq==null) return;
var date = new Date(rec.tbrq.time);
		...
		<table width="100%">
			<tr>
				...
				<td width="35%">
					...
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="zdwxytjxx.szzid" defaultText='请选择' codeName="相城地址" value="${zdwxytjxx.szzid}" /></td>
					 -->
				<th width="15%">企业名称</th>
				<td width="35%"><input name="zdwxytjxx.qymc" id="qymc" value="${zdwxytjxx.qymc}" type="text"></td>
			</tr>
			<tr>
				<th width="15%">填表日期</th>
			...
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_zdwxytjxx()" iconCls="icon-search">查询</a>&nbsp;
