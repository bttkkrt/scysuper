...
<title>危险化学品重大危险源备案申请管理</title>
	...
	<script>
        ...
        function addNew(){
    		...
    		var xc = (aw - 800) / 2;
    		var yc = (ah - 700) / 2;
            openparentWindow("newWindow","添加危险化学品重大危险源备案申请",xc,yc,"800","600","${ctx}/jsp/zdwxybasq/zdwxybasqInitEdit.action?flag=add&dt="+dt.getTime(),true,true,true,false,true,"win");
        ...
        function edit(row_Id){
    		...
    		var xc = (aw - 800) / 2;
    		var yc = (ah - 700) / 2;
            openparentWindow("newWindow","修改危险化学品重大危险源备案申请",xc,yc,"800","600","${ctx}/jsp/zdwxybasq/zdwxybasqInitEdit.action?flag=mod&zdwxybasq.id="+row_Id+"&dt="+dt.getTime(),true,true,true,false,true,"win");
        ...
        function view(row_Id){
    		...
    		var xc = (aw - 800) / 2;
    		var yc = (ah - 700) / 2;
            openparentWindow("newWindow","查看危险化学品重大危险源备案申请",xc,yc,"800","600","${ctx}/jsp/zdwxybasq/zdwxybasqView.action?zdwxybasq.id="+row_Id+"&dt="+dt.getTime(),true,true,true,false,true,"win");
        ...
        function search_zdwxybasq(){
        	var queryParams = {
        	"zdwxybasq.szzid": $("#szzid").val(),
				"zdwxybasq.qymc": $("#qymc").val(),
"zdwxybasq.zdwxymc": $("#zdwxymc").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				title:'危险化学品重大危险源备案申请列表',
				iconCls:'icon-save',
				nowrap: false,
				striped: true,
				collapsible:true,
				url:'zdwxybasqQuery.action',
				queryParams:{
				"zdwxybasq.szzid": $("#szzid").val(),
					"zdwxybasq.qymc": $("#qymc").val(),
"zdwxybasq.zdwxymc": $("#zdwxymc").val(),
	...
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				...
				<td width="35%"><input name="zdwxybasq.qymc" id="qymc" value="${zdwxybasq.qymc}" type="text"></td>
			...
			<s:if test="flag==3">
				<tr>
					...
					<select id="szzid" name="zdwxybasq.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="zdwxybasq.szzid" defaultText='请选择' codeName="相城地址" value="${zdwxybasq.szzid}" /></td>
					 -->
				</tr>
			</s:if>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_zdwxybasq()" iconCls="icon-search">查询</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="clear_form(document.myform);" iconCls="icon-undo">清空</a>&nbsp;				
				<s:if test="flag == 1">
				<a href="###" class="easyui-linkbutton" onclick="addNew();" iconCls="icon-add">添加</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="del();" iconCls="icon-remove">删除</a>&nbsp;
				<a href="###" class="easyui-linkbutton" onclick="download('basq')" iconCls="icon-add">模板下载</a>
				</s:if>
				</td>
			</tr>
		</table>
