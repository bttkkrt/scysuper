...
<title>危险化学品建设项目行政许可管理</title>
	...
	<script>
        ...
        function search_dangerlicene(){
        	var queryParams = {
					"dangerlicene.deptId":$("#deptId").val(),
					"dangerlicene.qymc":$("#qymc").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				...
				{field:'qymc',title:'企业名称',width:fixWidth(0.2)},
				          ...
				          {field:'smjmc',title:'扫描件名称',width:fixWidth(0.3),formatter:function(value,rec){
  var temp = '';
    $.ajax({
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			<tr>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="dangerlicene.qymc" size= 35 id="qymc" value="${dangerlicene.qymc}" type="text"></td>
			...
			<tr>
				...
				<s:if test="visable==1">
					...
					<select id="deptId" name="dangerlicene.deptId" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="dangerlicene.deptId" defaultText='请选择' codeName="相城地址" value="${dangerlicene.deptId}" /></td>
					 -->
				</s:if>
			</tr>
			<tr>
