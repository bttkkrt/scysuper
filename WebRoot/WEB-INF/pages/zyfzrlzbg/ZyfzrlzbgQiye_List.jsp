	...
	<script>
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				...
				columns:[[
{field:'fzr',title:'主要负责人',width:fixWidth(0.1)},
{field:'bgmc',title:'履职报告',width:fixWidth(0.1)},
...
{field:'sfywxgy',title:'是否有危险工艺',width:fixWidth(0.15),formatter:function(value,rec){
  var temp = '';
    $.ajax({
    ...
    dataType: 'json',
    async : false,
    data:{        "codeValue.itemValue" : rec.sfywxgy,
        "codeValue.codeId" : "402809812e7f8c28012e7fa82239000c"    },
    error: function(){
...
{field:'sfgczdwxy',title:'是否构成重大危险源',width:fixWidth(0.15),formatter:function(value,rec){
  var temp = '';
    $.ajax({
    url: '${ctx}/jsp/admin/code/findCodeValue.action',
    type: 'post',
    dataType: 'json',
    async : false,
    data:{        "codeValue.itemValue" : rec.sfgczdwxy,
        "codeValue.codeId" : "402809812e7f8c28012e7fa82239000c"    },
    error: function(){
        $.messager.alert('提示','获取一维代码错误！');
    },
