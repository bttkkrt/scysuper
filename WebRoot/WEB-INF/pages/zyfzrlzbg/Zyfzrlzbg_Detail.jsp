	...
	<form name="myform" method="post">
		<div class="submitdata">
			...
			<s:if test="role==0">
				<tr>
				<th width="15%">所在街道</th>
					<td width="35%">${zyfzrlzbg.szz}</td>
					<th width="15%">企业名称</th>
					<td width="35%">${zyfzrlzbg.qymc}</td>
				</tr>
						</s:if>
				<tr>
					<th width="15%">所在街道</th>
					<td width="35%">${zyfzrlzbg.szz}</td>
					<th width="15%">履职报告</th>
					<td width="35%">${zyfzrlzbg.bgmc}</td>
				</tr>
				<tr>
					<th width="15%">是否有危险工艺</th>
					<td width="35%"><cus:hxlabel codeName="是或否" itemValue="${zyfzrlzbg.sfywxgy}" /></td>
					<th width="15%">是否构成重大危险源</th>
					<td width="35%"><cus:hxlabel codeName="是或否" itemValue="${zyfzrlzbg.sfgczdwxy}" /></td>
				</tr>
				<tr>
					<th width="15%">上传时间</th>
					<td width="35%"><fmt:formatDate type="both" value="${zyfzrlzbg.createTime}" /></td>
						</tr>
					<tr>
