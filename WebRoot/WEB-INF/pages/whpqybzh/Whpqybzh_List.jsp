...
<head>
<title>危化品企业标准化核查完成情况管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_whpqybzh","添加危化品企业标准化核查完成情况","${ctx}/jsp/whpqybzh/whpqybzhInitEdit.action?flag=add&dt="+dt.getTime(),800,400);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_whpqybzh","修改危化品企业标准化核查完成情况","${ctx}/jsp/whpqybzh/whpqybzhInitEdit.action?flag=mod&whpqybzh.id="+row_Id+"&dt="+dt.getTime(),800,400);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_whpqybzh","查看危化品企业标准化核查完成情况","${ctx}/jsp/whpqybzh/whpqybzhView.action?whpqybzh.id="+row_Id+"&dt="+dt.getTime(),800,400);
         ...
         function exportData()
        {
         var queryMonthTimeStart = $("#queryMonthTimeStart").val();
        	...
        	document.myform.action = "${ctx}/jsp/whpqybzh/whpqybzhExport.action";
...
"whpqybzh.areaName": $("#areaName").val()
        ...
        $(function(){
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				title:'危化品企业标准化核查完成情况列表',
				url:'whpqybzhQuery.action',
				queryParams:{
					 "queryMonthTimeStart" :$("#queryMonthTimeStart").val(),
 "queryMonthTimeEnd" :$("#queryMonthTimeEnd").val(),
"whpqybzh.areaName": $("#areaName").val()
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_whpqybzh()" >查询<b></b></a>&nbsp;
