...
<html>
<head>
<title>职业病防护设施竣工管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
	 var flag = "${flag}";
	 var createUserID = "${createUserID}";
        function addNew(){
        	window.open("${ctx}/jsp/zywsxzxk/zywsxzxkInitEdit.action?flag=add&zywsxzxk.type=3");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/zywsxzxk/zywsxzxkInitEdit.action?flag=mod&zywsxzxk.type=3&zywsxzxk.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/zywsxzxk/zywsxzxkView.action?zywsxzxk.id="+row_Id+"&zywsxzxk.type=3");
        }
