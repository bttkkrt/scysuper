...
<html>
<head>
<title>职业病危害预评价报告管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
	 var flag = "${flag}";
	 var createUserID = "${createUserID}";
        function addNew(){
        	window.open("${ctx}/jsp/zywsxzxk/zywsxzxkInitEdit.action?flag=add&zywsxzxk.type=1");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/zywsxzxk/zywsxzxkInitEdit.action?flag=mod&zywsxzxk.type=1&zywsxzxk.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/zywsxzxk/zywsxzxkView.action?zywsxzxk.id="+row_Id+"&zywsxzxk.type=1");
        }
	...
	<div class="submitdata">
		<table width="100%">
			<tr>
				...
				<th width="15%">审核状态</th>
				<td width="35%">
					<s:select id="state" listKey="key" listValue="value"  theme="simple" list="#{'':' ','1':'待审核','2':'审核不通过','3':'审核通过'}" name="zywsxzxk.state" value="{zywsxzxk.state}"/>
				</td>
			</tr>
			<tr>
					<th width="15%">行业类别</th>
