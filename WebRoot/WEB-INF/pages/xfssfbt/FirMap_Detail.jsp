	...
	<form name="myform" method="post">
		...
		<div class="inner6px">
			...
			<table width="100%">
				<tr>
					<th width="15%">所在区域</th>
					<td width="35%" >${firMap.areaName}</td>
					<th width="15%">企业名称</th>
					<td width="35%" >${firMap.companyName}</td>
				</tr>
				<tr>
					<th width="15%">设施名称</th>
					<td width="35%" >${firMap.facilityName}</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4" height="100px" style="text-align:center">
					    <a href="#" class="btn_01" onclick="parent.close_win('win_firMap');">关闭<b></b></a>
					</td>
				</tr>
			</table>
		</div></div></div>
