...
<title>职业卫生安全管理制度管理</title>
	...
	<script>
        ...
        function addNew(){
        	window.open("${ctx}/jsp/zywsglzd/zywsglzdInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/zywsglzd/zywsglzdInitEdit.action?flag=mod&zywsglzd.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/zywsglzd/zywsglzdView.action?zywsglzd.id="+row_Id);
        }
        function close_win(){
        ...
        function search_zywsglzd(){
        	var queryParams = {
				"zywsglzd.producename": $("#producename").val(),
"zywsglzd.deptId": $("#deptId").val(),
"zywsglzd.comname": $("#comname").val(),
...
"zywsglzd.comname": $("#comname").val(),
  ...
  var temp = '';
    ...
    data:{        "codeValue.itemValue" : rec.producename,
        "codeValue.codeId" : "4028804840ce54940140ce592447000d"    },
    error: function(){
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="zywsglzd.comname" size=35 id="comname" value="${zywsglzd.comname}" type="text"></td>
				<th width="15%">制度名称</th>
				<td width="35%"><cus:SelectOneTag property="zywsglzd.producename" defaultText='请选择' codeName="职业卫生管理制度" value="${zywsglzd.producename}" /></td>
			...
			<tr>
				...
				<td width="35%">
					...
					<select id="deptId" name="zywsglzd.deptId" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="zywsglzd.deptId" defaultText='请选择' codeName="相城地址" value="${zywsglzd.deptId}" /></td>
					 -->
			</s:if>
			</tr>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_zywsglzd()" iconCls="icon-search">查询</a>&nbsp;
