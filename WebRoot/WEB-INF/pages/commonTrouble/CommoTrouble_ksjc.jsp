...
<html>
<head>
<title>安监局各科室（大队）检查企业情况统计表</title>
	<%@include file="/common/jsLib.jsp"%>
	<script>
        function search_tj(){
        	 
          	document.myform.action ="${ctx}/jsp/commonTrouble/commoTroubleKsjcTongJi.action";
        ...
        function exportdata()
        {
        	document.myform.action = "${ctx}/jsp/commonTrouble/commoTroubleKsjcExport.action";
        		document.myform.submit();
