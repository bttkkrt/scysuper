	...
	<form name="myform" method="post">
		...
		<div class="inner6px">
			...
			<table width="100%">
				<tr>
					<th width="15%">所在区域</th>
					<td width="35%" >${legSta.areaName}</td>
					<th width="15%">企业名称</th>
					<td width="35%" >${legSta.companyName}</td>
				</tr>
				<tr>
				    <th width="15%">清单名称</th>
					<td width="35%" >${legSta.legalName}</td>
					<th width="15%">上传时间</th>
					<td width="35%" ><fmt:formatDate type="both" value="${legSta.legalStandardTime}" /></td>
				</tr>
				<tr>
