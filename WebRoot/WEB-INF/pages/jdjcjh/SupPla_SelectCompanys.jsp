...
<head>
	...
	<script>
		 ...
		 $(document).ready(function(){
			    ...
			    $.post('${ctx}/jsp/jdjcjh/getDepartUser.action',{'t':t,'companyIds':companyIds},function(nodes){
 ...
 function RemoveSelect()
 {
		...
		$.post('${ctx}/jsp/jdjcjh/getDepartUser.action',{'t':t,'companyIds':companyids,'entBaseInfo.enterpriseNature':enterpriseNature,'entBaseInfo.enterpriseType':enterpriseType,'entBaseInfo.enterpriseScale':enterpriseScale,'entBaseInfo.enterpriseName':enterpriseName},function(nodes){
			$.fn.zTree.init($("#treeDemo"), setting, nodes);
		},'json');
 }
 ...
 function returnCheckedUsers(flowType) {
	...
	function searchCompanys(){
	     //根据查询条件查询出企业
			    ...
			    $.post('${ctx}/jsp/jdjcjh/getDepartUser.action',{'t':t,'entBaseInfo.enterpriseNature':enterpriseNature,'entBaseInfo.enterpriseType':enterpriseType,'entBaseInfo.enterpriseScale':enterpriseScale,'entBaseInfo.enterpriseName':enterpriseName,'companyIds':companyIds},function(nodes){
			    	$.fn.zTree.init($("#treeDemo"), setting, nodes);
			    },'json');
...
<body>
		...
		<div class="inner12px">
			...
			<tr>
			   <th width="15%">企业性质</th>
			    <td width="35%"><cus:SelectOneTag property="entBaseInfo.enterpriseNature" defaultText='请选择' codeName="企业性质" value="${entBaseInfo.enterpriseNature}" maxlength="127"/></td>
			    <th width="15%">企业分类</th>
			 ...
			 <td colspan="4" style="text-align:center">
			 	<a href="###" class="btn_01" onclick="searchCompanys()" >查询<b></b></a>&nbsp;
			 </td>
			 </tr>
			 </table>
		</div>
			...
			<tr width="100%">
				<td  style="vertical-align:top;text-align:center;" width="50%">
				 ...
				 <div class="zTreeDemoBackground left" style="width:100%">
					<ul id="treeDemo" class="ztree" style="width:90%">
					</ul>
				 </div>
				 </td>
				<td  style="vertical-align:top;text-align:center;" width="50%">
				<div class="zTreeDemoBackground left" style="width:100%">
					<ul id="tree1" class="ztree" style="width:90%">
