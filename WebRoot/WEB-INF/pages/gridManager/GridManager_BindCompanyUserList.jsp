	...
	<script>
        ...
        function bindCompanyUser(){
			...
			if(rows.length<1){
			    ...
			    $.messager.confirm("删除","确定要绑定吗?",function(result){
			        if(result){
		                $.ajax({
		                	url : "gridManagerBindCompanyUser.action",
		                	type: 'post',
		                    dataType: 'json',
		                    async : false,
		                    data:{ 
        ...
        function unbindCompanyUser(){
			...
			if(rows.length<1){
			    ...
			    $.messager.confirm("删除","确定要解除绑定吗?",function(result){
			        if(result){
		                $.ajax({
		                	url : "gridManagerJcBindCompanyUser.action",
		                	type: 'post',
		                    dataType: 'json',
		                    async : false,
		                    data:{ 
        ...
        $(function(){
			$('#pagination').datagrid({
				...
				striped: true,
				collapsible:true,
				url:'gridManagerBindCompanyUserQuery.action',
				queryParams:{
				...
				columns:[[
				          	 {field:'name',title:'有证企业名称',width:300},
