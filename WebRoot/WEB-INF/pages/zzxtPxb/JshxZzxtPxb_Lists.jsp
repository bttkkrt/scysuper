...
<title>员工再培训及转岗、下岗、脱岗培训管理</title>
	...
	<script>
        ...
        function view(row_Id){
          location.href = "${ctx}/jsp/zzxtPxb/jshxZzxtPxbList.action?jshxZzxtPxb.qyid="+row_Id;
        ...
        function search_jshxZzxtPxb(){
        	var queryParams = {
        	"jshxZzxtPxb.szzid": $("#szzid").val(),
"jshxZzxtPxb.qymc": $("#qymc").val()
			};        	
		...
		<table width="100%">
			<tr>
			  	<s:if test="flag==2">
					...
					<select id="szzid" name="jshxZzxtPxb.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="jshxZzxtPxb.szzid" defaultText='请选择' codeName="相城地址" value="${jshxZzxtPxb.szzid}" /></td>
					 -->
				</s:if>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="jshxZzxtPxb.qymc" id="qymc" value="${jshxZzxtPxb.qymc}" type="text"></td>
			</tr>
			<tr>
			</tr>
			<tr>
