...
<head>
	...
	<script>
	    ...
	    $(document).ready(function(){
	    	var data = 'jshxZcyhsbSavePhoto.action?type='+'${flag}'+','+'${jshxZcyhsb.linkId}';
		   	$("#uploadify").uploadify({
		...
		　		'fileDesc': '支持格式:gif,jpg,bmp,png,jpeg', //如果配置了以下的'fileExt'属性，那么这个属性是必须的  
				...
				var extname = picName;
				var table = window.opener.document.getElementById(flag);
				...
				comFile.indexOf('.gif')>0){
					var img = '<img src="/upload/photo/'+picName+'"';
					span1.innerHTML=img+" border='0' width='220' height='150'/>&nbsp;&nbsp;<br>"+filename;
				}else{
			...
			<table>
					<tr>
						<td width="60%" colspan="2">
								<div id="fileQueue" /><span style="color:red;float: right;">支持格式:gif,jpg,bmp,png,jpeg;图片大小不能大于20M</span>
