...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			{
				document.myform1.action="${ctx}/jsp/zjjtzsb/zjjtzsbShenheSave.action";
		...
		<div class="submitdata">
			<table width="100%">
				...
				<tr>
					...
					<th width="15%">审核结果</th>
					<td width="35%">
						<s:select id="state" name="zjjtzsb.state" list="#{'3':'整改合格','4':'整改不合格'}" theme="simple"/>
					</td>
				</tr>
				<tr>
					<th width="15%">审核备注</th>
					<td width="85%" colspan=3>
						<textarea id="remark" name="zjjtzsb.remark" style="width:100%;height:120px">${zjjtzsb.remark}</textarea>
					</td>
				</tr>
