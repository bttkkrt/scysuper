...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			{
				document.myform.action="${ctx}/jsp/aqscfk/aqscfkShenheSave.action";
		...
		<div class="submitdata">
			<table width="100%">
				...
				<tr>
					...
					<th width="15%">审核结果</th>
					<td width="35%">
						<s:select id="state" listKey="key" listValue="value"  theme="simple" list="#{'3':'审核通过','2':'审核不通过'}" name="aqscfk.state"/>
					</td>
				</tr>
				<tr>
					<th width="15%">审核备注</th>
					<td width="85%" colspan=3>
						<textarea id="remark" name="aqscfk.remark" rows="5" style="width: 80%">${aqscfk.remark}</textarea>
					</td>
				</tr>
				<tr>
