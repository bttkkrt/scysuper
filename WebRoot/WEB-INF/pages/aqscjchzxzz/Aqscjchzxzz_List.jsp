...
<head>
<title>安全生产检查和专项整治工作完成情况管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_aqscjchzxzz","添加安全生产检查和专项整治工作完成情况","${ctx}/jsp/aqscjchzxzz/aqscjchzxzzInitEdit.action?flag=add&dt="+dt.getTime(),800,400);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_aqscjchzxzz","修改安全生产检查和专项整治工作完成情况","${ctx}/jsp/aqscjchzxzz/aqscjchzxzzInitEdit.action?flag=mod&aqscjchzxzz.id="+row_Id+"&dt="+dt.getTime(),800,400);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_aqscjchzxzz","查看安全生产检查和专项整治工作完成情况","${ctx}/jsp/aqscjchzxzz/aqscjchzxzzView.action?aqscjchzxzz.id="+row_Id+"&dt="+dt.getTime(),800,400);
        ...
        function exportData()
        {
        	...
        	document.myform.action = "${ctx}/jsp/aqscjchzxzz/aqscjchzxzzExport.action";
...
"aqscjchzxzz.areaName": $("#areaName").val()
        ...
        $(function(){
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				title:'安全生产检查和专项整治工作完成情况列表',
				url:'aqscjchzxzzQuery.action',
				queryParams:{
					 "queryMonthTimeStart" :$("#queryMonthTimeStart").val(),
 "queryMonthTimeEnd" :$("#queryMonthTimeEnd").val(),
"aqscjchzxzz.areaName": $("#areaName").val()
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_aqscjchzxzz()" >查询<b></b></a>&nbsp;
