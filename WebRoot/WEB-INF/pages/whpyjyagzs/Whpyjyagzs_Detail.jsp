	...
	<form name="myform" method="post">
		<div class="submitdata">
			...
			<s:if test="role==0">
				<tr>
				<th width="15%">所在区域</th>
					<td width="35%">${whpyjyagzs.szz}</td>
					<th width="15%">企业名称</th>
					<td width="35%">${whpyjyagzs.qymc}</td>
				</tr>
						</s:if>
				<tr>
					<th width="15%">应急救援预案</th>
					<td width="35%">${whpyjyagzs.yjjyya}</td>
					<th width="15%">上传时间</th>
					<td width="35%"><fmt:formatDate type="both" value="${whpyjyagzs.createTime}" /></td>
				</tr>
				<tr>
				<th width="15%">已上传文件</th>
				<td width="85%" colspan="3"><div style="color:green;overflow:auto; height:200px;">
										  <table id="whpyjya">
