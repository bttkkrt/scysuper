...
<title>WHPYJYAGZS管理</title>
	...
	<script>
        ...
        function addNew(){
    		...
    		var xc = (aw - 400) / 2;
    		var yc = (ah - 350) / 2;
        	window.open("${ctx}/jsp/whpyjyagzs/whpyjyagzsInitEdit.action?flag=add");
        }
        function edit(row_Id){
    		...
    		var xc = (aw - 400) / 2;
    		var yc = (ah - 350) / 2;
        	window.open("${ctx}/jsp/whpyjyagzs/whpyjyagzsInitEdit.action?flag=mod&whpyjyagzs.id="+row_Id);
        }
        function view(row_Id){
    		...
    		var xc = (aw - 400) / 2;
    		var yc = (ah - 350) / 2;
        	window.open("${ctx}/jsp/whpyjyagzs/whpyjyagzsView.action?whpyjyagzs.id="+row_Id);
        }
        function close_win(){
        ...
        function search_whpyjyagzs(){
        	var queryParams = {
					"whpyjyagzs.deptId":$("#deptId").val(),
					"whpyjyagzs.qymc":$("#qymc").val(),
					"whpyjyagzs.yjjyya":$("#yjjyya").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				title:'危险化学品事故应急救援预案及备案告知书列表',
				iconCls:'icon-save',
				nowrap: false,
				striped: true,
				collapsible:true,
				url:'whpyjyagzsQuery.action',
				queryParams:{
						"whpyjyagzs.deptId":$("#deptId").val(),
					"whpyjyagzs.qymc":$("#qymc").val(),
					"whpyjyagzs.yjjyya":$("#yjjyya").val(),
...
{field:'yjjyya',title:'应急救援预案',width:fixWidth(0.2)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="whpyjyagzs.qymc" size= 35 id="qymc" value="${whpyjyagzs.qymc}" type="text"></td>
				<th width="15%">预案名称</th>
				<td width="35%"><input name="whpyjyagzs.yjjyya" size= 35 id="yjjyya" value="${whpyjyagzs.yjjyya}" type="text"></td>
			</tr>
			<tr>
			   ...
			   <th width="15%">所属街道</th>
				<td width="35%">
					...
					<select id="deptId" name="whpyjyagzs.deptId" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="whpyjyagzs.deptId" defaultText='请选择' codeName="相城地址" value="${whpyjyagzs.deptId}" /></td>
					 -->
				</s:if>
			</tr>
			<tr>
				<td colspan="4" style="text-align:center">
				<a href="###" class="easyui-linkbutton" onclick="search_whpyjyagzs()" iconCls="icon-search">查询</a>&nbsp;
