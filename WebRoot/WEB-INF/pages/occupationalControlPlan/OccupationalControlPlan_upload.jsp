...
<head>
	...
	<script>
	    ...
	    $(document).ready(function(){
	    	var data = "occupationalControlPlanSavePhoto.action?occupationalControlPlan.linkId="+"${occupationalControlPlan.linkId}";
		   	　$("#uploadify").uploadify({
	...
	　		'fileDesc': '所有文件：*.*', //如果配置了以下的'fileExt'属性，那么这个属性是必须的  
			...
			var extname = picName;
			var table = window.opener.document.getElementById('occupationalControlPlan');
