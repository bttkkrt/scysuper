			...
			<table width="100%">
				...
				<tr>
					<td style="text-align: right;font-family:仿宋_GB2312;font-size: 16.0pt">
						(${occupationalControlPlan.requiredOne})
						安职控备字(${occupationalControlPlan.requiredTwo})
						第${occupationalControlPlan.requiredThree}号
					</td>
				</tr>
				<tr>
					<td height="50px">
				...
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						${occupationalControlPlan.companyName}:
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						${occupationalControlPlan.userName}
					</td>
				</tr>
				<tr>
					<td height="20px">
				...
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						经办人：${occupationalControlPlan.contact}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系电话：${occupationalControlPlan.tel}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						报告完成日期:${occupationalControlPlan.bgwcrq}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						报告上报日期:${occupationalControlPlan.bgsbrq}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						备案日期:${occupationalControlPlan.barq}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						备案编号:${occupationalControlPlan.babh}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						下次备案日期:${occupationalControlPlan.xcbarq}
					</td>
				</tr>
				<tr>
					<td style="text-align: left;font-family:仿宋_GB2312;font-size: 16.0pt">
						档案编号:${occupationalControlPlan.dabh}
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td style="text-align: right;font-family:仿宋_GB2312;font-size: 16.0pt">
						${occupationalControlPlan.sendTime}&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td>
