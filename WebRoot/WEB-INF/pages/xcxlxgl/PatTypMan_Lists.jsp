...
<title>巡查项类型管理管理</title>
	...
	<script>
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_patTypMan","添加巡查项类型管理","${ctx}/jsp/xcxlxgl/patTypManInitEdit.action?flag=add&dt="+dt.getTime(),450,200);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_patTypMan","修改巡查项类型管理","${ctx}/jsp/xcxlxgl/patTypManInitEdit.action?flag=mod&patTypMan.id="+row_Id+"&dt="+dt.getTime(),450,200);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_patTypMan","查看巡查项类型管理","${ctx}/jsp/xcxlxgl/patTypManView.action?patTypMan.id="+row_Id+"&dt="+dt.getTime(),400,200);
        	
        }
         function xcxgl(row_Id){
            var id="newWindow";
    		var text = "巡查项管理";
    		var url ="/jsp/xcxgl/patManLists.action?patMan.patrolType="+row_Id;
