		  ...
		  <!-- START -->
                  <div class="panel bg-primary radius">
                     <div class="row row-table">
                        ...
                        <div class="col-sm-8 mt-20 mr-20" style="cursor: pointer;">
                           <a href="javascript:void(0)" onclick="clickModule(this,1)" _href="${ctx}/jsp/information/contentInformationsList.action" data-title="公告">
		  ...
		  <!-- START -->
                  <div class="panel bg-warning radius">
                     <div class="row row-table">
                        ...
                        <div class="col-sm-8 mt-20 mr-20" style="cursor: pointer;">
                           <a href="javascript:void(0)" onclick="clickModule(this,1)" _href="${ctx}/jsp/company/companyList.action?type=0" data-title="基本信息">
	                           <h2>${tempCompany }</h2>
	                           <p>基本信息</p>
                           </a>
                        </div>
                        ...
                        <div class="col-sm-8 mt-20 mr-20" style="cursor: pointer;">
                           <a href="javascript:void(0)" onclick="clickModule(this,1)" _href="${ctx}/jsp/distributeItem/distributeItemList.action" data-title="安全检查">
                       ...
                       <c:if test="${not empty companyTotal}">
                        <div class="col-sm-8 mt-20 mr-20" style="cursor: pointer;">
                           <a href="javascript:void(0)" onclick="clickModule(this,1)" _href="${ctx}/jsp/company/companyList.action" data-title="企业管理">
	                           <h2>${companyTotal }</h2>
	                           <p>企业</p>
	                       </a>
                        </div>
		  ...
		  <!-- START -->
                  <div class="panel bg-info radius">
                     <div class="row row-table">
                        ...
                        <div class="col-sm-8 mt-20 mr-20" style="cursor: pointer;">
                           <a href="javascript:void(0)" onclick="clickModule(this,1)" _href="${ctx}/jsp/zcyhsb/jshxZcyhsbList.action" data-title="企业自查隐患上报">
                           <h2>${zcyhsbTotals}</h2>
                           <p>企业自查隐患</p>
                           </a>
                        </div>
				...
				<ul   class="Huifold" id="Huifold2">
  					<li class="item text-l">
   						 ...
   						 <c:if test="${not empty companyDSH && companyDSH>0}">
   						 	<p><%=shijianindex%>. <a href="javascript:void(0)" onclick="clickModule(this,1)" data-title="待审核企业" _href="${ctx}/jsp/company/companyList.action?isShenhe=0">还有<span style="color:red">${companyDSH}</span>个待审核企业</a></p>
   						<% ++shijianindex;%> </c:if>
   						 <c:if test="${not empty zcyhsbDzg && zcyhsbDzg>0}">
   						 	<p><%=shijianindex%>. <a  href="javascript:void(0)" onclick="clickModule(this,1)" data-title="待整改企业自查隐患" _href="${ctx}/jsp/zcyhsb/jshxZcyhsbList.action?mqzt=1&zgwcsj=shijian&type=2)">还有<span style="color:red">${zcyhsbDzg}</span>个待整改企业自查隐患</a></p>
   						<% ++shijianindex;%> </c:if>
   						  <c:if test="${not empty yibanDzg && yibanDzg>0}"> 
   						 	<p><%=shijianindex%>. <a   href="javascript:void(0)" onclick="clickModule(this,1)" data-title="待整改一般隐患" _href="${ctx}/jsp/commonTrouble/commoTroubleList.action?shzt=0&type=3)">还有<span style="color:red">${yibanDzg}</span>个待整改一般隐患</a></p>
   						 <% ++shijianindex;%></c:if>
   						  <c:if test="${not empty yibanDsh && yibanDsh>0}"> 
   						 	<p><%=shijianindex%>. <a  href="javascript:void(0)" onclick="clickModule(this,1)" data-title="待审核一般隐患" _href="${ctx}/jsp/commonTrouble/commoTroubleList.action?shzt=3&type=2)">还有<span style="color:red">${yibanDsh}</span>个待审核一般隐患</a></p>
   						 <% ++shijianindex;%></c:if>
   						  <c:if test="${not empty zhongdaDzg && zhongdaDzg>0}"> 
   						 	<p><%=shijianindex%>. <a   href="javascript:void(0)" onclick="clickModule(this,1)" data-title="待整改重大隐患" _href="${ctx}/jsp/majorTrouble/majorTroubleList.action?shzt=0&type=3)">还有<span style="color:red">${zhongdaDzg}</span>个待整改重大隐患</a></p>
   						 <% ++shijianindex;%></c:if>
   						  <c:if test="${not empty zhongdaDsh && zhongdaDsh>0}"> 
   						 	<p><%=shijianindex%>. <a   href="javascript:void(0)" onclick="clickModule(this,1)" data-title="待审核重大隐患" _href="${ctx}/jsp/majorTrouble/majorTroubleList.action?shzt=3&type=2)">还有<span style="color:red">${zhongdaDsh}</span>个待审核重大隐患</a></p>
   						 <% ++shijianindex;%></c:if>
   						 <%if(shijianindex==1){
   						%>
   						...
   						<%}else{
   						%>
   						 	<p class="text-r"><a href=""><icon class="Hui-iconfont Hui-iconfont-huanyipi"></icon></a></p>
   						 	<%} 
   						%>
   						 </div>
 					 </li>
