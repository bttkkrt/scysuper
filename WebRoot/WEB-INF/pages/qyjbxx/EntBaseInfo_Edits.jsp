...
<body validform="true" style="overflow: auto;">
   <div class="box_01 boxBmargin12 submitdata" style="overflow-y: auto;overflow-x: auto;padding: 0;top: 0px;left: 0px;right: 0px;bottom: 0;position: absolute; ">
	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="entBaseInfoSaves.action">
		<s:token />
		...
		<input type="hidden" name="entBaseInfo.id" value="${entBaseInfo.id}">
			<table width="100%" border="0">
				<tr>
					<th width="15%">企业名称</th>
					<td width="35%">
						<input name="entBaseInfo.enterpriseName"  value="${entBaseInfo.enterpriseName}" type="text" >
					</td>
					<th width="15%">工商注册号</th>
					<td width="35%">${entBaseInfo.registrationNumber}</td>
				</tr>
				<tr>
					<th width="15%">统一社会信用编码</th>
					<td width="35%">${entBaseInfo.xydm}</td>
				...
				<tr>
					<th width="15%">所属网格</th>
					<td width="35%">
						<cus:SelectOneTag property="entBaseInfo.grid" defaultText='请选择' codeSql="select t.row_id,t.GRID_NAME from COM_GRI_MAN t where t.delflag = 0" value="${entBaseInfo.grid}" datatype="*1-127" errormsg='所属网格必须是1到127位字符！' nullmsg='所属网格不能为空！' sucmsg='所属网格填写正确！'  maxlength="127" onchange="deptChange();" style="width:50%"/><font style='color:red'>*</font>
					</td>
					<th width="15%">网格管理人员</th>
					<td width="35%"><span id="personTd"><cus:SelectOneTag property="entBaseInfo.gridManageId" defaultText='请选择' codeSql="select u.row_id AS ID,u.DISPLAY_NAME from USERS u where  u.DEL_FLAG=0 and  u.DEPT_CODE='${entBaseInfo.gridManageteamCode}'" value="${entBaseInfo.gridManageId}" style="width:50%"/></span></td>
				</tr>
				<tr>
					<th width="15%">经营范围</th>
				...
				<tr>
					<td colspan="4" height="100px" style="text-align:center">
						<a href="#" class="btn_01" onclick="closeLayer();" type="submit" >提交<b></b></a>&nbsp;
