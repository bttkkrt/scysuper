        ...
        function save()
        {
			...
			checkInfo('enterpriseScope'))
			{
				$.ajax({
					...
					type: "POST",
					dataType: 'json',
					url:"entBaseInfoSaveRegister.action", //把表单数据发送到entBaseInfoSaveRegister.action
            ...
            <div class="steps_01">
                <table width="80%"  border="0" cellpadding="0" cellspacing="0">
                	<tr>
						...
						<td>
							<input id="enterpriseCode" name="entBaseInfo.enterpriseCode" value="${entBaseInfo.enterpriseCode}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('enterpriseCode');" onblur="checkInfo('enterpriseCode');">
							...
							<div class="tips_02" id="enterpriseCodeError" style="display:none"><p>组织机构代码填写有误</p></div>
                    ...
                    <tr>
                        <th></th>
                        <td><a href="#" class="btn_next" onclick="chanageDiv('2')">下一步</a></td>
                    </tr>                                        
                </table>
            </div>            
        </div>
...
<div id="tab2" class="af_add" style="display:none">
    <div class="padd20">
    <div class="addcontent">
        <div class="steps steps-3">
            <ul>
            ...
            <div class="steps_01">
                <table width="80%"  border="0" cellpadding="0" cellspacing="0">
                	<tr>
						...
						<td>
							<input id="enterpriseName" name="entBaseInfo.enterpriseName" value="${entBaseInfo.enterpriseName}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('enterpriseName');" onblur="checkInfo('enterpriseName');">
							<div class="tips_01" id="enterpriseNameTitle" style="display:none"><p>请填写企业名称</p></div>
							<div class="tips_02" id="enterpriseNameExit" style="display:none"><p>该企业名称已被注册</p></div>
                    ...
                    <tr>
						...
						<td>
							...
							<div class="tips_01" id="enterpriseAddressTitle" style="display:none"><p>请填写地址</p></div>
							<div class="tips_02" id="enterpriseAddressNull" style="display:none"><p>地址不能为空</p></div>
                        	<div class="tips_03" id="enterpriseAddressSucc" style="display:none"><p>地址输入正确</p></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<cus:hxcheckbox property="entBaseInfo.enterpriseType" codeName="企业分类" value="${entBaseInfo.enterpriseType}" maxlength="127" onclick="showTitle('enterpriseType');checkInfo('enterpriseType');"/>
					...
					<tr>
						...
						<td>
							...
							<div class="tips_01" id="enterpriseNationnalityTitle" style="display:none"><p>请选择投资方国籍</p></div>
					...
					<tr>
						...
						<td>
							<input id="enterpriseRegisterMoney" name="entBaseInfo.enterpriseRegisterMoney" value="${entBaseInfo.enterpriseRegisterMoney}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('enterpriseRegisterMoney');" onblur="checkInfo('enterpriseRegisterMoney');" onKeyUp="clearNoNum(event,this)">
					...
					<tr>
						...
						<td>
							<input id="enterpriseInvestMoney" name="entBaseInfo.enterpriseInvestMoney" value="${entBaseInfo.enterpriseInvestMoney}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('enterpriseInvestMoney');" onblur="checkInfo('enterpriseInvestMoney');" onKeyUp="clearNoNum(event,this)">
					...
					<tr>
						...
						<td>
							<input id="enterpriseFixedassetMoney" name="entBaseInfo.enterpriseFixedassetMoney" value="${entBaseInfo.enterpriseFixedassetMoney}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('enterpriseFixedassetMoney');" onblur="checkInfo('enterpriseFixedassetMoney');" onKeyUp="clearNoNum(event,this)">
					...
					<tr>
						...
						<td>
							<cus:SelectOneTag property="entBaseInfo.enterprisWorkshopOwn" defaultText='请选择' codeName="厂房归属" value="${entBaseInfo.enterprisWorkshopOwn}" style="width:300px" maxlength="127" onfocus="showTitle('enterprisWorkshopOwn');" onblur="checkInfo('enterprisWorkshopOwn');"/>
                    ...
                    <tr>
                        ...
                        <td>
                        	<table>
                        		<tr>
                        			<td><a href="#" class="btn_next" onclick="chanageDiv('1')">上一步</a></td>
...
<div id="tab3" class="af_add" style="display:none">
    <div class="padd20">
    <div class="addcontent">
        <div class="steps steps-3">
            <ul>
