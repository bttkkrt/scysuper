                ...
                <table width="80%"  border="0" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
					...
					<tr>
						...
						<td>
							<cus:SelectOneTag property="entBaseInfo.enterpriseCategory" defaultText='请选择' codeName="行业类别" value="${entBaseInfo.enterpriseCategory}" style="width:150px" maxlength="127" onfocus="showTitle('enterpriseCategory');"  onblur="checkInfo('enterpriseCategory');" onchange="getHyxl(this.value)"/>
