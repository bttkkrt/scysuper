	 ...
	 function save()
        {
			...
			checkInfo('enterpriseScope'))
			{
				...
				{
					var a=document.getElementById("cqtp").innerHTML;
					if(a.indexOf('下载')<0){
						alert("请上传厂区图片！");
						return false;
					}
		...
		function checkInfo(obj)
		{
			...
			if(obj == 'enterpriseCategory')
			{
				ss = document.getElementById("jjlx").value;
			}
			if(ss == null || ss == "")
			{
				document.getElementById(obj+'Null').style.display = "";
            ...
            <div class="steps_01">
                <table width="80%"  border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<th>统一社会信用编码：</th>
						<td>
							<input id="xydm" name="entBaseInfo.xydm" value="${entBaseInfo.xydm}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('xydm');">
							<div class="tips_01" id="xydmTitle" style="display:none"><p>请填写工商注册号</p></div>
						</td>
					</tr>
                    <tr>
					...
					<tr>
						<th><span class="red">*</span>企业注册类型：</th>
						<td>
							<cus:SelectOneTag property="entBaseInfo.qyzclx" defaultText='请选择' codeName="企业注册类型" value="${entBaseInfo.qyzclx}" style="width:300px" maxlength="127" onfocus="showTitle('qyzclx');" onblur="checkInfo('qyzclx');"/>
							<div class="tips_01" id="qyzclxTitle" style="display:none"><p>请选择企业注册类型</p></div>
							<div class="tips_02" id="qyzclxNull" style="display:none"><p>企业注册类型不能为空</p></div>
                        	<div class="tips_03" id="qyzclxSucc" style="display:none"><p>企业注册类型输入正确</p></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<cus:SelectOneTag property="entBaseInfo.enterpriseCategory" defaultText='请选择' codeName="行业类别" value="${entBaseInfo.enterpriseCategory}" style="width:150px" maxlength="127" onfocus="showTitle('enterpriseCategory');" onchange="getHyxl(this.value)"/>
							<s:select theme="simple" cssStyle="width:25%;" id="jjlx" name="entBaseInfo.jjlx" list="%{hylist}" listKey="id" listValue="name" style="width:150px" onblur="checkInfo('enterpriseCategory');"></s:select>
					...
					<tr>
						...
						<td>
							<input id="enterpriseLegalName" name="entBaseInfo.enterpriseLegalName" value="${entBaseInfo.enterpriseLegalName}" type="text" style="width:300px" maxlength="127" onfocus="showTitle('enterpriseLegalName');" onblur="checkInfo('enterpriseLegalName');">
					...
					<tr>
						<th><span class="red">*</span>法人代表代表职务：</th>
						<td>
