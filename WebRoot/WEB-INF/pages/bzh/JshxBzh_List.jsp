...
<title>JSHX_BZH管理</title>
	...
	<script>
         var flag = "${flag}";
        function addNew(){
        	window.open("${ctx}/jsp/bzh/jshxBzhInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/bzh/jshxBzhInitEdit.action?flag=mod&jshxBzh.id="+row_Id);
        }
        function view(row_Id){
        	createSimpleWindow("win_agencyInfo","","${ctx}/jsp/bzh/jshxBzhView.action?jshxBzh.id="+row_Id,900,600);
		...
		<table width="100%">
			...
			<tr>
				...
				<td width="35%">
					...
					<select id="szzid" name="jshxBzh.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="jshxBzh.szzid" defaultText='请选择' codeName="相城地址" value="${jshxBzh.szzid}" /></td>
					 -->
				<th width="15%">企业名称</th>
