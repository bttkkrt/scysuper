...
<body validform="true" style="overflow: auto;">
   <div class="box_01 boxBmargin12 submitdata" style="overflow-y: auto;overflow-x: hidden;padding: 0;top: 0px;left: 0px;right: 0px;bottom: 0;position: absolute; ">
	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="cheManLicCheckSave.action">
		<s:token />
			<input type="hidden" name="flag" value="${flag}">
		<input type="hidden" name="cheManLic.id" value="${cheManLic.id}">
		<input type="hidden" name="checkRecord.infoId" value="${cheManLic.id}">
			<table width="100%">
				<tr>
					<th width="15%">所在区域</th>
				...
				<tr>
					...
					<a href="#" class="btn_01" type="submit" >提交<b></b></a>&nbsp;
					    <a href="#" class="btn_01" onclick="parent.close_win('win_cheManLic');">关闭<b></b></a>
					</td>
				</tr>
			</table>
		</div></div></div>
