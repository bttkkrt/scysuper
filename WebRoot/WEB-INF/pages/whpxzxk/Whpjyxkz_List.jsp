...
$(function()
{
        ...
        kkpager.init({
            ...
            //链接前部
            hrefFormer: '${ctx}/wzxx/whpjyxkzList',
            //链接尾部
            hrefLatter: '.action',
            getLink: function (n) {
...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">危化品经营许可证查询</a></p></div>
    <div class="news_list">
    <ul>
    	<c:forEach var="whpjyxkz" items="${whpjyxkzList}">
    	  <li><a href="${ctx}/wzxx/whpjyxkzContent.action?cheManLic.id=${whpjyxkz.id}">${whpjyxkz.companyName}</a><fmt:formatDate type="date" value="${whpjyxkz.createTime}" pattern="yyyy-MM-dd"/></li>
