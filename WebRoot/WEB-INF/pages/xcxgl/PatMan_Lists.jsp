...
<title>巡查项管理管理</title>
	...
	<script>
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_patMan","添加巡查项管理","${ctx}/jsp/xcxgl/patManInitEdit.action?flag=add&dt="+dt.getTime()+"&patMan.patrolType=${patMan.patrolType}",400,200);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_patMan","修改巡查项管理","${ctx}/jsp/xcxgl/patManInitEdit.action?flag=mod&patMan.id="+row_Id+"&dt="+dt.getTime()+"&patMan.patrolType=${patMan.patrolType}",400,200);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_patMan","查看巡查项管理","${ctx}/jsp/xcxgl/patManView.action?patMan.id="+row_Id+"&dt="+dt.getTime(),400,200);
...
"patMan.patrolType": "${patMan.patrolType}"
        ...
        $(function(){
        	...
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				...
				columns:[[
				          {field:'patrolName',title:'巡查项名称',width:100},
