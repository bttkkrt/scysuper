...
<html>
<head>
<title>岗位安全操作规程管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        var flag = "${flag}";
        function addNew(){
        	window.open("${ctx}/jsp/gwaq/jshxGwaqInitEdit.action?flag=add");
        }
        function edit(row_Id){
            window.open("${ctx}/jsp/gwaq/jshxGwaqInitEdit.action?flag=mod&jshxGwaq.id="+row_Id);
        }
        function view(row_Id){
            window.open("${ctx}/jsp/gwaq/jshxGwaqView.action?jshxGwaq.id="+row_Id);
        }
        function close_win(){
        ...
        function search_jshxGwaq(){
        	var queryParams = {
        	"jshxGwaq.szzid": $("#szzid").val(),
				"jshxGwaq.gwmc": $("#gwmc").val(),
"jshxGwaq.qymc": $("#qymc").val()
			};        	
...
{field:'gwmc',title:'岗位名称',width:fixWidth(0.2)},
{field:'gwygs',title:'岗位员工数',width:fixWidth(0.2)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			<tr>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="jshxGwaq.qymc" id="qymc" value="${jshxGwaq.qymc}" type="text"></td>
				<th width="15%">岗位名称</th>
				<td width="35%"><input name="jshxGwaq.gwmc" id="gwmc" value="${jshxGwaq.gwmc}" type="text"></td>
			</tr>
			<s:if test="flag==3">
			  	<tr>
				 	<th width="15%">所属地区</th>
					...
					<select id="szzid" name="jshxGwaq.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="jshxGwaq.szzid" defaultText='请选择' codeName="相城地址" value="${jshxGwaq.szzid}" /></td>
					 -->
				</tr>
			</s:if>
			<tr>
			...
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_jshxGwaq()" iconCls="icon-search">查询</a>&nbsp;
