...
<head>
	...
	<script>
		 ...
		 $(document).ready(function(){
			    ...
			    var infoType = window.opener.document.getElementById('sendinfoType').value;
                var u=userNames.substring(0,userNames.length-1); 
                var ids=userIds.split(",");
                var names=u.split(",");
			    var t=new Date().getTime();
			    $.post('${ctx}/jsp/fwgl/getDepartUser.action',{'t':t,'sendInformation.sendinfoType':infoType,'userIds':userIds},function(nodes){
