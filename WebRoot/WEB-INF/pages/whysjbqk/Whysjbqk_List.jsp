...
<html>
<head>
<title>危害因素基本情况管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	window.open("${ctx}/jsp/whysjbqk/whysjbqkInitEdit.action?flag=add");
        }
        function edit(row_Id){
            window.open("${ctx}/jsp/whysjbqk/whysjbqkInitEdit.action?flag=mod&whysjbqk.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/whysjbqk/whysjbqkView.action?whysjbqk.id="+row_Id);
        }
        function close_win(){
        ...
        function search_whysjbqk(){
        	var queryParams = {
				
        	    "whysjbqk.szzid": $("#szzid").val(),
				"whysjbqk.qymc": $("#qymc").val()
			};        	
		...
		<table width="100%">
			<tr>
				...
				<td width="35%">
					...
					<select id="szzid" name="whysjbqk.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="whysjbqk.szzid" defaultText='请选择' codeName="相城地址" value="${whysjbqk.szzid}" /></td>
					 -->
				<th width="15%">企业名称</th>
				<td width="35%"><input name="whysjbqk.qymc" id="qymc" value="${whysjbqk.qymc}" type="text"></td>
			</tr>
			<tr>
				<td colspan="4" align="center" style="text-align:center;">
				<a href="###" class="easyui-linkbutton" onclick="search_whysjbqk()" iconCls="icon-search">查询</a>&nbsp;
