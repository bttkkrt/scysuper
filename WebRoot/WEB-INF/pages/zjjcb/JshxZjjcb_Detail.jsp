	...
	<form name="myform" method="post">
		<div class="submitdata">
			<table width="100%">
				<tr>
					<th width="15%">专家姓名</th>
					<td width="35%">${jshxZjjcb.zjName}</td>
					<th width="15%">职称</th>
					<td width="35%">${jshxZjjcb.zc}</td>
				</tr>
				<tr>
					<th width="15%">从事专业</th>
					<td width="35%">${jshxZjjcb.zy}</td>
					<th width="15%">专家人数</th>
					<td width="35%">${jshxZjjcb.zjsl}</td>
				</tr>
				<tr>
					<th width="15%">隐患数</th>
					<td width="35%">${jshxZjjcb.yhs}</td>
					<th width="15%">其中重大隐患数</th>
					<td width="35%">${jshxZjjcb.zdyhs}</td>
				</tr>
				<tr>
					<th width="15%">隐患整改数</th>
					<td width="35%">${jshxZjjcb.yhzgs}</td>
					<th width="15%">其中重大隐患整改数</th>
					<td width="35%">${jshxZjjcb.zdyhzgs}</td>
				</tr>
				<tr>
					<th width="15%">整改费用（万元）</th>
					<td width="35%">${jshxZjjcb.zgfy}</td>
					<th width="15%">检查日期</th>
					<td width="35%"><fmt:formatDate type='date' value='${jshxZjjcb.jcrq}' /></td>
				</tr>
				<tr>
					<th width="15%">本次检查存在隐患及问题</th>
					<td colspan="3"><textarea readOnly name="jshxZjjcb.question" style="width:100%;height:120px">${jshxZjjcb.question}</textarea></td>
				</tr>
				<tr>
					<th width="15%">整改建议</th>
					<td colspan="3"><textarea readOnly name="jshxZjjcb.advice" style="width:100%;height:120px">${jshxZjjcb.advice}</textarea></td>
				</tr>
				<tr>
					<th width="15%">上次隐患整改情况</th>
					<td colspan="3"><textarea readOnly name="jshxZjjcb.zgqk" style="width:100%;height:120px">${jshxZjjcb.zgqk}</textarea></td>
				</tr>
				<tr>
					<th width="20%">扫描件文件</th>
