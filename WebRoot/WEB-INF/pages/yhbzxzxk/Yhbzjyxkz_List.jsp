...
$(function()
{
        ...
        kkpager.init({
            ...
            //链接前部
            hrefFormer: '${ctx}/wzxx/yhbzjyxkzList',
            //链接尾部
            hrefLatter: '.action',
            getLink: function (n) {
...
<!--/nav end-->	
<div class="main">
	<div class="location"><p>您现在的位置：<a href="${ctx}/wzxx/index.action">首页</a>&gt;<a href="#">烟花爆竹经营许可证查询</a></p></div>
    <div class="news_list">
    <ul>
    	<c:forEach var="yhbzjyxkz" items="${yhbzjyxkzList}">
    	  <li><a href="${ctx}/wzxx/yhbzjyxkzContent.action?firLic.id=${yhbzjyxkz.id}">${yhbzjyxkz.companyName}</a><fmt:formatDate type="date" value="${yhbzjyxkz.createTime}" pattern="yyyy-MM-dd"/></li>
