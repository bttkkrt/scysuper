...
<title>标准化评分管理</title>
	...
	<script>
        ...
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_companyScore","添加标准化评分","${ctx}/jsp/companyScore/companyScoreTime.action?dt="+dt.getTime(),1000,550);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_companyScore","修改标准化评分","${ctx}/jsp/companyScore/companyScoreInitEdit.action?flag=mod&companyScore.id="+row_Id+"&dt="+dt.getTime(),1000,550);
        	
        }
        
        function deal(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_companyScore","审核标准化评分","${ctx}/jsp/companyScore/companyScoreInitEdit.action?flag=deal&companyScore.id="+row_Id+"&dt="+dt.getTime(),1000,550);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_companyScore","查看标准化评分","${ctx}/jsp/companyScore/companyScoreView.action?companyScore.id="+row_Id+"&dt="+dt.getTime(),1000,550);
        ...
        function search_companyScore(){
        	var queryParams = {
					...
					"companyScore.areaId": $("#areaId").val(),
					"companyScore.companyName": $("#companyName").val()
			};        	
    ...
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<s:if test='roleName!="0"'>
				...
				<th width="15%">所在区域</th>
				<td width="35%"><cus:SelectOneTag style="width: 50%"  property="companyScore.areaId" defaultText='请选择' codeName="企业属地" value="${companyScore.areaId}" /></td>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="companyScore.companyName" style="width: 50%"  id="companyName" value="${companyScore.companyName}" type="text" maxlength="127"></td>
			</tr>
			</s:if>
				<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_companyScore()" >查询<b></b></a>&nbsp;
