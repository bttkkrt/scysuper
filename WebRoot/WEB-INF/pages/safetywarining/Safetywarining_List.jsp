...
<title>SAFETYWARINING管理</title>
	...
	<script>
        ...
        function addNew(){
    		...
    		var xc = (aw - 400) / 2;
    		var yc = (ah - 350) / 2;
        	window.open("${ctx}/jsp/safetywarining/safetywariningInitEdit.action?flag=add");
        }
        function edit(row_Id){
    		...
    		var xc = (aw - 400) / 2;
    		var yc = (ah - 350) / 2;
        	window.open("${ctx}/jsp/safetywarining/safetywariningInitEdit.action?flag=mod&safetywarining.id="+row_Id);
        }
        function view(row_Id){
    		...
    		var xc = (aw - 400) / 2;
    		var yc = (ah - 350) / 2;
        	window.open("${ctx}/jsp/safetywarining/safetywariningView.action?safetywarining.id="+row_Id);
        }
        function close_win(){
        ...
        function search_safetywarining(){
        	var queryParams = {
					"safetywarining.wxmc": $("#wxmc").val(),
					"safetywarining.qymc": $("#qymc").val(),
"safetywarining.deptId": $("#deptId").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				...
				striped: true,
				collapsible:true,
				url:'safetywariningQuery.action',
				queryParams:{
				"safetywarining.wxmc": $("#wxmc").val(),
					"safetywarining.qymc": $("#qymc").val(),
"safetywarining.deptId": $("#deptId").val(),
			 ...
			 "createTimeEnd" :$("#createTimeEnd").val()
				...
				columns:[[
{field:'szz',title:'所在镇',width:fixWidth(0.2)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			<tr>
			    <th width="15%">企业名称</th>
				<td width="35%"><input name="safetywarining.qymc" id="qymc" value="${safetywarining.qymc}" type="text"></td>
			...
			<s:if test="visable==1">
				<tr>
					...
					<select id="deptId" name="safetywarining.deptId" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="safetywarining.deptId" defaultText='请选择' codeName="相城地址" value="${safetywarining.deptId}" /></td>
					 -->
				</tr>  	
			</s:if>
			<tr>
			...
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_safetywarining()" iconCls="icon-search">查询</a>&nbsp;
