			...
			<table width="100%">
				...
				<tr>
					...
					<td width="35%">
						...
						<s:elseif test="gpdb.state == 1">
							已整改待审核
						</s:elseif>
						<s:elseif test="gpdb.state == 2">
							审核不通过
						</s:elseif>
						<s:else>
							审核通过
				...
				<tr>
					<th width="15%">备注</th>
					<td width="85%" colspan=3>
						<textarea id="remark" disabled name="gpdb.remark" rows="5" style="width: 80%">${gpdb.remark}</textarea>
					</td>
				</tr>
				<tr>
				</tr>
