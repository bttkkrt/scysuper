...
<title>危险化学品重大危险源备案管理</title>
	...
	<script>
        var flag = "${flag}";
        function addNew(){
        	window.open("${ctx}/jsp/zdwxyjbtz/zdwxyjbtzInitEdit.action?flag=add");
        }
        function edit(row_Id){
        	window.open("${ctx}/jsp/zdwxyjbtz/zdwxyjbtzInitEdit.action?flag=mod&zdwxyjbtz.id="+row_Id);
        }
        function view(row_Id){
        	window.open("${ctx}/jsp/zdwxyjbtz/zdwxyjbtzView.action?zdwxyjbtz.id="+row_Id);
        }
        ...
        function search_zdwxyjbtz(){
        	var queryParams = {
        	"zdwxyjbtz.szzid": $("#szzid").val(),
				"zdwxyjbtz.qymc": $("#qymc").val(),
"zdwxyjbtz.zdwxymc": $("#zdwxymc").val(),
 "queryZdwxytysjStart" :$("#queryZdwxytysjStart").val(),
 "queryZdwxytysjEnd" :$("#queryZdwxytysjEnd").val(),
        ...
        $(function(){
			...
			$('#pagination').datagrid({
				title:'危险化学品重大危险源备案信息列表',
				iconCls:'icon-save',
				nowrap: false,
				striped: true,
				collapsible:true,
				url:'zdwxyjbtzQuery.action',
				queryParams:{
				"zdwxyjbtz.szzid": $("#szzid").val(),
					"zdwxyjbtz.qymc": $("#qymc").val(),
"zdwxyjbtz.zdwxymc": $("#zdwxymc").val(),
	...
	<div class="submitdata">
		<table width="100%">
			...
			<tr>
				...
				<td width="35%"><input name="zdwxyjbtz.qymc" id="qymc" value="${zdwxyjbtz.qymc}" type="text"></td>
			...
			<s:if test="flag==3">
				<tr>
					...
					<select id="szzid" name="zdwxyjbtz.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="zdwxyjbtz.szzid" defaultText='请选择' codeName="相城地址" value="${zdwxyjbtz.szzid}" /></td>
					 -->
				</tr>
			</s:if>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_zdwxyjbtz()" iconCls="icon-search">查询</a>&nbsp;
