    ...
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<s:if test='roleName!="0"'>
				...
				<th width="15%">所在区域</th>
				<td width="35%"><cus:SelectOneTag style="width:50%" property="emeFac.areaId" defaultText='请选择' codeName="企业属地" value="${emeFac.areaId}" /></td>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="emeFac.companyName" style="width:50%" id="companyName" value="${emeFac.companyName}" type="text" maxlength="127"></td>
			</tr>
			</s:if>
			<tr>
			    <th width="15%">物资名称</th>
				...
				<th width="15%">物资级别</th>
				<td width="35%"><cus:SelectOneTag property="emeFac.facilityLevel" style="width:50%" defaultText='请选择' codeName="应急物资级别" value="${emeFac.facilityLevel}" /></td>
				</tr>
				<tr>
