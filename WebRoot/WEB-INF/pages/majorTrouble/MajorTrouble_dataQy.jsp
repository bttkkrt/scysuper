	...
	<script>
        $(function(){
			$('#pagination').datagrid({
				...
				striped: true,
				collapsible:true,
				url:'majorTroubleDataQyQuery.action',
				queryParams:{
...
{field:'yhs',title:'隐患数',width:fixWidth(0.15)},
{field:'zgs',title:'整改数',width:fixWidth(0.15)},
{field:'zgl',title:'整改率',width:fixWidth(0.15)},
{field:'zgzj',title:'整改资金',width:fixWidth(0.15)}
				        ]],
				pagination:true,
