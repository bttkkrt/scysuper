...
<head>
<title>高危行业安全生产强制责任保险试点工作管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_gwhy","添加高危行业安全生产强制责任保险试点工作","${ctx}/jsp/gwhy/gwhyInitEdit.action?flag=add&dt="+dt.getTime(),700,400);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_gwhy","修改高危行业安全生产强制责任保险试点工作","${ctx}/jsp/gwhy/gwhyInitEdit.action?flag=mod&gwhy.id="+row_Id+"&dt="+dt.getTime(),700,400);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_gwhy","查看高危行业安全生产强制责任保险试点工作","${ctx}/jsp/gwhy/gwhyView.action?gwhy.id="+row_Id+"&dt="+dt.getTime(),700,400);
         ...
         function exportData()
        {
            ...
            if(queryMonthTimeStart == ""){
               ...
               document.myform.action = "${ctx}/jsp/gwhy/gwhyExport.action";
...
"gwhy.areaName": $("#areaName").val()
        ...
        $(function(){
        	$('#pagination').datagrid($.extend(window.dg_cm_pp,{
				title:'高危行业安全生产强制责任保险试点工作列表',
				url:'gwhyQuery.action',
				queryParams:{
					 "queryMonthTimeStart" :$("#queryMonthTimeStart").val(),
 "queryMonthTimeEnd" :$("#queryMonthTimeEnd").val(),
"gwhy.areaName": $("#areaName").val()
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_gwhy()" >查询<b></b></a>&nbsp;
