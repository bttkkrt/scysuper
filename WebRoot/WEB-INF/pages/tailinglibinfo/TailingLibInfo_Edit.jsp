...
<%@include file="/WEB-INF/template/content_title.jsp"%>
	<form name="myform1" method="post" enctype="multipart/form-data">
		...
		<input name="tailingLibInfo.state" value="${tailingLibInfo.state}" type="hidden" >
		<input name="tailingLibInfo.shbs" value="${tailingLibInfo.shbs}" type="hidden" >
		
		
		<input name="tailingLibInfo.ifzsqy" value="${tailingLibInfo.ifzsqy}" type="hidden" >
		<input name="tailingLibInfo.zsqytype" value="${tailingLibInfo.zsqytype}" type="hidden" >
		<input name="tailingLibInfo.dutyFlag" value="${tailingLibInfo.dutyFlag}" type="hidden" >
