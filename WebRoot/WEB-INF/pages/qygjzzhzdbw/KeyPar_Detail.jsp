	...
	<form name="myform" method="post">
		...
		<div class="inner6px">
			...
			<table width="100%">
				<tr>
					<th width="15%">所在区域</th>
					<td width="35%" >${keyPar.areaName}</td>
					<th width="15%">企业名称</th>
					<td width="35%" >${keyPar.companyName}</td>
				</tr>
				<tr>
					<th width="15%">关键装置重点部位名称</th>
					<td width="35%" >${keyPar.keyPartName}</td>
				
					<th width="15%">主要危险因素</th>
					<td width="35%" >${keyPar.majorRiskFactors}</td>
				</tr>
				<tr>
					<th width="15%">责任人</th>
					<td width="35%" >${keyPar.responsiblePerson}</td>
					<th width="15%">岗位员工数量</th>
					<td width="35%" >${keyPar.postEmployeeNumber}</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4" height="100px" style="text-align:center">
					    <a href="#" class="btn_01" onclick="parent.close_win('win_keyPar');">关闭<b></b></a>
					</td>
				</tr>
			</table>
		</div></div></div>
