...
<html>
<head>
<title>JSHX_GWZNB管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
         var flag = "${flag}";
        function addNew(){
        	window.open("${ctx}/jsp/gwznb/jshxGwznbInitEdit.action?flag=add");
        }
        function edit(row_Id){
            window.open("${ctx}/jsp/gwznb/jshxGwznbInitEdit.action?flag=mod&jshxGwznb.id="+row_Id);
        }
        function view(row_Id){
            window.open("${ctx}/jsp/gwznb/jshxGwznbView.action?jshxGwznb.id="+row_Id);
        }
        function close_win(){
        ...
        function search_jshxGwznb(){
        	var queryParams = {
        		"jshxGwznb.szzid": $("#szzid").val(),
				"jshxGwznb.qymc": $("#qymc").val(),
			...
			$('#pagination').datagrid({
				...
				columns:[[
						 ...
						 {field:'qymc',title:'企业名称',width:fixWidth(0.2)},
						  {field:'gw',title:'岗位',width:fixWidth(0.2)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			<tr>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="jshxGwznb.qymc" id="qymc" value="${jshxGwznb.qymc}" type="text"></td>
			...
			<s:if test="flag==3">
			  	<tr>
					...
					<select id="szzid" name="jshxGwznb.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="jshxGwznb.szzid" defaultText='请选择' codeName="相城地址" value="${jshxGwznb.szzid}" /></td>
					 -->
				</tr>
			</s:if>
			<tr>
				...
				<a href="###" class="easyui-linkbutton" onclick="search_jshxGwznb()" iconCls="icon-search">查询</a>&nbsp;
