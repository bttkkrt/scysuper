	...
	<form name="myform" method="post">
		<div class="submitdata">
			<table width="100%">
				<tr>
					<th width="15%">所在街道</th>
					<td width="35%">${zycsjcbg.szz}</td>
					<th width="15%">企业名称</th>
					<td width="35%">${zycsjcbg.qymc}</td>
				</tr>
				<tr>
					<th width="15%">检测危害因素</th>
					<td width="35%">${zycsjcbg.jcwz}</td>
					<th width="15%">检测点数</th>
					<td width="35%">${zycsjcbg.jcds}</td>
				</tr>
				<tr>
					<th width="15%">检测日期</th>
					<td width="35%">${zycsjcbg.jcsj}</td>
					<th width="15%">不合格点数</th>
					<td width="35%">${zycsjcbg.bhgds}</td>
				</tr>
				<tr>
					<th width="15%">不合格点的危害因素名称</th>
					<td width="35%">${zycsjcbg.bggName}</td>
					<th width="15%">检测机构</th>
					<td width="35%">${zycsjcbg.jcdwname}</td>
				</tr>
				<tr>
