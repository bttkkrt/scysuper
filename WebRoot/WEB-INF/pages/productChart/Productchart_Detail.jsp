	...
	<form name="myform" method="post">
		<div class="submitdata">
			...
			<s:if test="role!=1">
				<tr>
					<th width="15%">企业名称</th>
					<td width="35%">${productchart.comName}</td>
					<th width="15%">所在镇</th>
					<td width="35%">${productchart.deptName}</td>
				</tr>
				</s:if>
				<tr>
					<th width="15%">生产流程</th>
					<td width="35%">${productchart.processname}</td>
				</tr>
					<tr>
					<th width="15%">已上传文件</th>
					<td width="85%" colspan="3">
							<div style="color:green;overflow:auto; height:200px;">								  <table id="qysclct">
