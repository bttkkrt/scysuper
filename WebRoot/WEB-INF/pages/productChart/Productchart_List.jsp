	...
	<script>
        ...
        function search_productchart(){
        	var queryParams = {
				...
				"productchart.deptId":$("#deptId").val(),
					"productchart.comName":$("#comName").val(),
				...
				columns:[[
				 {field:'deptName',title:'所属街道',width:fixWidth(0.2)},
				 	 {field:'comName',title:'企业名称',width:fixWidth(0.2)},
				          {field:'processname',title:'生产流程',width:fixWidth(0.2)},
...
<form name="myform" method="post">
	<div class="submitdata">
		<table width="100%">
			...
			<tr> 
				<th width="15%">企业名称</th>
				<td width="35%"><input name="productchart.comName" size=30 id="comName" value="${productchart.comName}" type="text"></td>
				<th width="15%">生产流程</th>
				<td width="35%"><input name="productchart.processname" id="processname" value="${productchart.processname}" type="text"></td>
			</tr>
			<tr>
				...
				<s:if test="visable==1">
					...
					<select id="deptId" name="productchart.deptId" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="productchart.deptId" defaultText='请选择' codeName="相城地址" value="${productchart.deptId}" /></td>
					 -->
				</s:if>
			</tr>
			<tr>
