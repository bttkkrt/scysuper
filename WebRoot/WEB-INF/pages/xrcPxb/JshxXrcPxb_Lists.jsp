...
<title>新入厂员工培训管理</title>
	...
	<script>
        ...
        function view(row_Id){
        	location.href = "${ctx}/jsp/xrcPxb/jshxXrcPxbList.action?jshxXrcPxb.qyid="+row_Id;
        }
        function reloadDate(){
        ...
        function search_jshxXrcPxb(){
        	var queryParams = {
        	"jshxXrcPxb.szzid": $("#szzid").val(),
"jshxXrcPxb.qymc": $("#qymc").val()
			};        	
								...
								var str="";
								  $.ajax({
										...
										success: function(data){
											if(""!=data.result){
											str+= "<span style='color:red;cursor:hand' onclick=\"view('"+rec.qyid+"')\">查看</span>";
											}
										}});
								 return str;*/
								 return "<span style='color:red;cursor:hand' onclick=\"view('"+rec.qyid+"')\">查看</span>";
                          }}
				        ]],
				pagination:true,
		...
		<table width="100%">
			<tr>
			  	<s:if test="flag==2">
					...
					<select id="szzid" name="jshxXrcPxb.szzid" style="width:150px;" ><option value="">请选择</option></select>
						
					<!--hanxc 2014/11/11 		
					<cus:SelectOneTag property="jshxXrcPxb.szzid" defaultText='请选择' codeName="相城地址" value="${jshxXrcPxb.szzid}" /></td>
					 -->
				</s:if>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="jshxXrcPxb.qymc" id="qymc" value="${jshxXrcPxb.qymc}" type="text"></td>
			</tr>
			<tr>
