...
<head>
<title>安全生产培训情况管理</title>
    <%@include file="/common/jsLib.jsp"%>
	<script>
        
        function addNew(){
        	var dt=new Date();
            createSimpleWindow("win_aqscpxqk","添加安全生产培训情况","${ctx}/jsp/aqscpxqk/aqscpxqkInitEdit.action?flag=add&dt="+dt.getTime(),700,300);
        	
        }
        function edit(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_aqscpxqk","修改安全生产培训情况","${ctx}/jsp/aqscpxqk/aqscpxqkInitEdit.action?flag=mod&aqscpxqk.id="+row_Id+"&dt="+dt.getTime(),700,300);
        	
        }
        function view(row_Id){
        	var dt=new Date();
            createSimpleWindow("win_aqscpxqk","查看安全生产培训情况","${ctx}/jsp/aqscpxqk/aqscpxqkView.action?aqscpxqk.id="+row_Id+"&dt="+dt.getTime(),700,300);
        ...
        function exportData()
        {
         var queryMonthTimeStart = $("#queryMonthTimeStart").val();
        	...
        	document.myform.action = "${ctx}/jsp/aqscpxqk/aqscpxqkExport.action";
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_aqscpxqk()" >查询<b></b></a>&nbsp;
