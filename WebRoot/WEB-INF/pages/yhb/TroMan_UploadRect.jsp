	...
	<form name="myform1" method="post" enctype="multipart/form-data" action="troManRectSave.action">
			...
			<table width="100%">
				...
				<tr>
					<th width="15%">检查项</th>
					<td width="35%" >
						<cus:hxlabel codeSql="select t.row_id,PATROL_NAME from PAT_MAN t where t.delflag = 0 and createuserid = '${curr_user.id}'" itemValue="${troMan.checkItem}" />
					</td>
					<th width="15%">整改期限</th>
				...
				<tr>
					<th width="15%">隐患地点</th>
					<td width="85%" colspan='3' >${troMan.troubleAdd}</td>
				</tr>
				<tr>
				...
				<tr>
					<th width="15%">整改结果</th>
					<td width="35%" >
					<s:select id='zgwc' cssStyle="width:60%"  name="troMan.dealState" list="#{'整改完成':'整改完成','整改未完成':'整改未完成'}" theme="simple" onchange="zgwcChange()"/>
					</td>
					<th width="15%">备注</th>
				...
				<tr id='zgsj'>
					<th width="15%">整改时间</th>
					<td width="35%" ><input name="troMan.recfinishTime" id='time' style="width:60%" type="text" class="Wdate" dataType="*1-127" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"><font style="color:red">*</font></td>
					<th width="15%">整改资金（元）</th>
					<td width="35%" ><input name="troMan.rectificationMoney" style="width:60%" dataType="*1-127"  nullmsg='整改资金（元）不能为空！' id='money' type="text" maxlength="127"><font style="color:red">*</font><span id="fixval"></span></td>
				</tr>
				<tr>
