...
<head>
	...
	　		'uploader': '<c:url value="/webResources/js/uploadify.swf"/>',  
			...
			　'script': '${ctx}/jsp/zycsjcry/zycsjcrySavePhoto.action', 
	...
	　		'fileDesc': '支持格式:所有文件', //如果配置了以下的'fileExt'属性，那么这个属性是必须的  
			...
			var extname = picName;
			var table = window.opener.document.getElementById("zyjkjh");
	...
	　},
		'onAllComplete': function (event, data){
			alert('上传成功');
			window.opener.document.getElementById("ss").style.display="";
			window.close();
	　}, 
