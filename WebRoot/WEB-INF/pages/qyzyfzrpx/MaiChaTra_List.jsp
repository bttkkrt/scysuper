...
<title>企业主要负责人培训管理</title>
	...
	<script>
        ...
        function search_maiChaTra(){
        	var queryParams = {
				"maiChaTra.areaId": $("#areaId").val(),
...
"maiChaTra.trainingCardnum": $("#trainingCardnum").val(),
"maiChaTra.trainingPersonName": $("#trainingPersonName").val(),
"maiChaTra.companyName": $("#companyName").val()
			};        	
    ...
    <div class="page_content">
		...
		<div class="inner12px">
			...
			<table width="100%">
				...
				<th width="15%">所在区域</th>
				<td width="35%"><cus:SelectOneTag property="maiChaTra.areaId" style="width:50%" defaultText='请选择' codeName="企业属地" value="${maiChaTra.areaId}" /></td>
				<th width="15%">企业名称</th>
				<td width="35%"><input name="maiChaTra.companyName" style="width:50%" id="companyName" value="${maiChaTra.companyName}" type="text" maxlength="127"></td>
			</tr></s:if>
			<tr>
				<th width="15%">主要负责人姓名</th>
				<td width="35%"><input name="maiChaTra.trainingPersonName" style="width:50%" id="trainingPersonName" value="${maiChaTra.trainingPersonName}" type="text" maxlength="127"></td>
				<th width="15%">证书号码</th>
				<td width="35%"><input id="trainingCardnum" name="maiChaTra.trainingCardnum" style="width:50%" value="${maiChaTra.trainingCardnum}" type="text"  maxlength="127"></td>
			</tr>
			<tr>	
			...
			<tr>
				...
				<tr>
					<td colspan="4" align="center">
						<a href="###" class="btn_01" onclick="search_maiChaTra()" >查询<b></b></a>&nbsp;
