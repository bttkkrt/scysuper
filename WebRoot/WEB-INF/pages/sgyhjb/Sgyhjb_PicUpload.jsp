...
<head>
	...
	<script>
	    ...
	    $(document).ready(function(){
	    	var data = '${ctx}/jsp/sgyhjb/sgyhjbSavePhoto.action?type='+'${flag}'+','+'${sgyhjb.linkId}';
		   	　$("#uploadify").uploadify({
	...
	　		'fileDesc': '支持格式:所有文件', //如果配置了以下的'fileExt'属性，那么这个属性是必须的  
			　'fileExt': '*.*;',//允许的格式
			...
			comFile.indexOf('.gif')>0){
				...
				span1.innerHTML=img+
				" border='0' width='220' height='150'/>&nbsp;&nbsp;<br>";
			}else{
			...
			aa1.href="javascript:savepic('"+ pid + "');";
